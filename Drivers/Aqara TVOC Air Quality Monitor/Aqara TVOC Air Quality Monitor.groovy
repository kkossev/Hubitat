 ...
 * ver. 3.0.0  2023-12-03 kkossev  - (dev. branch) transfer kkossev.airQualityLib into the refactored driver
 *
 *                                   TODO: code cleanup
...
static String timeStamp() {"2023/12/03 11:55 PM"}
...
void airQualityEvent(eventName, value, raw) {
...
//
def processDeviceEventAirQuality(name, valueScaled, unitText, descText) {
