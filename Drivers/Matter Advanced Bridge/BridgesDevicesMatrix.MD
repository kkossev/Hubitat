...
*last updated 2024/02/16* <br>
Target release date : mid of March 2024

## <b>Matter Advanced Bridge Project : MVP</b>
1. Publish and maintain a clearly defined and easy to understand list of which device types work and which do not work for each of the various Matter Bridges tested. (*status: WIP*)
2. Publish a list of known issues and limitations of the Hubitat Matter implementation. (*Status: WIP*)
3. Stable discovery process. (*Status: WIP*)
4. RGB bulb bugs fixed and tested.  (*Status: WIP*)
...
8. Matter Advanced Bridge package can be installed and updated via HPM. (*status: TODO*)
9. Help/Documentation button in driver linked to GitHub web page.
10. ???
...
| Motion Sensors            | working OK - tested          |                                   |
...
| Water Leak Sensor         | working OK - tested          | as contact / switch               |
| Tuya Valve on/off         | working OK - tested          | as contact / switch               |
...
| Bulbs - RGBW control      | working OK - tested          |  Aqara LED Strip T                |
...
| Illuminance  Sensors      | NOT working (not exposed via Matter??)  |   Xiaomi(Lumi) Light Sensor       |
...
|:-------------------|:--------------------------:|-------------------------------------:|
|        | Unknown                |   not tested / not implemented           |
...
|:--------------------------|:-------------------------:|--------------------------------------:|
| Motion Sensors            | should be OK - NOT tested | not tested                            |
...
last updated 2024/02/14
|Device Type                | Zemismart |   Aqara   | Phlips Hue| Switchbot |          Remarks                  |
|:--------------------------|:---------:|:---------:|:---------:|:---------:|----------------------------------:|
...
|    06        | 5.1 On/Off Plug-in Unit <br>(ID: 0x010A)      |  Yes  |  Yes  |   ?   |  ?  |'Matter Generic Component Switch'  |      |
|  06, 08      | 5.2 Dimmable Plug-in Unit <br>(ID: 0x010B)    |   ?   |   ?   |   ?   |  ?  |'Generic Component Dimmer'        |       |
|    --        | 6. <b>Switches and Control Device Types</b>   |       |       |       |     |      ---         |                  |
|    06        | 6.1  On/Off Light Switch <br>(ID: 0x0103)     |  Yes  |  Yes  |   ?   |  ?  |'Matter Generic Component Switch'  | Obsolete? |
...
|   0400       | 7.2    Light Sensor <br>(ID: 0x0106)          |  No   |  No   |   ?   |  ?  | TODO              |Confirm Light sensors are working or not? |
|   0406       | 7.3    Occupancy Sensor <br>(ID: 0x0107)      |  Yes  |  Yes  |   ?   |  ?  |'Matter Generic Component Motion Sensor'|     |
|   0402       | 7.4    Temperature Sensor <br>(ID: 0x0302)    |  Yes  |  Yes  |   ?   | Yes |'Generic Component Omni Sensor'|      |
...
Known Hubitat Matter platform related issues : 
* initialize() method is called on each and every Matter error - 
* Matter interface status (operational/failure) can not be checked in the driver - 
* Hubitat does not receive a notification when a Matter device has been reset (powered off/on) -
