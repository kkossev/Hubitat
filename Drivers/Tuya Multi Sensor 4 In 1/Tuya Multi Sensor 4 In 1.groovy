 ...
 * ver. 1.6.1  2023-10-09 kkossev  - (dev. branch) TS0601_KAPVNNLK_RADAR TS0225_HL0SS9OA_RADAR TS0225_2AAELWXK_RADAR TS0601_RADAR_MIR-HE200-TY refactoring
 *
...
def version() { "1.6.1" }
def timeStamp() {"2023/10/09 9:39 PM"}
