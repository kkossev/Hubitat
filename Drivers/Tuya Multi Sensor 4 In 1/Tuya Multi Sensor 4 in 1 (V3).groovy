 ...
 *
 * ver. 3.2.0  2024-05-25 kkossev  - (dev.branch) firt version, based on the mmWave radar driver code : depricated Linptech; added TS0202 add _TYZB01_vwqnz1sn; 
 *                                   
 *                                   TODO: 
...
deviceType = "MTHISensor"
@Field static final String DEVICE_TYPE = "MTHISensor"
...
boolean customProcessTuyaDp(final Map descMap, final int dp, final int dp_id, final int fncmd, final int dp_len=0) {
    // TODO - for depricated devices, 'ignored depricated device 0x01 event' ? ignored depricated device 0x65 event' 
    return false
}
