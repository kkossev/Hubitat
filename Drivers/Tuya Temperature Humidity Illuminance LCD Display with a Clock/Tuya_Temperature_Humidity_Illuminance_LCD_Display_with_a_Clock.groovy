 ...
 * ver. 1.0.11 2022-10-31 kkossev  - (dev.branch) - added _TZE200_whkgqxse
 *
*/

def version() { "1.0.11" }
def timeStamp() {"2022/11/09 7:00 AM"}
...
metadata {
    definition (name: "Tuya Temperature Humidity Illuminance LCD Display with a Clock", namespace: "kkossev", author: "Krassimir Kossev", importUrl: "https://raw.githubusercontent.com/kkossev/Hubitat/development/Drivers/Tuya%20Temperature%20Humidity%20Illuminance%20LCD%20Display%20with%20a%20Clock/Tuya_Temperature_Humidity_Illuminance_LCD_Display_with_a_Clock.groovy", singleThreaded: true ) {
        ...
        */
        ...
        fingerprint profileId:"0104", endpointId:"01", inClusters:"0000,0402,0405,EF00", outClusters:"0019,000A", model:"TS0601", manufacturer:"_TZE200_whkgqxse", deviceJoinName: "Tuya Zigbee Temperature Humidity Sensor With Backlight"    // https://www.aliexpress.com/item/1005003980647546.html
        //
