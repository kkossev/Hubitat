...
static String deviceProfileLibStamp() { '2024/05/05 7:58 PM' } // library marker kkossev.deviceProfileLib, line 42
...
// all DPs are spammy - sent periodically! // library marker kkossev.deviceProfileLib, line 968
public boolean isSpammyDeviceProfile() { // library marker kkossev.deviceProfileLib, line 969
...
List<Object> compareAndConvertTuyaToHubitatEventValue(Map foundItem, int fncmd, boolean doNotTrace=false) { // library marker kkossev.deviceProfileLib, line 1094
    ...
    switch (foundItem.type) { // library marker kkossev.deviceProfileLib, line 1100
        ...
        case 'enum' :       // [0:"inactive", 1:"active"]  foundItem.map=[75:0.75 meters, 150:1.50 meters, 225:2.25 meters, 300:3.00 meters, 375:3.75 meters, 450:4.50 meters] // library marker kkossev.deviceProfileLib, line 1104
            ...
            logTrace "latestEvent is dataType is ${dataType}" // library marker kkossev.deviceProfileLib, line 1108
            ...
            if (dataType == 'ENUM') { // library marker kkossev.deviceProfileLib, line 1110
 ...
 * Processes a Tuya DP (Data Point) received from the device, based on the device profile and its defined Tuya DPs. // library marker kkossev.deviceProfileLib, line 1158
 * If a preference exists for the DP, it updates the preference value and sends an event if the DP is declared as an attribute. // library marker kkossev.deviceProfileLib, line 1159
 * If no preference exists for the DP, it logs the DP value as an info message. // library marker kkossev.deviceProfileLib, line 1160
 * If the DP is spammy (not needed for anything), it does not perform any further processing. // library marker kkossev.deviceProfileLib, line 1161
 * // library marker kkossev.deviceProfileLib, line 1162
 * @param descMap The description map of the received DP. // library marker kkossev.deviceProfileLib, line 1163
 * @param dp The value of the received DP. // library marker kkossev.deviceProfileLib, line 1164
 * @param dp_id The ID of the received DP. // library marker kkossev.deviceProfileLib, line 1165
 * @param fncmd The command of the received DP. // library marker kkossev.deviceProfileLib, line 1166
 * @param dp_len The length of the received DP. // library marker kkossev.deviceProfileLib, line 1167
 * @return true if the DP was processed successfully, false otherwise. // library marker kkossev.deviceProfileLib, line 1168
 */ // library marker kkossev.deviceProfileLib, line 1169
public boolean processTuyaDPfromDeviceProfile(final Map descMap, final int dp, final int dp_id, final int fncmd_orig, final int dp_len) { // library marker kkossev.deviceProfileLib, line 1170
    int fncmd = fncmd_orig // library marker kkossev.deviceProfileLib, line 1171
    if (state.deviceProfile == null)  { return false } // library marker kkossev.deviceProfileLib, line 1172
    //if (!(DEVICE?.device?.type == "radar"))      { return false }   // enabled for all devices - 10/22/2023 !!!    // only these models are handled here for now ... // library marker kkossev.deviceProfileLib, line 1173
    if (isSpammyDPsToIgnore(descMap)) { return true  }       // do not perform any further processing, if this is a spammy report that is not needed for anyhting (such as the LED status) // library marker kkossev.deviceProfileLib, line 1174

    List<Map> tuyaDPsMap = deviceProfilesV3[state.deviceProfile]?.tuyaDPs // library marker kkossev.deviceProfileLib, line 1176
    if (tuyaDPsMap == null || tuyaDPsMap == [:]) { return false }    // no any Tuya DPs defined in the Device Profile // library marker kkossev.deviceProfileLib, line 1177

    Map foundItem = null // library marker kkossev.deviceProfileLib, line 1179
    tuyaDPsMap.each { item -> // library marker kkossev.deviceProfileLib, line 1180
        if (item['dp'] == (dp as int)) { // library marker kkossev.deviceProfileLib, line 1181
            foundItem = item // library marker kkossev.deviceProfileLib, line 1182
            return // library marker kkossev.deviceProfileLib, line 1183
    ...
    if (foundItem == null || foundItem == [:]) { // library marker kkossev.deviceProfileLib, line 1186
        // DP was not found into the tuyaDPs list for this particular deviceProfile // library marker kkossev.deviceProfileLib, line 1187
     //   updateStateUnknownDPs(descMap, dp, dp_id, fncmd, dp_len) // library marker kkossev.deviceProfileLib, line 1188
        // continue processing the DP report in the old code ... // library marker kkossev.deviceProfileLib, line 1189
        return false // library marker kkossev.deviceProfileLib, line 1190
    } // library marker kkossev.deviceProfileLib, line 1191

    return processFoundItem(foundItem, fncmd_orig, isSpammyDPsToNotTrace(descMap)) // library marker kkossev.deviceProfileLib, line 1193
} // library marker kkossev.deviceProfileLib, line 1194

// TODO: refactor! // library marker kkossev.deviceProfileLib, line 1196
public boolean processClusterAttributeFromDeviceProfile(final Map descMap) { // library marker kkossev.deviceProfileLib, line 1197
    logTrace "processClusterAttributeFromDeviceProfile: descMap = ${descMap}" // library marker kkossev.deviceProfileLib, line 1198
    if (state.deviceProfile == null)  { logTrace '<b>state.deviceProfile is missing!<b>'; return false } // library marker kkossev.deviceProfileLib, line 1199

    List<Map> attribMap = deviceProfilesV3[state.deviceProfile]?.attributes // library marker kkossev.deviceProfileLib, line 1201
    if (attribMap == null || attribMap.isEmpty()) { return false }    // no any attributes are defined in the Device Profile // library marker kkossev.deviceProfileLib, line 1202

    Map foundItem = null // library marker kkossev.deviceProfileLib, line 1204
    String clusterAttribute = "0x${descMap.cluster}:0x${descMap.attrId}" // library marker kkossev.deviceProfileLib, line 1205
    int value // library marker kkossev.deviceProfileLib, line 1206
    try { // library marker kkossev.deviceProfileLib, line 1207
        value = hexStrToUnsignedInt(descMap.value) // library marker kkossev.deviceProfileLib, line 1208
    } // library marker kkossev.deviceProfileLib, line 1209
    catch (e) { // library marker kkossev.deviceProfileLib, line 1210
        logWarn "processClusterAttributeFromDeviceProfile: exception ${e} caught while converting hex value ${descMap.value} to integer" // library marker kkossev.deviceProfileLib, line 1211
        return false // library marker kkossev.deviceProfileLib, line 1212
    } // library marker kkossev.deviceProfileLib, line 1213
    //logTrace "clusterAttribute = ${clusterAttribute}" // library marker kkossev.deviceProfileLib, line 1214
    attribMap.each { item -> // library marker kkossev.deviceProfileLib, line 1215
        if (item['at'] == clusterAttribute) { // library marker kkossev.deviceProfileLib, line 1216
            foundItem = item // library marker kkossev.deviceProfileLib, line 1217
            return // library marker kkossev.deviceProfileLib, line 1218
        } // library marker kkossev.deviceProfileLib, line 1219
    } // library marker kkossev.deviceProfileLib, line 1220
    if (foundItem == null) { // library marker kkossev.deviceProfileLib, line 1221
        // clusterAttribute was not found into the attributes list for this particular deviceProfile // library marker kkossev.deviceProfileLib, line 1222
        // updateStateUnknownclusterAttribute(descMap) // library marker kkossev.deviceProfileLib, line 1223
        // continue processing the descMap report in the old code ... // library marker kkossev.deviceProfileLib, line 1224
        logTrace "processClusterAttributeFromDeviceProfile: clusterAttribute ${clusterAttribute} was not found in the attributes list for this deviceProfile ${DEVICE?.description}" // library marker kkossev.deviceProfileLib, line 1225
        return false // library marker kkossev.deviceProfileLib, line 1226
    } // library marker kkossev.deviceProfileLib, line 1227
    return processFoundItem(foundItem, value, isSpammyDPsToNotTrace(descMap)) // library marker kkossev.deviceProfileLib, line 1228
} // library marker kkossev.deviceProfileLib, line 1229

// modifies the value of the foundItem if needed !!! // library marker kkossev.deviceProfileLib, line 1231
/* groovylint-disable-next-line MethodParameterTypeRequired */ // library marker kkossev.deviceProfileLib, line 1232
boolean processFoundItem(final Map foundItem, int value, boolean doNotTrace = false) { // library marker kkossev.deviceProfileLib, line 1233
    if (foundItem == null) { return false } // library marker kkossev.deviceProfileLib, line 1234
    // added 10/31/2023 - preProc the attribute value if needed // library marker kkossev.deviceProfileLib, line 1235
    if (foundItem.preProc != null) { // library marker kkossev.deviceProfileLib, line 1236
        /* groovylint-disable-next-line ParameterReassignment */ // library marker kkossev.deviceProfileLib, line 1237
        Integer preProcValue = preProc(foundItem, value) // library marker kkossev.deviceProfileLib, line 1238
        if (preProcValue == null) { // library marker kkossev.deviceProfileLib, line 1239
            logDebug "processFoundItem: preProc returned null for ${foundItem.name} value ${value} -> further processing is skipped!" // library marker kkossev.deviceProfileLib, line 1240
            return true // library marker kkossev.deviceProfileLib, line 1241
        } // library marker kkossev.deviceProfileLib, line 1242
        if (preProcValue != value) { // library marker kkossev.deviceProfileLib, line 1243
            logDebug "processFoundItem: <b>preProc</b> changed ${foundItem.name} value to ${preProcValue}" // library marker kkossev.deviceProfileLib, line 1244
            /* groovylint-disable-next-line ParameterReassignment */ // library marker kkossev.deviceProfileLib, line 1245
            value = preProcValue as int // library marker kkossev.deviceProfileLib, line 1246
        } // library marker kkossev.deviceProfileLib, line 1247
    } // library marker kkossev.deviceProfileLib, line 1248
    else { // library marker kkossev.deviceProfileLib, line 1249
        logTrace "processFoundItem: no preProc for ${foundItem.name}" // library marker kkossev.deviceProfileLib, line 1250
    } // library marker kkossev.deviceProfileLib, line 1251

    String name = foundItem.name                                   // preference name as in the attributes map // library marker kkossev.deviceProfileLib, line 1253
    /* groovylint-disable-next-line NoDef, VariableTypeRequired */ // library marker kkossev.deviceProfileLib, line 1254
    String existingPrefValue = settings[foundItem.name] ?: 'none'  // existing preference value // library marker kkossev.deviceProfileLib, line 1255
    //existingPrefValue = existingPrefValue?.replace("[", "").replace("]", "")               // preference name as in Hubitat settings (preferences), if already created. // library marker kkossev.deviceProfileLib, line 1256
    /* groovylint-disable-next-line NoDef, VariableTypeRequired */ // library marker kkossev.deviceProfileLib, line 1257
    def preferenceValue = null   // preference value // library marker kkossev.deviceProfileLib, line 1258
    //log.trace "settings=${settings}" // library marker kkossev.deviceProfileLib, line 1259
    //boolean preferenceExists = settings.containsKey(foundItem.name)         // check if there is an existing preference for this clusterAttribute // library marker kkossev.deviceProfileLib, line 1260
    boolean preferenceExists = DEVICE?.preferences?.containsKey(foundItem.name)         // check if there is an existing preference for this clusterAttribute // library marker kkossev.deviceProfileLib, line 1261
    //log.trace "preferenceExists=${preferenceExists}" // library marker kkossev.deviceProfileLib, line 1262
    boolean isAttribute = device.hasAttribute(foundItem.name)    // check if there is such a attribute for this clusterAttribute // library marker kkossev.deviceProfileLib, line 1263
    boolean isEqual = false // library marker kkossev.deviceProfileLib, line 1264
    boolean wasChanged = false // library marker kkossev.deviceProfileLib, line 1265
    if (!doNotTrace) { // library marker kkossev.deviceProfileLib, line 1266
        logTrace "processFoundItem: name=${foundItem.name}, isAttribute=${isAttribute}, preferenceExists=${preferenceExists}, existingPrefValue=${existingPrefValue} (type ${foundItem.type}, rw=${foundItem.rw}) value is ${value} (description: ${foundItem.description})" // library marker kkossev.deviceProfileLib, line 1267
    } // library marker kkossev.deviceProfileLib, line 1268
    // check if the clusterAttribute has the same value as the last one, or the value has changed // library marker kkossev.deviceProfileLib, line 1269
    // the previous value may be stored in an attribute, as a preference, as both attribute and preference or not stored anywhere ... // library marker kkossev.deviceProfileLib, line 1270
    String unitText     = foundItem.unit != null ? "$foundItem.unit" : '' // library marker kkossev.deviceProfileLib, line 1271
    /* groovylint-disable-next-line NoDef, VariableTypeRequired */ // library marker kkossev.deviceProfileLib, line 1272
    def valueScaled    // can be number or decimal or string // library marker kkossev.deviceProfileLib, line 1273
    String descText = descText  = "${name} is ${value} ${unitText}"    // the default description text for log events // library marker kkossev.deviceProfileLib, line 1274

    // TODO - check if clusterAttribute is in the list of the received state.attributes - then we have something to compare ! // library marker kkossev.deviceProfileLib, line 1276
    if (!isAttribute && !preferenceExists) {                    // if the previous value of this clusterAttribute is not stored anywhere - just seend an Info log if Debug is enabled // library marker kkossev.deviceProfileLib, line 1277
        if (!doNotTrace) {                                      // only if the clusterAttribute is not in the spammy list // library marker kkossev.deviceProfileLib, line 1278
            logTrace "processFoundItem: no preference or attribute for ${name} - just log the value, if not equal to the last one..." // library marker kkossev.deviceProfileLib, line 1279
            // TODO - scaledValue ????? // library marker kkossev.deviceProfileLib, line 1280
            descText  = "${name} is ${value} ${unitText}" // library marker kkossev.deviceProfileLib, line 1281
            if (settings.logEnable) { logInfo "${descText }" }  // only when Debug is enabled! // library marker kkossev.deviceProfileLib, line 1282
        } // library marker kkossev.deviceProfileLib, line 1283
        // no more processing is needed, as this clusterAttribute is not a preference and not an attribute // library marker kkossev.deviceProfileLib, line 1284
        return true // library marker kkossev.deviceProfileLib, line 1285
    } // library marker kkossev.deviceProfileLib, line 1286

    // first, check if there is a preference defined to be updated // library marker kkossev.deviceProfileLib, line 1288
    if (preferenceExists && !doNotTrace) {  // do not even try to automatically update the preference if it is in the spammy list! - added 04/23/2024 // library marker kkossev.deviceProfileLib, line 1289
        // preference exists and its's value is extracted // library marker kkossev.deviceProfileLib, line 1290
        (isEqual, preferenceValue)  = compareAndConvertTuyaToHubitatPreferenceValue(foundItem, value, existingPrefValue) // library marker kkossev.deviceProfileLib, line 1291
        logTrace "processFoundItem: preference '${name}' exists with existingPrefValue ${existingPrefValue} (type ${foundItem.type}) -> <b>isEqual=${isEqual} preferenceValue=${preferenceValue}</b>" // library marker kkossev.deviceProfileLib, line 1292
        if (isEqual == true) { // library marker kkossev.deviceProfileLib, line 1293
            //log.trace "doNotTrace=${doNotTrace} isSpammyDeviceProfile=${isSpammyDeviceProfile()}" // library marker kkossev.deviceProfileLib, line 1294
            if (!(doNotTrace || isSpammyDeviceProfile())) {                                 // the clusterAttribute value is the same as the preference value - no need to update the preference // library marker kkossev.deviceProfileLib, line 1295
                logDebug "processFoundItem: no change: preference '${name}' existingPrefValue ${existingPrefValue} equals scaled value ${preferenceValue} (clusterAttribute raw value ${value})" // library marker kkossev.deviceProfileLib, line 1296
            } // library marker kkossev.deviceProfileLib, line 1297
        } // library marker kkossev.deviceProfileLib, line 1298
        else { // library marker kkossev.deviceProfileLib, line 1299
            String scaledPreferenceValue = preferenceValue      //.toString() is not neccessary // library marker kkossev.deviceProfileLib, line 1300
            if (foundItem.type == 'enum' && foundItem.scale != null && foundItem.scale != 0 && foundItem.scale != 1) { // library marker kkossev.deviceProfileLib, line 1301
                scaledPreferenceValue = ((preferenceValue * safeToInt(foundItem.scale)) as int).toString() // library marker kkossev.deviceProfileLib, line 1302
            } // library marker kkossev.deviceProfileLib, line 1303
            logDebug "processFoundItem: preference '${name}' value ${existingPrefValue} <b>differs</b> from the new scaled value ${preferenceValue} (clusterAttribute raw value ${value})" // library marker kkossev.deviceProfileLib, line 1304
            if (settings.logEnable) { logInfo "updating the preference '${name}' from ${existingPrefValue} to ${preferenceValue} (scaledPreferenceValue=${scaledPreferenceValue}, type=${foundItem.type})" } // library marker kkossev.deviceProfileLib, line 1305
            try { // library marker kkossev.deviceProfileLib, line 1306
                device.updateSetting("${name}", [value:scaledPreferenceValue, type:foundItem.type]) // library marker kkossev.deviceProfileLib, line 1307
                wasChanged = true // library marker kkossev.deviceProfileLib, line 1308
            } // library marker kkossev.deviceProfileLib, line 1309
            catch (e) { // library marker kkossev.deviceProfileLib, line 1310
                logWarn "exception ${e} caught while updating preference ${name} to ${preferenceValue}, type ${foundItem.type}" // library marker kkossev.deviceProfileLib, line 1311
    ...
    else {    // no preference exists for this clusterAttribute // library marker kkossev.deviceProfileLib, line 1315
        // if not in the spammy list - log it! // library marker kkossev.deviceProfileLib, line 1316
        unitText = foundItem.unit != null ? "$foundItem.unit" : '' // library marker kkossev.deviceProfileLib, line 1317
        //logInfo "${name} is ${value} ${unitText}" // library marker kkossev.deviceProfileLib, line 1318
    } // library marker kkossev.deviceProfileLib, line 1319

    // second, send an event if this is declared as an attribute! // library marker kkossev.deviceProfileLib, line 1321
    if (isAttribute) {                                         // this clusterAttribute has an attribute that must be sent in an Event // library marker kkossev.deviceProfileLib, line 1322
        (isEqual, valueScaled) = compareAndConvertTuyaToHubitatEventValue(foundItem, value, doNotTrace) // library marker kkossev.deviceProfileLib, line 1323
        if (isEqual == false) { logTrace "attribute '${name}' exists (type ${foundItem.type}), value ${value} -> <b>isEqual=${isEqual} valueScaled=${valueScaled}</b> wasChanged=${wasChanged}" } // library marker kkossev.deviceProfileLib, line 1324
        descText  = "${name} is ${valueScaled} ${unitText}" // library marker kkossev.deviceProfileLib, line 1325
        if (settings?.logEnable == true) { descText += " (raw:${value})" } // library marker kkossev.deviceProfileLib, line 1326
        if (state.states != null && state.states['isRefresh'] == true) { descText += ' [refresh]' } // library marker kkossev.deviceProfileLib, line 1327
        if (isEqual && !wasChanged) {                        // this DP report has the same value as the last one - just send a debug log and move along! // library marker kkossev.deviceProfileLib, line 1328
            if (!doNotTrace) { // library marker kkossev.deviceProfileLib, line 1329
                if (settings.logEnable) { logDebug "${descText } (no change)" } // library marker kkossev.deviceProfileLib, line 1330
            } // library marker kkossev.deviceProfileLib, line 1331
            // patch for inverted motion sensor 2-in-1 // library marker kkossev.deviceProfileLib, line 1332
            if (name == 'motion' && is2in1()) {                 // TODO - remove the patch !! // library marker kkossev.deviceProfileLib, line 1333
                logDebug 'patch for inverted motion sensor 2-in-1' // library marker kkossev.deviceProfileLib, line 1334
            // continue ... // library marker kkossev.deviceProfileLib, line 1335
            } // library marker kkossev.deviceProfileLib, line 1336
            else { // library marker kkossev.deviceProfileLib, line 1337
                if (state.states != null && state.states['isRefresh'] == true) { // library marker kkossev.deviceProfileLib, line 1338
                    logTrace 'isRefresh = true - continue and send an event, although there was no change...' // library marker kkossev.deviceProfileLib, line 1339
                } // library marker kkossev.deviceProfileLib, line 1340
                else { // library marker kkossev.deviceProfileLib, line 1341
                    return true       // we are done (if there was potentially a preference, it should be already set to the same value) // library marker kkossev.deviceProfileLib, line 1342
        ...
        // clusterAttribute value (value) is not equal to the attribute last value or was changed- we must send an event! // library marker kkossev.deviceProfileLib, line 1347
        //log.trace 'sending event' // library marker kkossev.deviceProfileLib, line 1348
        int divider = safeToInt(foundItem.scale ?: 1) ?: 1 // library marker kkossev.deviceProfileLib, line 1349
        float valueCorrected = value / divider // library marker kkossev.deviceProfileLib, line 1350
        if (!doNotTrace) { logTrace "value=${value} foundItem.scale=${foundItem.scale}  divider=${divider} valueCorrected=${valueCorrected}" } // library marker kkossev.deviceProfileLib, line 1351
        // process the events in the device specific driver.. // library marker kkossev.deviceProfileLib, line 1352
        if (DEVICE_TYPE in ['Thermostat'])  { processDeviceEventThermostat(name, valueScaled, unitText, descText) } // library marker kkossev.deviceProfileLib, line 1353
        else { // library marker kkossev.deviceProfileLib, line 1354
            switch (name) { // library marker kkossev.deviceProfileLib, line 1355
                case 'motion' : // library marker kkossev.deviceProfileLib, line 1356
                    handleMotion(value as boolean)  // TODO !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! // library marker kkossev.deviceProfileLib, line 1357
                    break // library marker kkossev.deviceProfileLib, line 1358
                case 'temperature' : // library marker kkossev.deviceProfileLib, line 1359
                    //temperatureEvent(value / getTemperatureDiv()) // library marker kkossev.deviceProfileLib, line 1360
                    handleTemperatureEvent(valueScaled as Float) // library marker kkossev.deviceProfileLib, line 1361
                    break // library marker kkossev.deviceProfileLib, line 1362
                case 'humidity' : // library marker kkossev.deviceProfileLib, line 1363
                    handleHumidityEvent(valueScaled) // library marker kkossev.deviceProfileLib, line 1364
                    break // library marker kkossev.deviceProfileLib, line 1365
                case 'illuminance' : // library marker kkossev.deviceProfileLib, line 1366
                case 'illuminance_lux' :    // ignore the IAS Zone illuminance reports for HL0SS9OA and 2AAELWXK // library marker kkossev.deviceProfileLib, line 1367
                    //log.trace "illuminance event received deviceProfile is ${getDeviceProfile()} value=${value} valueScaled=${valueScaled} valueCorrected=${valueCorrected}" // library marker kkossev.deviceProfileLib, line 1368
                    handleIlluminanceEvent(valueCorrected as int) // library marker kkossev.deviceProfileLib, line 1369
                    break // library marker kkossev.deviceProfileLib, line 1370
                case 'pushed' : // library marker kkossev.deviceProfileLib, line 1371
                    logDebug "button event received value=${value} valueScaled=${valueScaled} valueCorrected=${valueCorrected}" // library marker kkossev.deviceProfileLib, line 1372
                    buttonEvent(valueScaled) // library marker kkossev.deviceProfileLib, line 1373
                    break // library marker kkossev.deviceProfileLib, line 1374
                default : // library marker kkossev.deviceProfileLib, line 1375
                    log.trace "wasChanged=${wasChanged} name=${name} value=${value} valueScaled=${valueScaled}" // library marker kkossev.deviceProfileLib, line 1376
                    sendEvent(name : name, value : valueScaled, unit:unitText, descriptionText: descText, type: 'physical', isStateChange: true)    // attribute value is changed - send an event ! // library marker kkossev.deviceProfileLib, line 1377
                    if (!doNotTrace) { // library marker kkossev.deviceProfileLib, line 1378
                        logTrace "event ${name} sent w/ value ${valueScaled}" // library marker kkossev.deviceProfileLib, line 1379
                        logInfo "${descText}"   // TODO - send info log only if the value has changed?   // TODO - check whether Info log will be sent also for spammy clusterAttribute ? // library marker kkossev.deviceProfileLib, line 1380
        ...
        //logTrace "attrValue=${attrValue} valueScaled=${valueScaled} equal=${isEqual}" // library marker kkossev.deviceProfileLib, line 1384
        } // library marker kkossev.deviceProfileLib, line 1385
    } // library marker kkossev.deviceProfileLib, line 1386
    // all processing was done here! // library marker kkossev.deviceProfileLib, line 1387
    return true // library marker kkossev.deviceProfileLib, line 1388
...
public boolean validateAndFixPreferences(boolean debug=false) { // library marker kkossev.deviceProfileLib, line 1391
    if (debug) { logTrace "validateAndFixPreferences: preferences=${DEVICE?.preferences}" } // library marker kkossev.deviceProfileLib, line 1392
    if (DEVICE?.preferences == null || DEVICE?.preferences == [:]) { // library marker kkossev.deviceProfileLib, line 1393
        logDebug "validateAndFixPreferences: no preferences defined for device profile ${getDeviceProfile()}" // library marker kkossev.deviceProfileLib, line 1394
        return false // library marker kkossev.deviceProfileLib, line 1395
    } // library marker kkossev.deviceProfileLib, line 1396
    int validationFailures = 0 // library marker kkossev.deviceProfileLib, line 1397
    int validationFixes = 0 // library marker kkossev.deviceProfileLib, line 1398
    int total = 0 // library marker kkossev.deviceProfileLib, line 1399
    /* groovylint-disable-next-line NoDef, VariableTypeRequired */ // library marker kkossev.deviceProfileLib, line 1400
    def oldSettingValue // library marker kkossev.deviceProfileLib, line 1401
    /* groovylint-disable-next-line NoDef, VariableTypeRequired */ // library marker kkossev.deviceProfileLib, line 1402
    def newValue // library marker kkossev.deviceProfileLib, line 1403
    String settingType // library marker kkossev.deviceProfileLib, line 1404
    DEVICE?.preferences.each { // library marker kkossev.deviceProfileLib, line 1405
        Map foundMap = getPreferencesMapByName(it.key) // library marker kkossev.deviceProfileLib, line 1406
        if (foundMap == null || foundMap == [:]) { // library marker kkossev.deviceProfileLib, line 1407
            logDebug "validateAndFixPreferences: map not found for preference ${it.key}"    // 10/21/2023 - sevirity lowered to debug // library marker kkossev.deviceProfileLib, line 1408
            return false // library marker kkossev.deviceProfileLib, line 1409
        } // library marker kkossev.deviceProfileLib, line 1410
        settingType = device.getSettingType(it.key) // library marker kkossev.deviceProfileLib, line 1411
        oldSettingValue = device.getSetting(it.key) // library marker kkossev.deviceProfileLib, line 1412
        if (settingType == null) { // library marker kkossev.deviceProfileLib, line 1413
            logDebug "validateAndFixPreferences: settingType not found for preference ${it.key}" // library marker kkossev.deviceProfileLib, line 1414
            return false // library marker kkossev.deviceProfileLib, line 1415
        } // library marker kkossev.deviceProfileLib, line 1416
        if (debug) { logTrace "validateAndFixPreferences: preference ${it.key} (dp=${it.value}) oldSettingValue = ${oldSettingValue} mapType = ${foundMap.type} settingType=${settingType}" } // library marker kkossev.deviceProfileLib, line 1417
        if (foundMap.type != settingType) { // library marker kkossev.deviceProfileLib, line 1418
            logDebug "validateAndFixPreferences: preference ${it.key} (dp=${it.value}) new mapType = ${foundMap.type} <b>differs</b> from the old settingType=${settingType} (oldSettingValue = ${oldSettingValue}) " // library marker kkossev.deviceProfileLib, line 1419
            validationFailures ++ // library marker kkossev.deviceProfileLib, line 1420
            // remove the setting and create a new one using the foundMap.type // library marker kkossev.deviceProfileLib, line 1421
            try { // library marker kkossev.deviceProfileLib, line 1422
                device.removeSetting(it.key) // library marker kkossev.deviceProfileLib, line 1423
                logDebug "validateAndFixPreferences: removing setting ${it.key}" // library marker kkossev.deviceProfileLib, line 1424
            } catch (e) { // library marker kkossev.deviceProfileLib, line 1425
                logWarn "validateAndFixPreferences: exception ${e} caught while removing setting ${it.key}" // library marker kkossev.deviceProfileLib, line 1426
                return false // library marker kkossev.deviceProfileLib, line 1427
            } // library marker kkossev.deviceProfileLib, line 1428
            // first, try to use the old setting value // library marker kkossev.deviceProfileLib, line 1429
            try { // library marker kkossev.deviceProfileLib, line 1430
                // correct the oldSettingValue type // library marker kkossev.deviceProfileLib, line 1431
                if (foundMap.type == 'decimal')     { newValue = oldSettingValue.toDouble() } // library marker kkossev.deviceProfileLib, line 1432
                else if (foundMap.type == 'number') { newValue = oldSettingValue.toInteger() } // library marker kkossev.deviceProfileLib, line 1433
                else if (foundMap.type == 'bool')   { newValue = oldSettingValue == 'true' ? 1 : 0 } // library marker kkossev.deviceProfileLib, line 1434
                else if (foundMap.type == 'enum') { // library marker kkossev.deviceProfileLib, line 1435
                    // check if the old settingValue was 'true' or 'false' and convert it to 1 or 0 // library marker kkossev.deviceProfileLib, line 1436
                    if (oldSettingValue == 'true' || oldSettingValue == 'false' || oldSettingValue == true || oldSettingValue == false) { // library marker kkossev.deviceProfileLib, line 1437
                        newValue = (oldSettingValue == 'true' || oldSettingValue == true) ? '1' : '0' // library marker kkossev.deviceProfileLib, line 1438
                    } // library marker kkossev.deviceProfileLib, line 1439
                    // check if there are any period chars in the foundMap.map string keys as String and format the settingValue as string with 2 decimals // library marker kkossev.deviceProfileLib, line 1440
                    else if (foundMap.map.keySet().toString().any { it.contains('.') }) { // library marker kkossev.deviceProfileLib, line 1441
                        newValue = String.format('%.2f', oldSettingValue) // library marker kkossev.deviceProfileLib, line 1442
                    } else { // library marker kkossev.deviceProfileLib, line 1443
                        // format the settingValue as a string of the integer value // library marker kkossev.deviceProfileLib, line 1444
                        newValue = String.format('%d', oldSettingValue) // library marker kkossev.deviceProfileLib, line 1445
                    } // library marker kkossev.deviceProfileLib, line 1446
                } // library marker kkossev.deviceProfileLib, line 1447
                device.updateSetting(it.key, [value:newValue, type:foundMap.type]) // library marker kkossev.deviceProfileLib, line 1448
                logDebug "validateAndFixPreferences: removed and updated setting ${it.key} from old type ${settingType} to new type ${foundMap.type} with the old value ${oldSettingValue} to new value ${newValue}" // library marker kkossev.deviceProfileLib, line 1449
                validationFixes ++ // library marker kkossev.deviceProfileLib, line 1450
            } // library marker kkossev.deviceProfileLib, line 1451
            catch (e) { // library marker kkossev.deviceProfileLib, line 1452
                logWarn "validateAndFixPreferences: exception '${e}' caught while creating setting ${it.key} with type ${foundMap.type} to new type ${foundMap.type} with the old value ${oldSettingValue} to new value ${newValue}" // library marker kkossev.deviceProfileLib, line 1453
                // change the settingValue to the foundMap default value // library marker kkossev.deviceProfileLib, line 1454
                try { // library marker kkossev.deviceProfileLib, line 1455
                    settingValue = foundMap.defVal // library marker kkossev.deviceProfileLib, line 1456
                    device.updateSetting(it.key, [value:settingValue, type:foundMap.type]) // library marker kkossev.deviceProfileLib, line 1457
                    logDebug "validateAndFixPreferences: updated setting ${it.key} from old type ${settingType} to new type ${foundMap.type} with <b>default</b> value ${newValue} " // library marker kkossev.deviceProfileLib, line 1458
                    validationFixes ++ // library marker kkossev.deviceProfileLib, line 1459
                } catch (e2) { // library marker kkossev.deviceProfileLib, line 1460
                    logWarn "<b>validateAndFixPreferences: exception '${e2}' caught while setting default value ... Giving up!</b>" // library marker kkossev.deviceProfileLib, line 1461
                    return false // library marker kkossev.deviceProfileLib, line 1462
        ...
        total ++ // library marker kkossev.deviceProfileLib, line 1466
    } // library marker kkossev.deviceProfileLib, line 1467
    logDebug "validateAndFixPreferences: total = ${total} validationFailures = ${validationFailures} validationFixes = ${validationFixes}" // library marker kkossev.deviceProfileLib, line 1468
    return true // library marker kkossev.deviceProfileLib, line 1469
} // library marker kkossev.deviceProfileLib, line 1470

public void printFingerprints() { // library marker kkossev.deviceProfileLib, line 1472
    deviceProfilesV3.each { profileName, profileMap -> // library marker kkossev.deviceProfileLib, line 1473
        profileMap.fingerprints?.each { fingerprint -> // library marker kkossev.deviceProfileLib, line 1474
            logInfo "${fingerprint}" // library marker kkossev.deviceProfileLib, line 1475
...
/* // library marker kkossev.commonLib, line 13
  ...
  * ver. 3.1.1  2024-05-05 kkossev  - (dev. branch) getTuyaAttributeValue bug fix; added customCustomParseIlluminanceCluster method // library marker kkossev.commonLib, line 41
...
@Field static final Map HealthcheckMethodOpts = [            // used by healthCheckMethod // library marker kkossev.commonLib, line 132
    defaultValue: 1, // library marker kkossev.commonLib, line 133
    options     : [0: 'Disabled', 1: 'Activity check', 2: 'Periodic polling'] // library marker kkossev.commonLib, line 134
...
@Field static final Map HealthcheckIntervalOpts = [          // used by healthCheckInterval // library marker kkossev.commonLib, line 136
    defaultValue: 240, // library marker kkossev.commonLib, line 137
    options     : [10: 'Every 10 Mins', 30: 'Every 30 Mins', 60: 'Every 1 Hour', 240: 'Every 4 Hours', 720: 'Every 12 Hours'] // library marker kkossev.commonLib, line 138
] // library marker kkossev.commonLib, line 139
@Field static final Map SwitchThreeStateOpts = [ // library marker kkossev.commonLib, line 140
    defaultValue: 0, // library marker kkossev.commonLib, line 141
    options     : [0: 'off', 1: 'on', 2: 'switching_off', 3: 'switching_on', 4: 'switch_failure'] // library marker kkossev.commonLib, line 142
] // library marker kkossev.commonLib, line 143

@Field static final Map ConfigureOpts = [ // library marker kkossev.commonLib, line 145
    'Configure the device'       : [key:2, function: 'configureNow'], // library marker kkossev.commonLib, line 146
    'Reset Statistics'           : [key:9, function: 'resetStatistics'], // library marker kkossev.commonLib, line 147
    '           --            '  : [key:3, function: 'configureHelp'], // library marker kkossev.commonLib, line 148
    'Delete All Preferences'     : [key:4, function: 'deleteAllSettings'], // library marker kkossev.commonLib, line 149
    'Delete All Current States'  : [key:5, function: 'deleteAllCurrentStates'], // library marker kkossev.commonLib, line 150
    'Delete All Scheduled Jobs'  : [key:6, function: 'deleteAllScheduledJobs'], // library marker kkossev.commonLib, line 151
    'Delete All State Variables' : [key:7, function: 'deleteAllStates'], // library marker kkossev.commonLib, line 152
    'Delete All Child Devices'   : [key:8, function: 'deleteAllChildDevices'], // library marker kkossev.commonLib, line 153
    '           -             '  : [key:1, function: 'configureHelp'], // library marker kkossev.commonLib, line 154
    '*** LOAD ALL DEFAULTS ***'  : [key:0, function: 'loadAllDefaults'] // library marker kkossev.commonLib, line 155
] // library marker kkossev.commonLib, line 156

boolean isVirtual() { device.controllerType == null || device.controllerType == '' } // library marker kkossev.commonLib, line 158
/* groovylint-disable-next-line UnusedMethodParameter */ // library marker kkossev.commonLib, line 159
boolean isAqaraTVOC_OLD()  { (device?.getDataValue('model') ?: 'n/a') in ['lumi.airmonitor.acn01'] } // library marker kkossev.commonLib, line 160
boolean isAqaraTRV_OLD()   { (device?.getDataValue('model') ?: 'n/a') in ['lumi.airrtc.agl001'] } // library marker kkossev.commonLib, line 161
boolean isAqaraFP1()   { (device?.getDataValue('model') ?: 'n/a') in ['lumi.motion.ac01'] } // library marker kkossev.commonLib, line 162
boolean isFingerbot()  { DEVICE_TYPE == 'Fingerbot' ? isFingerbotFingerot() : false } // library marker kkossev.commonLib, line 163
...
void parse(final String description) { // library marker kkossev.commonLib, line 169
    checkDriverVersion(state)    // +1 ms // library marker kkossev.commonLib, line 170
    updateRxStats(state)         // +1 ms // library marker kkossev.commonLib, line 171
    unscheduleCommandTimeoutCheck(state) // library marker kkossev.commonLib, line 172
    setHealthStatusOnline(state) // +2 ms // library marker kkossev.commonLib, line 173
    ...
    if (description?.startsWith('zone status')  || description?.startsWith('zone report')) { // library marker kkossev.commonLib, line 175
        ...
        List<String> cmds = zigbee.enrollResponse() + zigbee.readAttribute(0x0500, 0x0000) // library marker kkossev.commonLib, line 189
    ...
    if (isTuyaE00xCluster(description) == true || otherTuyaOddities(description) == true) {     // +15 ms // library marker kkossev.commonLib, line 195
        return // library marker kkossev.commonLib, line 196
    } // library marker kkossev.commonLib, line 197
    final Map descMap = myParseDescriptionAsMap(description)    // +5 ms // library marker kkossev.commonLib, line 198

    if (!isChattyDeviceReport(descMap)) { logDebug "parse: descMap = ${descMap} description=${description }" }   // library marker kkossev.commonLib, line 200
    if (isSpammyDeviceReport(descMap)) { return }  // +20 mS (both) // library marker kkossev.commonLib, line 201

    if (descMap.profileId == '0000') { // library marker kkossev.commonLib, line 203
        parseZdoClusters(descMap) // library marker kkossev.commonLib, line 204
        return // library marker kkossev.commonLib, line 205
    } // library marker kkossev.commonLib, line 206
    if (descMap.isClusterSpecific == false) { // library marker kkossev.commonLib, line 207
        parseGeneralCommandResponse(descMap) // library marker kkossev.commonLib, line 208
        return // library marker kkossev.commonLib, line 209
    } // library marker kkossev.commonLib, line 210
    // // library marker kkossev.commonLib, line 211
    //final String clusterName = clusterLookup(descMap.clusterInt) // library marker kkossev.commonLib, line 212
    //final String attribute = descMap.attrId ? " attribute 0x${descMap.attrId} (value ${descMap.value})" : '' // library marker kkossev.commonLib, line 213
    //if (settings.logEnable) { log.trace "zigbee received ${clusterName} message" + attribute } // library marker kkossev.commonLib, line 214

    switch (descMap.clusterInt as Integer) { // library marker kkossev.commonLib, line 216
        case zigbee.BASIC_CLUSTER:                          // 0x0000 // library marker kkossev.commonLib, line 217
            parseBasicCluster(descMap) // library marker kkossev.commonLib, line 218
            descMap.remove('additionalAttrs')?.each { final Map map -> parseBasicCluster(descMap + map) } // library marker kkossev.commonLib, line 219
            break // library marker kkossev.commonLib, line 220
        case zigbee.POWER_CONFIGURATION_CLUSTER:            // 0x0001 // library marker kkossev.commonLib, line 221
            parsePowerCluster(descMap) // library marker kkossev.commonLib, line 222
            descMap.remove('additionalAttrs')?.each { final Map map -> parsePowerCluster(descMap + map) } // library marker kkossev.commonLib, line 223
            break // library marker kkossev.commonLib, line 224
        case zigbee.IDENTIFY_CLUSTER:                      // 0x0003 // library marker kkossev.commonLib, line 225
            parseIdentityCluster(descMap) // library marker kkossev.commonLib, line 226
            descMap.remove('additionalAttrs')?.each { final Map map -> parseIdentityCluster(descMap + map) } // library marker kkossev.commonLib, line 227
            break // library marker kkossev.commonLib, line 228
        case zigbee.GROUPS_CLUSTER:                        // 0x0004 // library marker kkossev.commonLib, line 229
            parseGroupsCluster(descMap) // library marker kkossev.commonLib, line 230
            descMap.remove('additionalAttrs')?.each { final Map map -> parseGroupsCluster(descMap + map) } // library marker kkossev.commonLib, line 231
            break // library marker kkossev.commonLib, line 232
        case zigbee.SCENES_CLUSTER:                         // 0x0005 // library marker kkossev.commonLib, line 233
            parseScenesCluster(descMap) // library marker kkossev.commonLib, line 234
            descMap.remove('additionalAttrs')?.each { final Map map -> parseScenesCluster(descMap + map) } // library marker kkossev.commonLib, line 235
            break // library marker kkossev.commonLib, line 236
        case zigbee.ON_OFF_CLUSTER:                         // 0x0006 // library marker kkossev.commonLib, line 237
            parseOnOffCluster(descMap) // library marker kkossev.commonLib, line 238
            descMap.remove('additionalAttrs')?.each { final Map map -> parseOnOffCluster(descMap + map) } // library marker kkossev.commonLib, line 239
            break // library marker kkossev.commonLib, line 240
        case zigbee.LEVEL_CONTROL_CLUSTER:                  // 0x0008 // library marker kkossev.commonLib, line 241
            parseLevelControlCluster(descMap) // library marker kkossev.commonLib, line 242
            descMap.remove('additionalAttrs')?.each { final Map map -> parseLevelControlCluster(descMap + map) } // library marker kkossev.commonLib, line 243
            break // library marker kkossev.commonLib, line 244
        case 0x000C :                                       // Aqara TVOC Air Monitor; Aqara Cube T1 Pro; // library marker kkossev.commonLib, line 245
            parseAnalogInputCluster(descMap, description) // library marker kkossev.commonLib, line 246
            descMap.remove('additionalAttrs')?.each { final Map map -> parseAnalogInputCluster(descMap + map, description) } // library marker kkossev.commonLib, line 247
            break // library marker kkossev.commonLib, line 248
        case 0x0012 :                                       // Aqara Cube - Multistate Input // library marker kkossev.commonLib, line 249
            parseMultistateInputCluster(descMap) // library marker kkossev.commonLib, line 250
            break // library marker kkossev.commonLib, line 251
         case 0x0102 :                                      // window covering // library marker kkossev.commonLib, line 252
            parseWindowCoveringCluster(descMap) // library marker kkossev.commonLib, line 253
            break // library marker kkossev.commonLib, line 254
        case 0x0201 :                                       // Aqara E1 TRV // library marker kkossev.commonLib, line 255
            parseThermostatCluster(descMap) // library marker kkossev.commonLib, line 256
            descMap.remove('additionalAttrs')?.each { final Map map -> parseThermostatCluster(descMap + map) } // library marker kkossev.commonLib, line 257
            break // library marker kkossev.commonLib, line 258
        case 0x0300 :                                       // Aqara LED Strip T1 // library marker kkossev.commonLib, line 259
            parseColorControlCluster(descMap, description) // library marker kkossev.commonLib, line 260
            descMap.remove('additionalAttrs')?.each { final Map map -> parseColorControlCluster(descMap + map, description) } // library marker kkossev.commonLib, line 261
            break // library marker kkossev.commonLib, line 262
        case zigbee.ILLUMINANCE_MEASUREMENT_CLUSTER :       //0x0400 // library marker kkossev.commonLib, line 263
            parseIlluminanceCluster(descMap) // library marker kkossev.commonLib, line 264
            descMap.remove('additionalAttrs')?.each { final Map map -> parseIlluminanceCluster(descMap + map) } // library marker kkossev.commonLib, line 265
            break // library marker kkossev.commonLib, line 266
        case zigbee.TEMPERATURE_MEASUREMENT_CLUSTER :       //0x0402 // library marker kkossev.commonLib, line 267
            parseTemperatureCluster(descMap) // library marker kkossev.commonLib, line 268
            break // library marker kkossev.commonLib, line 269
        case zigbee.RELATIVE_HUMIDITY_MEASUREMENT_CLUSTER : //0x0405 // library marker kkossev.commonLib, line 270
            parseHumidityCluster(descMap) // library marker kkossev.commonLib, line 271
            break // library marker kkossev.commonLib, line 272
        case 0x0406 : //OCCUPANCY_CLUSTER                   // Sonoff SNZB-06 // library marker kkossev.commonLib, line 273
            parseOccupancyCluster(descMap) // library marker kkossev.commonLib, line 274
            break // library marker kkossev.commonLib, line 275
        case 0x042A :                                       // pm2.5 // library marker kkossev.commonLib, line 276
            parsePm25Cluster(descMap) // library marker kkossev.commonLib, line 277
            break // library marker kkossev.commonLib, line 278
        case zigbee.ELECTRICAL_MEASUREMENT_CLUSTER: // library marker kkossev.commonLib, line 279
            parseElectricalMeasureCluster(descMap) // library marker kkossev.commonLib, line 280
            descMap.remove('additionalAttrs')?.each { final Map map -> parseElectricalMeasureCluster(descMap + map) } // library marker kkossev.commonLib, line 281
            break // library marker kkossev.commonLib, line 282
        case zigbee.METERING_CLUSTER: // library marker kkossev.commonLib, line 283
            parseMeteringCluster(descMap) // library marker kkossev.commonLib, line 284
            descMap.remove('additionalAttrs')?.each { final Map map -> parseMeteringCluster(descMap + map) } // library marker kkossev.commonLib, line 285
            break // library marker kkossev.commonLib, line 286
        case 0xE002 : // library marker kkossev.commonLib, line 287
            parseE002Cluster(descMap) // library marker kkossev.commonLib, line 288
            descMap.remove('additionalAttrs')?.each { final Map map -> parseE002Cluster(descMap + map) } // library marker kkossev.commonLib, line 289
            break // library marker kkossev.commonLib, line 290
        case 0xEC03 :   // Linptech unknown cluster // library marker kkossev.commonLib, line 291
            parseEC03Cluster(descMap) // library marker kkossev.commonLib, line 292
            descMap.remove('additionalAttrs')?.each { final Map map -> parseEC03Cluster(descMap + map) } // library marker kkossev.commonLib, line 293
            break // library marker kkossev.commonLib, line 294
        case 0xEF00 :                                       // Tuya famous cluster // library marker kkossev.commonLib, line 295
            parseTuyaCluster(descMap) // library marker kkossev.commonLib, line 296
            descMap.remove('additionalAttrs')?.each { final Map map -> parseTuyaCluster(descMap + map) } // library marker kkossev.commonLib, line 297
            break // library marker kkossev.commonLib, line 298
        case 0xFC11 :                                       // Sonoff // library marker kkossev.commonLib, line 299
            parseFC11Cluster(descMap) // library marker kkossev.commonLib, line 300
            descMap.remove('additionalAttrs')?.each { final Map map -> parseFC11Cluster(descMap + map) } // library marker kkossev.commonLib, line 301
            break // library marker kkossev.commonLib, line 302
        case 0xfc7e :                                       // tVOC 'Sensirion VOC index' https://sensirion.com/media/documents/02232963/6294E043/Info_Note_VOC_Index.pdf // library marker kkossev.commonLib, line 303
            parseAirQualityIndexCluster(descMap) // library marker kkossev.commonLib, line 304
            break // library marker kkossev.commonLib, line 305
        case 0xFCC0 :                                       // XIAOMI_CLUSTER_ID Xiaomi cluster // library marker kkossev.commonLib, line 306
            parseXiaomiCluster(descMap) // library marker kkossev.commonLib, line 307
            descMap.remove('additionalAttrs')?.each { final Map m -> parseXiaomiCluster(descMap + m) } // library marker kkossev.commonLib, line 308
            break // library marker kkossev.commonLib, line 309
        default: // library marker kkossev.commonLib, line 310
            if (settings.logEnable) { // library marker kkossev.commonLib, line 311
                logWarn "zigbee received <b>unknown cluster:${descMap.cluster} (${descMap.clusterInt})</b> message (${descMap})" // library marker kkossev.commonLib, line 312
...
static void updateRxStats(final Map state) { // library marker kkossev.commonLib, line 318
    if (state.stats != null) { state.stats['rxCtr'] = (state.stats['rxCtr'] ?: 0) + 1 } else { state.stats = [:] }  // +5ms // library marker kkossev.commonLib, line 319
} // library marker kkossev.commonLib, line 320

boolean isChattyDeviceReport(final Map descMap)  {  // when @CompileStatis is slower? // library marker kkossev.commonLib, line 322
    if (_TRACE_ALL == true) { return false } // library marker kkossev.commonLib, line 323
    if (this.respondsTo('isSpammyDPsToNotTrace')) {  // defined in deviceProfileLib // library marker kkossev.commonLib, line 324
        return isSpammyDPsToNotTrace(descMap) // library marker kkossev.commonLib, line 325
    } // library marker kkossev.commonLib, line 326
    return false // library marker kkossev.commonLib, line 327
} // library marker kkossev.commonLib, line 328

boolean isSpammyDeviceReport(final Map descMap) { // library marker kkossev.commonLib, line 330
    if (_TRACE_ALL == true) { return false } // library marker kkossev.commonLib, line 331
    if (this.respondsTo('isSpammyDPsToIgnore')) {   // defined in deviceProfileLib // library marker kkossev.commonLib, line 332
        return isSpammyDPsToIgnore(descMap) // library marker kkossev.commonLib, line 333
    } // library marker kkossev.commonLib, line 334
    return false // library marker kkossev.commonLib, line 335
} // library marker kkossev.commonLib, line 336

boolean isSpammyTuyaRadar() { // library marker kkossev.commonLib, line 338
    if (_TRACE_ALL == true) { return false } // library marker kkossev.commonLib, line 339
    if (this.respondsTo('isSpammyDeviceProfile'())) {   // defined in deviceProfileLib // library marker kkossev.commonLib, line 340
        return isSpammyDeviceProfile() // library marker kkossev.commonLib, line 341
    } // library marker kkossev.commonLib, line 342
    return false // library marker kkossev.commonLib, line 343
} // library marker kkossev.commonLib, line 344

@Field static final Map<Integer, String> ZdoClusterEnum = [ // library marker kkossev.commonLib, line 346
    0x0002: 'Node Descriptor Request', // library marker kkossev.commonLib, line 347
    0x0005: 'Active Endpoints Request', // library marker kkossev.commonLib, line 348
    0x0006: 'Match Descriptor Request', // library marker kkossev.commonLib, line 349
    0x0022: 'Unbind Request', // library marker kkossev.commonLib, line 350
    0x0013: 'Device announce', // library marker kkossev.commonLib, line 351
    0x0034: 'Management Leave Request', // library marker kkossev.commonLib, line 352
    0x8002: 'Node Descriptor Response', // library marker kkossev.commonLib, line 353
    0x8004: 'Simple Descriptor Response', // library marker kkossev.commonLib, line 354
    0x8005: 'Active Endpoints Response', // library marker kkossev.commonLib, line 355
    0x801D: 'Extended Simple Descriptor Response', // library marker kkossev.commonLib, line 356
    0x801E: 'Extended Active Endpoint Response', // library marker kkossev.commonLib, line 357
    0x8021: 'Bind Response', // library marker kkossev.commonLib, line 358
    0x8022: 'Unbind Response', // library marker kkossev.commonLib, line 359
    0x8023: 'Bind Register Response', // library marker kkossev.commonLib, line 360
    0x8034: 'Management Leave Response' // library marker kkossev.commonLib, line 361
] // library marker kkossev.commonLib, line 362

/** // library marker kkossev.commonLib, line 364
 * ZDO (Zigbee Data Object) Clusters Parsing // library marker kkossev.commonLib, line 365
 * @param descMap Zigbee message in parsed map format // library marker kkossev.commonLib, line 366
 */ // library marker kkossev.commonLib, line 367
void parseZdoClusters(final Map descMap) { // library marker kkossev.commonLib, line 368
    if (state.stats == null) { state.stats = [:] }  // library marker kkossev.commonLib, line 369
    final Integer clusterId = descMap.clusterInt as Integer // library marker kkossev.commonLib, line 370
    final String clusterName = ZdoClusterEnum[clusterId] ?: "UNKNOWN_CLUSTER (0x${descMap.clusterId})" // library marker kkossev.commonLib, line 371
    final String statusHex = ((List)descMap.data)[1] // library marker kkossev.commonLib, line 372
    final Integer statusCode = hexStrToUnsignedInt(statusHex) // library marker kkossev.commonLib, line 373
    final String statusName = ZigbeeStatusEnum[statusCode] ?: "0x${statusHex}" // library marker kkossev.commonLib, line 374
    final String clusterInfo = "${device.displayName} Received ZDO ${clusterName} (0x${descMap.clusterId}) status ${statusName}" // library marker kkossev.commonLib, line 375
    switch (clusterId) { // library marker kkossev.commonLib, line 376
        case 0x0005 : // library marker kkossev.commonLib, line 377
            state.stats['activeEpRqCtr'] = (state.stats['activeEpRqCtr'] ?: 0) + 1 // library marker kkossev.commonLib, line 378
            if (settings?.logEnable) { log.info "${clusterInfo}, data=${descMap.data} (Sequence Number:${descMap.data[0]}, data:${descMap.data})" } // library marker kkossev.commonLib, line 379
            break // library marker kkossev.commonLib, line 380
        case 0x0006 : // library marker kkossev.commonLib, line 381
            state.stats['matchDescCtr'] = (state.stats['matchDescCtr'] ?: 0) + 1 // library marker kkossev.commonLib, line 382
            if (settings?.logEnable) { log.info "${clusterInfo}, data=${descMap.data} (Sequence Number:${descMap.data[0]}, Input cluster count:${descMap.data[5]} Input cluster: 0x${descMap.data[7] + descMap.data[6]})" } // library marker kkossev.commonLib, line 383
            break // library marker kkossev.commonLib, line 384
        case 0x0013 : // device announcement // library marker kkossev.commonLib, line 385
            state.stats['rejoinCtr'] = (state.stats['rejoinCtr'] ?: 0) + 1 // library marker kkossev.commonLib, line 386
            if (settings?.logEnable) { log.info "${clusterInfo}, rejoinCtr= ${state.stats['rejoinCtr']}, data=${descMap.data} (Sequence Number:${descMap.data[0]}, Device network ID: ${descMap.data[2] + descMap.data[1]}, Capability Information: ${descMap.data[11]})" } // library marker kkossev.commonLib, line 387
            break // library marker kkossev.commonLib, line 388
        case 0x8004 : // simple descriptor response // library marker kkossev.commonLib, line 389
            if (settings?.logEnable) { log.info "${clusterInfo}, data=${descMap.data} (Sequence Number:${descMap.data[0]}, status:${descMap.data[1]}, lenght:${hubitat.helper.HexUtils.hexStringToInt(descMap.data[4])}" } // library marker kkossev.commonLib, line 390
            //parseSimpleDescriptorResponse( descMap ) // library marker kkossev.commonLib, line 391
            break // library marker kkossev.commonLib, line 392
        case 0x8005 : // endpoint response // library marker kkossev.commonLib, line 393
            String endpointCount = descMap.data[4] // library marker kkossev.commonLib, line 394
            String endpointList = descMap.data[5] // library marker kkossev.commonLib, line 395
            if (settings?.logEnable) { log.info "${clusterInfo}, (endpoint response) endpointCount = ${endpointCount}  endpointList = ${endpointList}" } // library marker kkossev.commonLib, line 396
            break // library marker kkossev.commonLib, line 397
        case 0x8021 : // bind response // library marker kkossev.commonLib, line 398
            if (settings?.logEnable) { log.info "${clusterInfo}, data=${descMap.data} (Sequence Number:${descMap.data[0]}, Status: ${descMap.data[1] == '00' ? 'Success' : '<b>Failure</b>'})" } // library marker kkossev.commonLib, line 399
            break // library marker kkossev.commonLib, line 400
        case 0x8022 : //unbind request // library marker kkossev.commonLib, line 401
        case 0x8034 : //leave response // library marker kkossev.commonLib, line 402
            if (settings?.logEnable) { log.info "${clusterInfo}" } // library marker kkossev.commonLib, line 403
            break // library marker kkossev.commonLib, line 404
        default : // library marker kkossev.commonLib, line 405
            if (settings?.logEnable) { log.warn "${device.displayName} Unprocessed ZDO command: cluster=${descMap.clusterId} command=${descMap.command} attrId=${descMap.attrId} value=${descMap.value} data=${descMap.data}" } // library marker kkossev.commonLib, line 406
            break // library marker kkossev.commonLib, line 407
    } // library marker kkossev.commonLib, line 408
    if (this.respondsTo('customParseZdoClusters')) { customParseZdoClusters(descMap) } // library marker kkossev.commonLib, line 409
} // library marker kkossev.commonLib, line 410

/** // library marker kkossev.commonLib, line 412
 * Zigbee General Command Parsing // library marker kkossev.commonLib, line 413
 * @param descMap Zigbee message in parsed map format // library marker kkossev.commonLib, line 414
 */ // library marker kkossev.commonLib, line 415
void parseGeneralCommandResponse(final Map descMap) { // library marker kkossev.commonLib, line 416
    final int commandId = hexStrToUnsignedInt(descMap.command) // library marker kkossev.commonLib, line 417
    switch (commandId) { // library marker kkossev.commonLib, line 418
        case 0x01: // read attribute response // library marker kkossev.commonLib, line 419
            parseReadAttributeResponse(descMap) // library marker kkossev.commonLib, line 420
            break // library marker kkossev.commonLib, line 421
        case 0x04: // write attribute response // library marker kkossev.commonLib, line 422
            parseWriteAttributeResponse(descMap) // library marker kkossev.commonLib, line 423
            break // library marker kkossev.commonLib, line 424
        case 0x07: // configure reporting response // library marker kkossev.commonLib, line 425
            parseConfigureResponse(descMap) // library marker kkossev.commonLib, line 426
            break // library marker kkossev.commonLib, line 427
        case 0x09: // read reporting configuration response // library marker kkossev.commonLib, line 428
            parseReadReportingConfigResponse(descMap) // library marker kkossev.commonLib, line 429
            break // library marker kkossev.commonLib, line 430
        case 0x0B: // default command response // library marker kkossev.commonLib, line 431
            parseDefaultCommandResponse(descMap) // library marker kkossev.commonLib, line 432
            break // library marker kkossev.commonLib, line 433
        default: // library marker kkossev.commonLib, line 434
            final String commandName = ZigbeeGeneralCommandEnum[commandId] ?: "UNKNOWN_COMMAND (0x${descMap.command})" // library marker kkossev.commonLib, line 435
            final String clusterName = clusterLookup(descMap.clusterInt) // library marker kkossev.commonLib, line 436
            final String status = descMap.data in List ? ((List)descMap.data).last() : descMap.data // library marker kkossev.commonLib, line 437
            final int statusCode = hexStrToUnsignedInt(status) // library marker kkossev.commonLib, line 438
            final String statusName = ZigbeeStatusEnum[statusCode] ?: "0x${status}" // library marker kkossev.commonLib, line 439
            if (statusCode > 0x00) { // library marker kkossev.commonLib, line 440
                log.warn "zigbee ${commandName} ${clusterName} error: ${statusName}" // library marker kkossev.commonLib, line 441
            } else if (settings.logEnable) { // library marker kkossev.commonLib, line 442
                log.trace "zigbee ${commandName} ${clusterName}: ${descMap.data}" // library marker kkossev.commonLib, line 443
            } // library marker kkossev.commonLib, line 444
            break // library marker kkossev.commonLib, line 445
 ...
 * Zigbee Read Attribute Response Parsing // library marker kkossev.commonLib, line 450
...
void parseReadAttributeResponse(final Map descMap) { // library marker kkossev.commonLib, line 453
    final List<String> data = descMap.data as List<String> // library marker kkossev.commonLib, line 454
    final String attribute = data[1] + data[0] // library marker kkossev.commonLib, line 455
    final int statusCode = hexStrToUnsignedInt(data[2]) // library marker kkossev.commonLib, line 456
    final String status = ZigbeeStatusEnum[statusCode] ?: "0x${data}" // library marker kkossev.commonLib, line 457
    if (statusCode > 0x00) { // library marker kkossev.commonLib, line 458
        logWarn "zigbee read ${clusterLookup(descMap.clusterInt)} attribute 0x${attribute} error: ${status}" // library marker kkossev.commonLib, line 459
    } // library marker kkossev.commonLib, line 460
    else { // library marker kkossev.commonLib, line 461
        logDebug "zigbee read ${clusterLookup(descMap.clusterInt)} attribute 0x${attribute} response: ${status} ${data}" // library marker kkossev.commonLib, line 462
 ...
 * Zigbee Write Attribute Response Parsing // library marker kkossev.commonLib, line 467
...
void parseWriteAttributeResponse(final Map descMap) { // library marker kkossev.commonLib, line 470
    final String data = descMap.data in List ? ((List)descMap.data).first() : descMap.data // library marker kkossev.commonLib, line 471
    final int statusCode = hexStrToUnsignedInt(data) // library marker kkossev.commonLib, line 472
    final String statusName = ZigbeeStatusEnum[statusCode] ?: "0x${data}" // library marker kkossev.commonLib, line 473
    if (statusCode > 0x00) { // library marker kkossev.commonLib, line 474
        logWarn "zigbee response write ${clusterLookup(descMap.clusterInt)} attribute error: ${statusName}" // library marker kkossev.commonLib, line 475
    } // library marker kkossev.commonLib, line 476
    else { // library marker kkossev.commonLib, line 477
        logDebug "zigbee response write ${clusterLookup(descMap.clusterInt)} attribute response: ${statusName}" // library marker kkossev.commonLib, line 478
 ...
 * Zigbee Configure Reporting Response Parsing  - command 0x07 // library marker kkossev.commonLib, line 483
 */ // library marker kkossev.commonLib, line 484
void parseConfigureResponse(final Map descMap) { // library marker kkossev.commonLib, line 485
    // TODO - parse the details of the configuration respose - cluster, min, max, delta ... // library marker kkossev.commonLib, line 486
    final String status = ((List)descMap.data).first() // library marker kkossev.commonLib, line 487
    final int statusCode = hexStrToUnsignedInt(status) // library marker kkossev.commonLib, line 488
    if (statusCode == 0x00 && settings.enableReporting != false) { // library marker kkossev.commonLib, line 489
        state.reportingEnabled = true // library marker kkossev.commonLib, line 490
    } // library marker kkossev.commonLib, line 491
    final String statusName = ZigbeeStatusEnum[statusCode] ?: "0x${status}" // library marker kkossev.commonLib, line 492
    if (statusCode > 0x00) { // library marker kkossev.commonLib, line 493
        log.warn "zigbee configure reporting error: ${statusName} ${descMap.data}" // library marker kkossev.commonLib, line 494
    } else { // library marker kkossev.commonLib, line 495
        logDebug "zigbee configure reporting response: ${statusName} ${descMap.data}" // library marker kkossev.commonLib, line 496
 ...
 * Parses the response of reading reporting configuration - command 0x09 // library marker kkossev.commonLib, line 501
 */ // library marker kkossev.commonLib, line 502
void parseReadReportingConfigResponse(final Map descMap) { // library marker kkossev.commonLib, line 503
    // TS0121 Received Read Reporting Configuration Response (0x09) for cluster:0006 , data=[00, 00, 00, 00, 10, 00, 00, 58, 02] (Status: Success) min=0 max=600 // library marker kkossev.commonLib, line 504
    // TS0121 Received Read Reporting Configuration Response (0x09) for cluster:0702 , data=[00, 00, 00, 00, 25, 3C, 00, 10, 0E, 00, 00, 00, 00, 00, 00] (Status: Success) min=60 max=3600 // library marker kkossev.commonLib, line 505
    int status = zigbee.convertHexToInt(descMap.data[0])    // Status: Success (0x00) // library marker kkossev.commonLib, line 506
    //def attr = zigbee.convertHexToInt(descMap.data[3])*256 + zigbee.convertHexToInt(descMap.data[2])    // Attribute: OnOff (0x0000) // library marker kkossev.commonLib, line 507
    if (status == 0) { // library marker kkossev.commonLib, line 508
        //def dataType = zigbee.convertHexToInt(descMap.data[4])    // Data Type: Boolean (0x10) // library marker kkossev.commonLib, line 509
        int min = zigbee.convertHexToInt(descMap.data[6]) * 256 + zigbee.convertHexToInt(descMap.data[5]) // library marker kkossev.commonLib, line 510
        int max = zigbee.convertHexToInt(descMap.data[8] + descMap.data[7]) // library marker kkossev.commonLib, line 511
        int delta = 0 // library marker kkossev.commonLib, line 512
        if (descMap.data.size() >= 10) { // library marker kkossev.commonLib, line 513
            delta = zigbee.convertHexToInt(descMap.data[10] + descMap.data[9]) // library marker kkossev.commonLib, line 514
        } // library marker kkossev.commonLib, line 515
        else { // library marker kkossev.commonLib, line 516
            logTrace "descMap.data.size = ${descMap.data.size()}" // library marker kkossev.commonLib, line 517
        } // library marker kkossev.commonLib, line 518
        logDebug "Received Read Reporting Configuration Response (0x09) for cluster:${descMap.clusterId} attribute:${descMap.data[3] + descMap.data[2]}, data=${descMap.data} (Status: ${descMap.data[0] == '00' ? 'Success' : '<b>Failure</b>'}) min=${min} max=${max} delta=${delta}" // library marker kkossev.commonLib, line 519
    } // library marker kkossev.commonLib, line 520
    else { // library marker kkossev.commonLib, line 521
        logWarn "<b>Not Found (0x8b)</b> Read Reporting Configuration Response for cluster:${descMap.clusterId} attribute:${descMap.data[3] + descMap.data[2]}, data=${descMap.data} (Status: ${descMap.data[0] == '00' ? 'Success' : '<b>Failure</b>'})" // library marker kkossev.commonLib, line 522
    } // library marker kkossev.commonLib, line 523
} // library marker kkossev.commonLib, line 524

/* groovylint-disable-next-line MethodParameterTypeRequired */ // library marker kkossev.commonLib, line 526
def executeCustomHandler(String handlerName, handlerArgs) { // library marker kkossev.commonLib, line 527
    if (!this.respondsTo(handlerName)) { // library marker kkossev.commonLib, line 528
        logTrace "executeCustomHandler: function <b>${handlerName}</b> not found" // library marker kkossev.commonLib, line 529
        return false // library marker kkossev.commonLib, line 530
    } // library marker kkossev.commonLib, line 531
    // execute the customHandler function // library marker kkossev.commonLib, line 532
    boolean result = false // library marker kkossev.commonLib, line 533
    try { // library marker kkossev.commonLib, line 534
        result = "$handlerName"(handlerArgs) // library marker kkossev.commonLib, line 535
    } // library marker kkossev.commonLib, line 536
    catch (e) { // library marker kkossev.commonLib, line 537
        logWarn "executeCustomHandler: Exception '${e}'caught while processing <b>$handlerName</b>(<b>$handlerArgs</b>) (val=${fncmd}))" // library marker kkossev.commonLib, line 538
        return false // library marker kkossev.commonLib, line 539
    } // library marker kkossev.commonLib, line 540
    //logDebug "customSetFunction result is ${fncmd}" // library marker kkossev.commonLib, line 541
    return result // library marker kkossev.commonLib, line 542
} // library marker kkossev.commonLib, line 543

/** // library marker kkossev.commonLib, line 545
 * Zigbee Default Command Response Parsing // library marker kkossev.commonLib, line 546
 * @param descMap Zigbee message in parsed map format // library marker kkossev.commonLib, line 547
 */ // library marker kkossev.commonLib, line 548
void parseDefaultCommandResponse(final Map descMap) { // library marker kkossev.commonLib, line 549
    final List<String> data = descMap.data as List<String> // library marker kkossev.commonLib, line 550
    final String commandId = data[0] // library marker kkossev.commonLib, line 551
    final int statusCode = hexStrToUnsignedInt(data[1]) // library marker kkossev.commonLib, line 552
    final String status = ZigbeeStatusEnum[statusCode] ?: "0x${data[1]}" // library marker kkossev.commonLib, line 553
    if (statusCode > 0x00) { // library marker kkossev.commonLib, line 554
        logWarn "zigbee ${clusterLookup(descMap.clusterInt)} command 0x${commandId} error: ${status}" // library marker kkossev.commonLib, line 555
    } else { // library marker kkossev.commonLib, line 556
        logDebug "zigbee ${clusterLookup(descMap.clusterInt)} command 0x${commandId} response: ${status}" // library marker kkossev.commonLib, line 557
        // ZigUSB has its own interpretation of the Zigbee standards ... :( // library marker kkossev.commonLib, line 558
        if (this.respondsTo('customParseDefaultCommandResponse')) { // library marker kkossev.commonLib, line 559
            customParseDefaultCommandResponse(descMap) // library marker kkossev.commonLib, line 560
...
// Zigbee Attribute IDs // library marker kkossev.commonLib, line 565
...
@Field static final Map<Integer, String> ZigbeeStatusEnum = [ // library marker kkossev.commonLib, line 570
    0x00: 'Success', // library marker kkossev.commonLib, line 571
    0x01: 'Failure', // library marker kkossev.commonLib, line 572
    0x02: 'Not Authorized', // library marker kkossev.commonLib, line 573
    0x80: 'Malformed Command', // library marker kkossev.commonLib, line 574
    0x81: 'Unsupported COMMAND', // library marker kkossev.commonLib, line 575
    0x85: 'Invalid Field', // library marker kkossev.commonLib, line 576
    0x86: 'Unsupported Attribute', // library marker kkossev.commonLib, line 577
    0x87: 'Invalid Value', // library marker kkossev.commonLib, line 578
    0x88: 'Read Only', // library marker kkossev.commonLib, line 579
    0x89: 'Insufficient Space', // library marker kkossev.commonLib, line 580
    0x8A: 'Duplicate Exists', // library marker kkossev.commonLib, line 581
    0x8B: 'Not Found', // library marker kkossev.commonLib, line 582
    0x8C: 'Unreportable Attribute', // library marker kkossev.commonLib, line 583
    0x8D: 'Invalid Data Type', // library marker kkossev.commonLib, line 584
    0x8E: 'Invalid Selector', // library marker kkossev.commonLib, line 585
    0x94: 'Time out', // library marker kkossev.commonLib, line 586
    0x9A: 'Notification Pending', // library marker kkossev.commonLib, line 587
    0xC3: 'Unsupported Cluster' // library marker kkossev.commonLib, line 588
...
void parseXiaomiCluster(final Map descMap) { // library marker kkossev.commonLib, line 617
    if (xiaomiLibVersion() != null) { parseXiaomiClusterLib(descMap) } else { logWarn 'Xiaomi cluster 0xFCC0' } // library marker kkossev.commonLib, line 618
} // library marker kkossev.commonLib, line 619

@Field static final int ROLLING_AVERAGE_N = 10 // library marker kkossev.commonLib, line 621
BigDecimal approxRollingAverage(BigDecimal avgPar, BigDecimal newSample) { // library marker kkossev.commonLib, line 622
    BigDecimal avg = avgPar // library marker kkossev.commonLib, line 623
    if (avg == null || avg == 0) { avg = newSample } // library marker kkossev.commonLib, line 624
    avg -= avg / ROLLING_AVERAGE_N // library marker kkossev.commonLib, line 625
    avg += newSample / ROLLING_AVERAGE_N // library marker kkossev.commonLib, line 626
    return avg // library marker kkossev.commonLib, line 627
 ...
 * Standard clusters reporting handlers // library marker kkossev.commonLib, line 632
 * ----------------------------------------------------------------------------- // library marker kkossev.commonLib, line 633
*/ // library marker kkossev.commonLib, line 634
@Field static final Map powerSourceOpts =  [ defaultValue: 0, options: [0: 'unknown', 1: 'mains', 2: 'mains', 3: 'battery', 4: 'dc', 5: 'emergency mains', 6: 'emergency mains']] // library marker kkossev.commonLib, line 635

/** // library marker kkossev.commonLib, line 637
 * Zigbee Basic Cluster Parsing  0x0000 // library marker kkossev.commonLib, line 638
 * @param descMap Zigbee message in parsed map format // library marker kkossev.commonLib, line 639
 */ // library marker kkossev.commonLib, line 640
void parseBasicCluster(final Map descMap) { // library marker kkossev.commonLib, line 641
    Long now = new Date().getTime() // library marker kkossev.commonLib, line 642
    if (state.lastRx == null) { state.lastRx = [:] } // library marker kkossev.commonLib, line 643
    state.lastRx['checkInTime'] = now // library marker kkossev.commonLib, line 644
    switch (descMap.attrInt as Integer) { // library marker kkossev.commonLib, line 645
        case 0x0000: // library marker kkossev.commonLib, line 646
            logDebug "Basic cluster: ZCLVersion = ${descMap?.value}" // library marker kkossev.commonLib, line 647
            break // library marker kkossev.commonLib, line 648
        case PING_ATTR_ID: // 0x01 - Using 0x01 read as a simple ping/pong mechanism // library marker kkossev.commonLib, line 649
            boolean isPing = state.states['isPing'] ?: false // library marker kkossev.commonLib, line 650
            if (isPing) { // library marker kkossev.commonLib, line 651
                int timeRunning = now.toInteger() - (state.lastTx['pingTime'] ?: '0').toInteger() // library marker kkossev.commonLib, line 652
                if (timeRunning > 0 && timeRunning < MAX_PING_MILISECONDS) { // library marker kkossev.commonLib, line 653
                    state.stats['pingsOK'] = (state.stats['pingsOK'] ?: 0) + 1 // library marker kkossev.commonLib, line 654
                    if (timeRunning < safeToInt((state.stats['pingsMin'] ?: '999'))) { state.stats['pingsMin'] = timeRunning } // library marker kkossev.commonLib, line 655
                    if (timeRunning > safeToInt((state.stats['pingsMax'] ?: '0')))   { state.stats['pingsMax'] = timeRunning } // library marker kkossev.commonLib, line 656
                    state.stats['pingsAvg'] = approxRollingAverage(safeToDouble(state.stats['pingsAvg']), safeToDouble(timeRunning)) as int // library marker kkossev.commonLib, line 657
                    sendRttEvent() // library marker kkossev.commonLib, line 658
                } // library marker kkossev.commonLib, line 659
                else { // library marker kkossev.commonLib, line 660
                    logWarn "unexpected ping timeRunning=${timeRunning} " // library marker kkossev.commonLib, line 661
                } // library marker kkossev.commonLib, line 662
                state.states['isPing'] = false // library marker kkossev.commonLib, line 663
            } // library marker kkossev.commonLib, line 664
            else { // library marker kkossev.commonLib, line 665
                logTrace "Tuya check-in message (attribute ${descMap.attrId} reported: ${descMap.value})" // library marker kkossev.commonLib, line 666
            } // library marker kkossev.commonLib, line 667
            break // library marker kkossev.commonLib, line 668
        case 0x0004: // library marker kkossev.commonLib, line 669
            logDebug "received device manufacturer ${descMap?.value}" // library marker kkossev.commonLib, line 670
            // received device manufacturer IKEA of Sweden // library marker kkossev.commonLib, line 671
            String manufacturer = device.getDataValue('manufacturer') // library marker kkossev.commonLib, line 672
            if ((manufacturer == null || manufacturer == 'unknown') && (descMap?.value != null)) { // library marker kkossev.commonLib, line 673
                logWarn "updating device manufacturer from ${manufacturer} to ${descMap?.value}" // library marker kkossev.commonLib, line 674
                device.updateDataValue('manufacturer', descMap?.value) // library marker kkossev.commonLib, line 675
            } // library marker kkossev.commonLib, line 676
            break // library marker kkossev.commonLib, line 677
        case 0x0005: // library marker kkossev.commonLib, line 678
            logDebug "received device model ${descMap?.value}" // library marker kkossev.commonLib, line 679
            // received device model Remote Control N2 // library marker kkossev.commonLib, line 680
            String model = device.getDataValue('model') // library marker kkossev.commonLib, line 681
            if ((model == null || model == 'unknown') && (descMap?.value != null)) { // library marker kkossev.commonLib, line 682
                logWarn "updating device model from ${model} to ${descMap?.value}" // library marker kkossev.commonLib, line 683
                device.updateDataValue('model', descMap?.value) // library marker kkossev.commonLib, line 684
            } // library marker kkossev.commonLib, line 685
            break // library marker kkossev.commonLib, line 686
        case 0x0007: // library marker kkossev.commonLib, line 687
            String powerSourceReported = powerSourceOpts.options[descMap?.value as int] // library marker kkossev.commonLib, line 688
            logDebug "received Power source <b>${powerSourceReported}</b> (${descMap?.value})" // library marker kkossev.commonLib, line 689
            //powerSourceEvent( powerSourceReported ) // library marker kkossev.commonLib, line 690
            break // library marker kkossev.commonLib, line 691
        case 0xFFDF: // library marker kkossev.commonLib, line 692
            logDebug "Tuya check-in (Cluster Revision=${descMap?.value})" // library marker kkossev.commonLib, line 693
            break // library marker kkossev.commonLib, line 694
        case 0xFFE2: // library marker kkossev.commonLib, line 695
            logDebug "Tuya check-in (AppVersion=${descMap?.value})" // library marker kkossev.commonLib, line 696
            break // library marker kkossev.commonLib, line 697
        case [0xFFE0, 0xFFE1, 0xFFE3, 0xFFE4] : // library marker kkossev.commonLib, line 698
            logTrace "Tuya attribute ${descMap?.attrId} value=${descMap?.value}" // library marker kkossev.commonLib, line 699
            break // library marker kkossev.commonLib, line 700
        case 0xFFFE: // library marker kkossev.commonLib, line 701
            logTrace "Tuya attributeReportingStatus (attribute FFFE) value=${descMap?.value}" // library marker kkossev.commonLib, line 702
            break // library marker kkossev.commonLib, line 703
        case FIRMWARE_VERSION_ID:    // 0x4000 // library marker kkossev.commonLib, line 704
            final String version = descMap.value ?: 'unknown' // library marker kkossev.commonLib, line 705
            log.info "device firmware version is ${version}" // library marker kkossev.commonLib, line 706
            updateDataValue('softwareBuild', version) // library marker kkossev.commonLib, line 707
            break // library marker kkossev.commonLib, line 708
        default: // library marker kkossev.commonLib, line 709
            logWarn "zigbee received unknown Basic cluster attribute 0x${descMap.attrId} (value ${descMap.value})" // library marker kkossev.commonLib, line 710
...
void parsePowerCluster(final Map descMap) { // library marker kkossev.commonLib, line 716
    if (descMap.value == null || descMap.value == 'FFFF') { return } // invalid or unknown value // library marker kkossev.commonLib, line 717
    if (descMap.attrId in ['0020', '0021']) { // library marker kkossev.commonLib, line 718
        state.lastRx['batteryTime'] = new Date().getTime() // library marker kkossev.commonLib, line 719
        state.stats['battCtr'] = (state.stats['battCtr'] ?: 0) + 1 // library marker kkossev.commonLib, line 720
    } // library marker kkossev.commonLib, line 721
    if (this.respondsTo('customParsePowerCluster')) { // library marker kkossev.commonLib, line 722
        customParsePowerCluster(descMap) // library marker kkossev.commonLib, line 723
    } // library marker kkossev.commonLib, line 724
    else { // library marker kkossev.commonLib, line 725
        logDebug "zigbee received Power cluster attribute 0x${descMap.attrId} (value ${descMap.value})" // library marker kkossev.commonLib, line 726
    } // library marker kkossev.commonLib, line 727
} // library marker kkossev.commonLib, line 728

/* groovylint-disable-next-line UnusedMethodParameter */ // library marker kkossev.commonLib, line 730
void parseIdentityCluster(final Map descMap) { logDebug 'unprocessed parseIdentityCluster' } // library marker kkossev.commonLib, line 731

void parseScenesCluster(final Map descMap) { // library marker kkossev.commonLib, line 733
    if (this.respondsTo('customParseScenesCluster')) { customParseScenesCluster(descMap) } else { logWarn "unprocessed ScenesCluster attribute ${descMap.attrId}" } // library marker kkossev.commonLib, line 734
} // library marker kkossev.commonLib, line 735

void parseGroupsCluster(final Map descMap) { // library marker kkossev.commonLib, line 737
    if (this.respondsTo('customParseGroupsCluster')) { customParseGroupsCluster(descMap) } else { logWarn "unprocessed GroupsCluster attribute ${descMap.attrId}" } // library marker kkossev.commonLib, line 738
 ...
 * on/off cluster            0x0006 // library marker kkossev.commonLib, line 743
 * ----------------------------------------------------------------------------- // library marker kkossev.commonLib, line 744
*/ // library marker kkossev.commonLib, line 745

void parseOnOffCluster(final Map descMap) { // library marker kkossev.commonLib, line 747
    if (this.respondsTo('customParseOnOffCluster')) { // library marker kkossev.commonLib, line 748
        customParseOnOffCluster(descMap) // library marker kkossev.commonLib, line 749
    } // library marker kkossev.commonLib, line 750
    else if (descMap.attrId == '0000') { // library marker kkossev.commonLib, line 751
        if (descMap.value == null || descMap.value == 'FFFF') { logDebug "parseOnOffCluster: invalid value: ${descMap.value}"; return } // invalid or unknown value // library marker kkossev.commonLib, line 752
        int rawValue = hexStrToUnsignedInt(descMap.value) // library marker kkossev.commonLib, line 753
        sendSwitchEvent(rawValue) // library marker kkossev.commonLib, line 754
    } // library marker kkossev.commonLib, line 755
    else if (descMap.attrId in ['4000', '4001', '4002', '4004', '8000', '8001', '8002', '8003']) { // library marker kkossev.commonLib, line 756
        parseOnOffAttributes(descMap) // library marker kkossev.commonLib, line 757
    } // library marker kkossev.commonLib, line 758
    else { // library marker kkossev.commonLib, line 759
        if (descMap.attrId != null) { logWarn "parseOnOffCluster: unprocessed attrId ${descMap.attrId}"  } // library marker kkossev.commonLib, line 760
        else { logDebug "parseOnOffCluster: skipped processing OnOIff cluster (attrId is ${descMap.attrId})" } // ZigUSB has its own interpretation of the Zigbee standards ... :( // library marker kkossev.commonLib, line 761
    } // library marker kkossev.commonLib, line 762
} // library marker kkossev.commonLib, line 763

void clearIsDigital()        { state.states['isDigital'] = false } // library marker kkossev.commonLib, line 765
void switchDebouncingClear() { state.states['debounce']  = false } // library marker kkossev.commonLib, line 766
void isRefreshRequestClear() { state.states['isRefresh'] = false } // library marker kkossev.commonLib, line 767

void toggle() { // library marker kkossev.commonLib, line 769
    String descriptionText = 'central button switch is ' // library marker kkossev.commonLib, line 770
    String state = '' // library marker kkossev.commonLib, line 771
    if ((device.currentState('switch')?.value ?: 'n/a') == 'off') { // library marker kkossev.commonLib, line 772
        state = 'on' // library marker kkossev.commonLib, line 773
    } // library marker kkossev.commonLib, line 774
    else { // library marker kkossev.commonLib, line 775
        state = 'off' // library marker kkossev.commonLib, line 776
    } // library marker kkossev.commonLib, line 777
    descriptionText += state // library marker kkossev.commonLib, line 778
    sendEvent(name: 'switch', value: state, descriptionText: descriptionText, type: 'physical', isStateChange: true) // library marker kkossev.commonLib, line 779
    logInfo "${descriptionText}" // library marker kkossev.commonLib, line 780
} // library marker kkossev.commonLib, line 781

void off() { // library marker kkossev.commonLib, line 783
    if (this.respondsTo('customOff')) { // library marker kkossev.commonLib, line 784
        customOff() // library marker kkossev.commonLib, line 785
        return // library marker kkossev.commonLib, line 786
    } // library marker kkossev.commonLib, line 787
    if ((settings?.alwaysOn ?: false) == true) { // library marker kkossev.commonLib, line 788
        logWarn "AlwaysOn option for ${device.displayName} is enabled , the command to switch it OFF is ignored!" // library marker kkossev.commonLib, line 789
        return // library marker kkossev.commonLib, line 790
    } // library marker kkossev.commonLib, line 791
    List<String> cmds = (settings?.inverceSwitch == null || settings?.inverceSwitch == false) ?  zigbee.off()  : zigbee.on() // library marker kkossev.commonLib, line 792
    String currentState = device.currentState('switch')?.value ?: 'n/a' // library marker kkossev.commonLib, line 793
    logDebug "off() currentState=${currentState}" // library marker kkossev.commonLib, line 794
    if (_THREE_STATE == true && settings?.threeStateEnable == true) { // library marker kkossev.commonLib, line 795
        if (currentState == 'off') { // library marker kkossev.commonLib, line 796
            runIn(1, 'refresh',  [overwrite: true]) // library marker kkossev.commonLib, line 797
        } // library marker kkossev.commonLib, line 798
        String value = SwitchThreeStateOpts.options[2]    // 'switching_on' // library marker kkossev.commonLib, line 799
        String descriptionText = "${value}" // library marker kkossev.commonLib, line 800
        if (logEnable) { descriptionText += ' (2)' } // library marker kkossev.commonLib, line 801
        sendEvent(name: 'switch', value: value, descriptionText: descriptionText, type: 'digital', isStateChange: true) // library marker kkossev.commonLib, line 802
        logInfo "${descriptionText}" // library marker kkossev.commonLib, line 803
    ...
    /* // library marker kkossev.commonLib, line 805
        ...
        if (currentState != 'off') { // library marker kkossev.commonLib, line 807
            logDebug "Switching ${device.displayName} Off" // library marker kkossev.commonLib, line 808
        } // library marker kkossev.commonLib, line 809
        else { // library marker kkossev.commonLib, line 810
            logDebug "ignoring off command for ${device.displayName} - already off" // library marker kkossev.commonLib, line 811
    ...
    */ // library marker kkossev.commonLib, line 815
    ...
    state.states['isDigital'] = true // library marker kkossev.commonLib, line 817
    runInMillis(DIGITAL_TIMER, clearIsDigital, [overwrite: true]) // library marker kkossev.commonLib, line 818
    sendZigbeeCommands(cmds) // library marker kkossev.commonLib, line 819
} // library marker kkossev.commonLib, line 820

void on() { // library marker kkossev.commonLib, line 822
    if (this.respondsTo('customOn')) { // library marker kkossev.commonLib, line 823
        customOn() // library marker kkossev.commonLib, line 824
        return // library marker kkossev.commonLib, line 825
    } // library marker kkossev.commonLib, line 826
    List<String> cmds = (settings?.inverceSwitch == null || settings?.inverceSwitch == false) ?  zigbee.on()  : zigbee.off() // library marker kkossev.commonLib, line 827
    String currentState = device.currentState('switch')?.value ?: 'n/a' // library marker kkossev.commonLib, line 828
    logDebug "on() currentState=${currentState}" // library marker kkossev.commonLib, line 829
    if (_THREE_STATE == true && settings?.threeStateEnable == true) { // library marker kkossev.commonLib, line 830
        if ((device.currentState('switch')?.value ?: 'n/a') == 'on') { // library marker kkossev.commonLib, line 831
            runIn(1, 'refresh',  [overwrite: true]) // library marker kkossev.commonLib, line 832
        } // library marker kkossev.commonLib, line 833
        String value = SwitchThreeStateOpts.options[3]    // 'switching_on' // library marker kkossev.commonLib, line 834
        String descriptionText = "${value}" // library marker kkossev.commonLib, line 835
        if (logEnable) { descriptionText += ' (2)' } // library marker kkossev.commonLib, line 836
        sendEvent(name: 'switch', value: value, descriptionText: descriptionText, type: 'digital', isStateChange: true) // library marker kkossev.commonLib, line 837
        logInfo "${descriptionText}" // library marker kkossev.commonLib, line 838
    } // library marker kkossev.commonLib, line 839
    /* // library marker kkossev.commonLib, line 840
    else { // library marker kkossev.commonLib, line 841
        if (currentState != 'on') { // library marker kkossev.commonLib, line 842
            logDebug "Switching ${device.displayName} On" // library marker kkossev.commonLib, line 843
        } // library marker kkossev.commonLib, line 844
        else { // library marker kkossev.commonLib, line 845
            logDebug "ignoring on command for ${device.displayName} - already on" // library marker kkossev.commonLib, line 846
    ...
    */ // library marker kkossev.commonLib, line 850
    state.states['isDigital'] = true // library marker kkossev.commonLib, line 851
    runInMillis(DIGITAL_TIMER, clearIsDigital, [overwrite: true]) // library marker kkossev.commonLib, line 852
    sendZigbeeCommands(cmds) // library marker kkossev.commonLib, line 853
} // library marker kkossev.commonLib, line 854

void sendSwitchEvent(int switchValuePar) { // library marker kkossev.commonLib, line 856
    int switchValue = safeToInt(switchValuePar) // library marker kkossev.commonLib, line 857
    if (settings?.inverceSwitch != null && settings?.inverceSwitch == true) { // library marker kkossev.commonLib, line 858
        switchValue = (switchValue == 0x00) ? 0x01 : 0x00 // library marker kkossev.commonLib, line 859
    } // library marker kkossev.commonLib, line 860
    String value = (switchValue == null) ? 'unknown' : (switchValue == 0x00) ? 'off' : (switchValue == 0x01) ? 'on' : 'unknown' // library marker kkossev.commonLib, line 861
    Map map = [:] // library marker kkossev.commonLib, line 862
    boolean debounce = state.states['debounce'] ?: false // library marker kkossev.commonLib, line 863
    String lastSwitch = state.states['lastSwitch'] ?: 'unknown' // library marker kkossev.commonLib, line 864
    if (value == lastSwitch && (debounce || (settings.ignoreDuplicated ?: false))) { // library marker kkossev.commonLib, line 865
        logDebug "Ignored duplicated switch event ${value}" // library marker kkossev.commonLib, line 866
        runInMillis(DEBOUNCING_TIMER, switchDebouncingClear, [overwrite: true]) // library marker kkossev.commonLib, line 867
        return // library marker kkossev.commonLib, line 868
    } // library marker kkossev.commonLib, line 869
    logTrace "value=${value}  lastSwitch=${state.states['lastSwitch']}" // library marker kkossev.commonLib, line 870
    boolean isDigital = state.states['isDigital'] ?: false // library marker kkossev.commonLib, line 871
    map.type = isDigital ? 'digital' : 'physical' // library marker kkossev.commonLib, line 872
    if (lastSwitch != value) { // library marker kkossev.commonLib, line 873
        logDebug "switch state changed from <b>${lastSwitch}</b> to <b>${value}</b>" // library marker kkossev.commonLib, line 874
        state.states['debounce'] = true // library marker kkossev.commonLib, line 875
        state.states['lastSwitch'] = value // library marker kkossev.commonLib, line 876
        runInMillis(DEBOUNCING_TIMER, switchDebouncingClear, [overwrite: true]) // library marker kkossev.commonLib, line 877
    } else { // library marker kkossev.commonLib, line 878
        state.states['debounce'] = true // library marker kkossev.commonLib, line 879
        runInMillis(DEBOUNCING_TIMER, switchDebouncingClear, [overwrite: true]) // library marker kkossev.commonLib, line 880
    } // library marker kkossev.commonLib, line 881
    map.name = 'switch' // library marker kkossev.commonLib, line 882
    map.value = value // library marker kkossev.commonLib, line 883
    boolean isRefresh = state.states['isRefresh'] ?: false // library marker kkossev.commonLib, line 884
    if (isRefresh) { // library marker kkossev.commonLib, line 885
        map.descriptionText = "${device.displayName} is ${value} [Refresh]" // library marker kkossev.commonLib, line 886
        map.isStateChange = true // library marker kkossev.commonLib, line 887
    } else { // library marker kkossev.commonLib, line 888
        map.descriptionText = "${device.displayName} is ${value} [${map.type}]" // library marker kkossev.commonLib, line 889
    } // library marker kkossev.commonLib, line 890
    logInfo "${map.descriptionText}" // library marker kkossev.commonLib, line 891
    sendEvent(map) // library marker kkossev.commonLib, line 892
    clearIsDigital() // library marker kkossev.commonLib, line 893
    if (this.respondsTo('customSwitchEventPostProcesing')) { // library marker kkossev.commonLib, line 894
        customSwitchEventPostProcesing(map) // library marker kkossev.commonLib, line 895
    } // library marker kkossev.commonLib, line 896
} // library marker kkossev.commonLib, line 897

@Field static final Map powerOnBehaviourOptions = [ // library marker kkossev.commonLib, line 899
    '0': 'switch off', // library marker kkossev.commonLib, line 900
    '1': 'switch on', // library marker kkossev.commonLib, line 901
    '2': 'switch last state' // library marker kkossev.commonLib, line 902
] // library marker kkossev.commonLib, line 903

@Field static final Map switchTypeOptions = [ // library marker kkossev.commonLib, line 905
    '0': 'toggle', // library marker kkossev.commonLib, line 906
    '1': 'state', // library marker kkossev.commonLib, line 907
    '2': 'momentary' // library marker kkossev.commonLib, line 908
] // library marker kkossev.commonLib, line 909

Map myParseDescriptionAsMap(String description) { // library marker kkossev.commonLib, line 911
    Map descMap = [:] // library marker kkossev.commonLib, line 912
    try { // library marker kkossev.commonLib, line 913
        descMap = zigbee.parseDescriptionAsMap(description) // library marker kkossev.commonLib, line 914
    } // library marker kkossev.commonLib, line 915
    catch (e1) { // library marker kkossev.commonLib, line 916
        logWarn "exception ${e1} caught while parseDescriptionAsMap <b>myParseDescriptionAsMap</b> description:  ${description}" // library marker kkossev.commonLib, line 917
        // try alternative custom parsing // library marker kkossev.commonLib, line 918
        descMap = [:] // library marker kkossev.commonLib, line 919
        try { // library marker kkossev.commonLib, line 920
            descMap += description.replaceAll('\\[|\\]', '').split(',').collectEntries { entry -> // library marker kkossev.commonLib, line 921
                List<String> pair = entry.split(':') // library marker kkossev.commonLib, line 922
                [(pair.first().trim()): pair.last().trim()] // library marker kkossev.commonLib, line 923
            } // library marker kkossev.commonLib, line 924
        } // library marker kkossev.commonLib, line 925
        catch (e2) { // library marker kkossev.commonLib, line 926
            logWarn "exception ${e2} caught while parsing using an alternative method <b>myParseDescriptionAsMap</b> description:  ${description}" // library marker kkossev.commonLib, line 927
            return [:] // library marker kkossev.commonLib, line 928
        } // library marker kkossev.commonLib, line 929
        logDebug "alternative method parsing success: descMap=${descMap}" // library marker kkossev.commonLib, line 930
    } // library marker kkossev.commonLib, line 931
    return descMap // library marker kkossev.commonLib, line 932
} // library marker kkossev.commonLib, line 933

boolean isTuyaE00xCluster(String description) { // library marker kkossev.commonLib, line 935
    if (description == null || !(description.indexOf('cluster: E000') >= 0 || description.indexOf('cluster: E001') >= 0)) { // library marker kkossev.commonLib, line 936
        return false // library marker kkossev.commonLib, line 937
    } // library marker kkossev.commonLib, line 938
    // try to parse ... // library marker kkossev.commonLib, line 939
    //logDebug "Tuya cluster: E000 or E001 - try to parse it..." // library marker kkossev.commonLib, line 940
    Map descMap = [:] // library marker kkossev.commonLib, line 941
    try { // library marker kkossev.commonLib, line 942
        descMap = zigbee.parseDescriptionAsMap(description) // library marker kkossev.commonLib, line 943
        logDebug "TuyaE00xCluster Desc Map: ${descMap}" // library marker kkossev.commonLib, line 944
    } // library marker kkossev.commonLib, line 945
    catch (e) { // library marker kkossev.commonLib, line 946
        logDebug "<b>exception</b> caught while parsing description:  ${description}" // library marker kkossev.commonLib, line 947
        logDebug "TuyaE00xCluster Desc Map: ${descMap}" // library marker kkossev.commonLib, line 948
        // cluster E001 is the one that is generating exceptions... // library marker kkossev.commonLib, line 949
        return true // library marker kkossev.commonLib, line 950
    } // library marker kkossev.commonLib, line 951

    if (descMap.cluster == 'E000' && descMap.attrId in ['D001', 'D002', 'D003']) { // library marker kkossev.commonLib, line 953
        logDebug "Tuya Specific cluster ${descMap.cluster} attribute ${descMap.attrId} value is ${descMap.value}" // library marker kkossev.commonLib, line 954
    } // library marker kkossev.commonLib, line 955
    else if (descMap.cluster == 'E001' && descMap.attrId == 'D010') { // library marker kkossev.commonLib, line 956
        if (settings?.logEnable) { logInfo "power on behavior is <b>${powerOnBehaviourOptions[safeToInt(descMap.value).toString()]}</b> (${descMap.value})" } // library marker kkossev.commonLib, line 957
    } // library marker kkossev.commonLib, line 958
    else if (descMap.cluster == 'E001' && descMap.attrId == 'D030') { // library marker kkossev.commonLib, line 959
        if (settings?.logEnable) { logInfo "swith type is <b>${switchTypeOptions[safeToInt(descMap.value).toString()]}</b> (${descMap.value})" } // library marker kkossev.commonLib, line 960
    } // library marker kkossev.commonLib, line 961
    else { // library marker kkossev.commonLib, line 962
        logDebug "<b>unprocessed</b> TuyaE00xCluster Desc Map: $descMap" // library marker kkossev.commonLib, line 963
        return false // library marker kkossev.commonLib, line 964
    } // library marker kkossev.commonLib, line 965
    return true    // processed // library marker kkossev.commonLib, line 966
} // library marker kkossev.commonLib, line 967

// return true if further processing in the main parse method should be cancelled ! // library marker kkossev.commonLib, line 969
boolean otherTuyaOddities(final String description) { // library marker kkossev.commonLib, line 970
  /* // library marker kkossev.commonLib, line 971
    if (description.indexOf('cluster: 0000') >= 0 && description.indexOf('attrId: 0004') >= 0) { // library marker kkossev.commonLib, line 972
        if (logEnable) log.debug "${device.displayName} skipping Tuya parse of  cluster 0 attrId 4"             // parseDescriptionAsMap throws exception when processing Tuya cluster 0 attrId 4 // library marker kkossev.commonLib, line 973
        return true // library marker kkossev.commonLib, line 974
    } // library marker kkossev.commonLib, line 975
*/ // library marker kkossev.commonLib, line 976
    Map descMap = [:] // library marker kkossev.commonLib, line 977
    try { // library marker kkossev.commonLib, line 978
        descMap = zigbee.parseDescriptionAsMap(description) // library marker kkossev.commonLib, line 979
    } // library marker kkossev.commonLib, line 980
    catch (e1) { // library marker kkossev.commonLib, line 981
        logWarn "exception ${e1} caught while parseDescriptionAsMap <b>otherTuyaOddities</b> description:  ${description}" // library marker kkossev.commonLib, line 982
        // try alternative custom parsing // library marker kkossev.commonLib, line 983
        descMap = [:] // library marker kkossev.commonLib, line 984
        try { // library marker kkossev.commonLib, line 985
            descMap += description.replaceAll('\\[|\\]', '').split(',').collectEntries { entry -> // library marker kkossev.commonLib, line 986
                List<String> pair = entry.split(':') // library marker kkossev.commonLib, line 987
                [(pair.first().trim()): pair.last().trim()] // library marker kkossev.commonLib, line 988
            } // library marker kkossev.commonLib, line 989
        } // library marker kkossev.commonLib, line 990
        catch (e2) { // library marker kkossev.commonLib, line 991
            logWarn "exception ${e2} caught while parsing using an alternative method <b>otherTuyaOddities</b> description:  ${description}" // library marker kkossev.commonLib, line 992
            return true // library marker kkossev.commonLib, line 993
        } // library marker kkossev.commonLib, line 994
        logDebug "alternative method parsing success: descMap=${descMap}" // library marker kkossev.commonLib, line 995
    } // library marker kkossev.commonLib, line 996
    //if (logEnable) {log.trace "${device.displayName} Checking Tuya Oddities Desc Map: $descMap"} // library marker kkossev.commonLib, line 997
    if (descMap.attrId == null) { // library marker kkossev.commonLib, line 998
        //logDebug "otherTuyaOddities: descMap = ${descMap}" // library marker kkossev.commonLib, line 999
        //if (logEnable) log.trace "${device.displayName} otherTuyaOddities - Cluster ${descMap.clusterId} NO ATTRIBUTE, skipping" // library marker kkossev.commonLib, line 1000
        return false // library marker kkossev.commonLib, line 1001
    } // library marker kkossev.commonLib, line 1002
    boolean bWasAtLeastOneAttributeProcessed = false // library marker kkossev.commonLib, line 1003
    boolean bWasThereAnyStandardAttribite = false // library marker kkossev.commonLib, line 1004
    // attribute report received // library marker kkossev.commonLib, line 1005
    List attrData = [[cluster: descMap.cluster ,attrId: descMap.attrId, value: descMap.value, status: descMap.status]] // library marker kkossev.commonLib, line 1006
    descMap.additionalAttrs.each { // library marker kkossev.commonLib, line 1007
        attrData << [cluster: descMap.cluster, attrId: it.attrId, value: it.value, status: it.status] // library marker kkossev.commonLib, line 1008
    //log.trace "Tuya oddity: filling in attrData ${attrData}" // library marker kkossev.commonLib, line 1009
    } // library marker kkossev.commonLib, line 1010
    attrData.each { // library marker kkossev.commonLib, line 1011
        //log.trace "each it=${it}" // library marker kkossev.commonLib, line 1012
        //def map = [:] // library marker kkossev.commonLib, line 1013
        if (it.status == '86') { // library marker kkossev.commonLib, line 1014
            logWarn "Tuya Cluster ${descMap.cluster} unsupported attrId ${it.attrId}" // library marker kkossev.commonLib, line 1015
        // TODO - skip parsing? // library marker kkossev.commonLib, line 1016
        } // library marker kkossev.commonLib, line 1017
        switch (it.cluster) { // library marker kkossev.commonLib, line 1018
            case '0000' : // library marker kkossev.commonLib, line 1019
                if (it.attrId in ['FFE0', 'FFE1', 'FFE2', 'FFE4']) { // library marker kkossev.commonLib, line 1020
                    logTrace "Cluster ${descMap.cluster} Tuya specific attrId ${it.attrId} value ${it.value})" // library marker kkossev.commonLib, line 1021
                    bWasAtLeastOneAttributeProcessed = true // library marker kkossev.commonLib, line 1022
                } // library marker kkossev.commonLib, line 1023
                else if (it.attrId in ['FFFE', 'FFDF']) { // library marker kkossev.commonLib, line 1024
                    logTrace "Cluster ${descMap.cluster} Tuya specific attrId ${it.attrId} value ${it.value})" // library marker kkossev.commonLib, line 1025
                    bWasAtLeastOneAttributeProcessed = true // library marker kkossev.commonLib, line 1026
                } // library marker kkossev.commonLib, line 1027
                else { // library marker kkossev.commonLib, line 1028
                    //logDebug "otherTuyaOddities? - Cluster ${descMap.cluster} attrId ${it.attrId} value ${it.value}) N/A, skipping" // library marker kkossev.commonLib, line 1029
                    bWasThereAnyStandardAttribite = true // library marker kkossev.commonLib, line 1030
                } // library marker kkossev.commonLib, line 1031
                break // library marker kkossev.commonLib, line 1032
            default : // library marker kkossev.commonLib, line 1033
                //if (logEnable) log.trace "${device.displayName} otherTuyaOddities - Cluster ${it.cluster} N/A, skipping" // library marker kkossev.commonLib, line 1034
                break // library marker kkossev.commonLib, line 1035
        } // switch // library marker kkossev.commonLib, line 1036
    } // for each attribute // library marker kkossev.commonLib, line 1037
    return bWasAtLeastOneAttributeProcessed && !bWasThereAnyStandardAttribite // library marker kkossev.commonLib, line 1038
} // library marker kkossev.commonLib, line 1039

private boolean isCircuitBreaker()      { device.getDataValue('manufacturer') in ['_TZ3000_ky0fq4ho'] } // library marker kkossev.commonLib, line 1041

void parseOnOffAttributes(final Map it) { // library marker kkossev.commonLib, line 1043
    logDebug "OnOff attribute ${it.attrId} cluster ${it.cluster } reported: value=${it.value}" // library marker kkossev.commonLib, line 1044
    /* groovylint-disable-next-line VariableTypeRequired */ // library marker kkossev.commonLib, line 1045
    def mode // library marker kkossev.commonLib, line 1046
    String attrName // library marker kkossev.commonLib, line 1047
    if (it.value == null) { // library marker kkossev.commonLib, line 1048
        logDebug "OnOff attribute ${it.attrId} cluster ${it.cluster } skipping NULL value status=${it.status}" // library marker kkossev.commonLib, line 1049
        return // library marker kkossev.commonLib, line 1050
    } // library marker kkossev.commonLib, line 1051
    int value = zigbee.convertHexToInt(it.value) // library marker kkossev.commonLib, line 1052
    switch (it.attrId) { // library marker kkossev.commonLib, line 1053
        case '4000' :    // non-Tuya GlobalSceneControl (bool), read-only // library marker kkossev.commonLib, line 1054
            attrName = 'Global Scene Control' // library marker kkossev.commonLib, line 1055
            mode = value == 0 ? 'off' : value == 1 ? 'on' : null // library marker kkossev.commonLib, line 1056
            break // library marker kkossev.commonLib, line 1057
        case '4001' :    // non-Tuya OnTime (UINT16), read-only // library marker kkossev.commonLib, line 1058
            attrName = 'On Time' // library marker kkossev.commonLib, line 1059
            mode = value // library marker kkossev.commonLib, line 1060
            break // library marker kkossev.commonLib, line 1061
        case '4002' :    // non-Tuya OffWaitTime (UINT16), read-only // library marker kkossev.commonLib, line 1062
            attrName = 'Off Wait Time' // library marker kkossev.commonLib, line 1063
            mode = value // library marker kkossev.commonLib, line 1064
            break // library marker kkossev.commonLib, line 1065
        case '4003' :    // non-Tuya "powerOnState" (ENUM8), read-write, default=1 // library marker kkossev.commonLib, line 1066
            attrName = 'Power On State' // library marker kkossev.commonLib, line 1067
            mode = value == 0 ? 'off' : value == 1 ? 'on' : value == 2 ?  'Last state' : 'UNKNOWN' // library marker kkossev.commonLib, line 1068
            break // library marker kkossev.commonLib, line 1069
        case '8000' :    // command "childLock", [[name:"Child Lock", type: "ENUM", description: "Select Child Lock mode", constraints: ["off", "on"]]] // library marker kkossev.commonLib, line 1070
            attrName = 'Child Lock' // library marker kkossev.commonLib, line 1071
            mode = value == 0 ? 'off' : 'on' // library marker kkossev.commonLib, line 1072
            break // library marker kkossev.commonLib, line 1073
        case '8001' :    // command "ledMode", [[name:"LED mode", type: "ENUM", description: "Select LED mode", constraints: ["Disabled", "Lit when On", "Lit when Off", "Always Green", "Red when On; Green when Off", "Green when On; Red when Off", "Always Red" ]]] // library marker kkossev.commonLib, line 1074
            attrName = 'LED mode' // library marker kkossev.commonLib, line 1075
            if (isCircuitBreaker()) { // library marker kkossev.commonLib, line 1076
                mode = value == 0 ? 'Always Green' : value == 1 ? 'Red when On; Green when Off' : value == 2 ? 'Green when On; Red when Off' : value == 3 ? 'Always Red' : null // library marker kkossev.commonLib, line 1077
            } // library marker kkossev.commonLib, line 1078
            else { // library marker kkossev.commonLib, line 1079
                mode = value == 0 ? 'Disabled' : value == 1 ? 'Lit when On' : value == 2 ? 'Lit when Off' : value == 3 ? 'Freeze' : null // library marker kkossev.commonLib, line 1080
            } // library marker kkossev.commonLib, line 1081
            break // library marker kkossev.commonLib, line 1082
        case '8002' :    // command "powerOnState", [[name:"Power On State", type: "ENUM", description: "Select Power On State", constraints: ["off","on", "Last state"]]] // library marker kkossev.commonLib, line 1083
            attrName = 'Power On State' // library marker kkossev.commonLib, line 1084
            mode = value == 0 ? 'off' : value == 1 ? 'on' : value == 2 ?  'Last state' : null // library marker kkossev.commonLib, line 1085
            break // library marker kkossev.commonLib, line 1086
        case '8003' : //  Over current alarm // library marker kkossev.commonLib, line 1087
            attrName = 'Over current alarm' // library marker kkossev.commonLib, line 1088
            mode = value == 0 ? 'Over Current OK' : value == 1 ? 'Over Current Alarm' : null // library marker kkossev.commonLib, line 1089
            break // library marker kkossev.commonLib, line 1090
        default : // library marker kkossev.commonLib, line 1091
            logWarn "Unprocessed Tuya OnOff attribute ${it.attrId} cluster ${it.cluster } reported: value=${it.value}" // library marker kkossev.commonLib, line 1092
            return // library marker kkossev.commonLib, line 1093
    } // library marker kkossev.commonLib, line 1094
    if (settings?.logEnable) { logInfo "${attrName} is ${mode}" } // library marker kkossev.commonLib, line 1095
} // library marker kkossev.commonLib, line 1096

void parseLevelControlCluster(final Map descMap) { // library marker kkossev.commonLib, line 1098
    if (this.respondsTo('customParseLevelControlCluster')) { // library marker kkossev.commonLib, line 1099
        customParseLevelControlCluster(descMap) // library marker kkossev.commonLib, line 1100
    } // library marker kkossev.commonLib, line 1101
    else if (this.respondsTo('levelLibParseLevelControlCluster')) { // library marker kkossev.commonLib, line 1102
        levelLibParseLevelControlCluster(descMap) // library marker kkossev.commonLib, line 1103
    } // library marker kkossev.commonLib, line 1104
    else { // library marker kkossev.commonLib, line 1105
        logWarn "unprocessed LevelControl attribute ${descMap.attrId}" // library marker kkossev.commonLib, line 1106
    } // library marker kkossev.commonLib, line 1107
} // library marker kkossev.commonLib, line 1108

String intTo16bitUnsignedHex(int value) { // library marker kkossev.commonLib, line 1110
    String hexStr = zigbee.convertToHexString(value.toInteger(), 4) // library marker kkossev.commonLib, line 1111
    return new String(hexStr.substring(2, 4) + hexStr.substring(0, 2)) // library marker kkossev.commonLib, line 1112
} // library marker kkossev.commonLib, line 1113

String intTo8bitUnsignedHex(int value) { // library marker kkossev.commonLib, line 1115
    return zigbee.convertToHexString(value.toInteger(), 2) // library marker kkossev.commonLib, line 1116
} // library marker kkossev.commonLib, line 1117

void parseColorControlCluster(final Map descMap, String description) { // library marker kkossev.commonLib, line 1119
    if (DEVICE_TYPE in ['Bulb']) { // library marker kkossev.commonLib, line 1120
        parseColorControlClusterBulb(descMap, description) // library marker kkossev.commonLib, line 1121
    } // library marker kkossev.commonLib, line 1122
    else if (descMap.attrId == '0000') { // library marker kkossev.commonLib, line 1123
        if (descMap.value == null || descMap.value == 'FFFF') { logDebug "parseLevelControlCluster: invalid value: ${descMap.value}"; return } // invalid or unknown value // library marker kkossev.commonLib, line 1124
        final int rawValue = hexStrToUnsignedInt(descMap.value) // library marker kkossev.commonLib, line 1125
        sendLevelControlEvent(rawValue) // library marker kkossev.commonLib, line 1126
    } // library marker kkossev.commonLib, line 1127
    else { // library marker kkossev.commonLib, line 1128
        logWarn "unprocessed LevelControl attribute ${descMap.attrId}" // library marker kkossev.commonLib, line 1129
    } // library marker kkossev.commonLib, line 1130
} // library marker kkossev.commonLib, line 1131

void parseIlluminanceCluster(final Map descMap) { // library marker kkossev.commonLib, line 1133
    if (this.respondsTo('customCustomParseIlluminanceCluster')) { customCustomParseIlluminanceCluster(descMap) }  // library marker kkossev.commonLib, line 1134
    else if (this.respondsTo('customParseIlluminanceCluster')) { customParseIlluminanceCluster(descMap) }  // library marker kkossev.commonLib, line 1135
    else { logWarn "unprocessed Illuminance attribute ${descMap.attrId}" } // library marker kkossev.commonLib, line 1136
} // library marker kkossev.commonLib, line 1137

// Temperature Measurement Cluster 0x0402 // library marker kkossev.commonLib, line 1139
void parseTemperatureCluster(final Map descMap) { // library marker kkossev.commonLib, line 1140
    if (this.respondsTo('customParseTemperatureCluster')) { // library marker kkossev.commonLib, line 1141
        customParseTemperatureCluster(descMap) // library marker kkossev.commonLib, line 1142
    } // library marker kkossev.commonLib, line 1143
    else { // library marker kkossev.commonLib, line 1144
        logWarn "unprocessed Temperature attribute ${descMap.attrId}" // library marker kkossev.commonLib, line 1145
    } // library marker kkossev.commonLib, line 1146
} // library marker kkossev.commonLib, line 1147

// Humidity Measurement Cluster 0x0405 // library marker kkossev.commonLib, line 1149
void parseHumidityCluster(final Map descMap) { // library marker kkossev.commonLib, line 1150
    if (this.respondsTo('customParseHumidityCluster')) { // library marker kkossev.commonLib, line 1151
        customParseHumidityCluster(descMap) // library marker kkossev.commonLib, line 1152
    } // library marker kkossev.commonLib, line 1153
    else { // library marker kkossev.commonLib, line 1154
        logWarn "unprocessed Humidity attribute ${descMap.attrId}" // library marker kkossev.commonLib, line 1155
    } // library marker kkossev.commonLib, line 1156
} // library marker kkossev.commonLib, line 1157

// Occupancy Sensing Cluster 0x0406 // library marker kkossev.commonLib, line 1159
void parseOccupancyCluster(final Map descMap) { // library marker kkossev.commonLib, line 1160
    if (this.respondsTo('customParseOccupancyCluster')) { // library marker kkossev.commonLib, line 1161
        customParseOccupancyCluster(descMap) // library marker kkossev.commonLib, line 1162
    } // library marker kkossev.commonLib, line 1163
    else { // library marker kkossev.commonLib, line 1164
        logWarn "unprocessed Occupancy attribute ${descMap.attrId}" // library marker kkossev.commonLib, line 1165
    } // library marker kkossev.commonLib, line 1166
} // library marker kkossev.commonLib, line 1167

// Electrical Measurement Cluster 0x0702 // library marker kkossev.commonLib, line 1169
void parseElectricalMeasureCluster(final Map descMap) { // library marker kkossev.commonLib, line 1170
    if (!executeCustomHandler('customParseElectricalMeasureCluster', descMap)) { logWarn 'parseElectricalMeasureCluster is NOT implemented1' } // library marker kkossev.commonLib, line 1171
} // library marker kkossev.commonLib, line 1172

// Metering Cluster 0x0B04 // library marker kkossev.commonLib, line 1174
void parseMeteringCluster(final Map descMap) { // library marker kkossev.commonLib, line 1175
    if (!executeCustomHandler('customParseMeteringCluster', descMap)) { logWarn 'parseMeteringCluster is NOT implemented1' } // library marker kkossev.commonLib, line 1176
} // library marker kkossev.commonLib, line 1177

// pm2.5 // library marker kkossev.commonLib, line 1179
void parsePm25Cluster(final Map descMap) { // library marker kkossev.commonLib, line 1180
    if (descMap.value == null || descMap.value == 'FFFF') { return } // invalid or unknown value // library marker kkossev.commonLib, line 1181
    int value = hexStrToUnsignedInt(descMap.value) // library marker kkossev.commonLib, line 1182
    /* groovylint-disable-next-line NoFloat */ // library marker kkossev.commonLib, line 1183
    float floatValue  = Float.intBitsToFloat(value.intValue()) // library marker kkossev.commonLib, line 1184
    if (this.respondsTo('handlePm25Event')) { // library marker kkossev.commonLib, line 1185
        handlePm25Event(floatValue as Integer) // library marker kkossev.commonLib, line 1186
    } // library marker kkossev.commonLib, line 1187
    else { // library marker kkossev.commonLib, line 1188
        logWarn "handlePm25Event: don't know how to handle descMap=${descMap}" // library marker kkossev.commonLib, line 1189
    } // library marker kkossev.commonLib, line 1190
} // library marker kkossev.commonLib, line 1191

// Analog Input Cluster 0x000C // library marker kkossev.commonLib, line 1193
void parseAnalogInputCluster(final Map descMap, String description=null) { // library marker kkossev.commonLib, line 1194
    if (this.respondsTo('customParseAnalogInputCluster')) { // library marker kkossev.commonLib, line 1195
        customParseAnalogInputCluster(descMap) // library marker kkossev.commonLib, line 1196
    } // library marker kkossev.commonLib, line 1197
    else if (this.respondsTo('customParseAnalogInputClusterDescription')) { // library marker kkossev.commonLib, line 1198
        customParseAnalogInputClusterDescription(description)                   // ZigUSB // library marker kkossev.commonLib, line 1199
    } // library marker kkossev.commonLib, line 1200
    else if (DEVICE_TYPE in ['AirQuality']) { // library marker kkossev.commonLib, line 1201
        parseAirQualityIndexCluster(descMap) // library marker kkossev.commonLib, line 1202
    } // library marker kkossev.commonLib, line 1203
    else { // library marker kkossev.commonLib, line 1204
        logWarn "parseAnalogInputCluster: don't know how to handle descMap=${descMap}" // library marker kkossev.commonLib, line 1205
    } // library marker kkossev.commonLib, line 1206
} // library marker kkossev.commonLib, line 1207

// Multistate Input Cluster 0x0012 // library marker kkossev.commonLib, line 1209
void parseMultistateInputCluster(final Map descMap) { // library marker kkossev.commonLib, line 1210
    if (this.respondsTo('customParseMultistateInputCluster')) { customParseMultistateInputCluster(descMap) } else { logWarn "parseMultistateInputCluster: don't know how to handle descMap=${descMap}" } // library marker kkossev.commonLib, line 1211
} // library marker kkossev.commonLib, line 1212

// Window Covering Cluster 0x0102 // library marker kkossev.commonLib, line 1214
void parseWindowCoveringCluster(final Map descMap) { // library marker kkossev.commonLib, line 1215
    if (this.respondsTo('customParseWindowCoveringCluster')) { customParseWindowCoveringCluster(descMap) } else { logWarn "parseWindowCoveringCluster: don't know how to handle descMap=${descMap}" } // library marker kkossev.commonLib, line 1216
} // library marker kkossev.commonLib, line 1217

// thermostat cluster 0x0201 // library marker kkossev.commonLib, line 1219
void parseThermostatCluster(final Map descMap) { // library marker kkossev.commonLib, line 1220
    if (this.respondsTo('customParseThermostatCluster')) { customParseThermostatCluster(descMap) } else { logWarn "parseThermostatCluster: don't know how to handle descMap=${descMap}" } // library marker kkossev.commonLib, line 1221
} // library marker kkossev.commonLib, line 1222

void parseFC11Cluster(final Map descMap) { // library marker kkossev.commonLib, line 1224
    if (this.respondsTo('customParseFC11Cluster')) { customParseFC11Cluster(descMap) } else { logWarn "parseFC11Cluster: don't know how to handle descMap=${descMap}" } // library marker kkossev.commonLib, line 1225
} // library marker kkossev.commonLib, line 1226

void parseE002Cluster(final Map descMap) { // library marker kkossev.commonLib, line 1228
    if (this.respondsTo('customParseE002Cluster')) { customParseE002Cluster(descMap) } else { logWarn "Unprocessed cluster 0xE002 command ${descMap.command} attrId ${descMap.attrId} value ${value} (0x${descMap.value})" }    // radars // library marker kkossev.commonLib, line 1229
} // library marker kkossev.commonLib, line 1230

void parseEC03Cluster(final Map descMap) { // library marker kkossev.commonLib, line 1232
    if (this.respondsTo('customParseEC03Cluster')) { customParseEC03Cluster(descMap) } else { logWarn "Unprocessed cluster 0xEC03C command ${descMap.command} attrId ${descMap.attrId} value ${value} (0x${descMap.value})" }   // radars // library marker kkossev.commonLib, line 1233
 ...
 * Tuya cluster EF00 specific code // library marker kkossev.commonLib, line 1238
 * ----------------------------------------------------------------------------- // library marker kkossev.commonLib, line 1239
*/ // library marker kkossev.commonLib, line 1240
private static getCLUSTER_TUYA()       { 0xEF00 } // library marker kkossev.commonLib, line 1241
private static getSETDATA()            { 0x00 } // library marker kkossev.commonLib, line 1242
private static getSETTIME()            { 0x24 } // library marker kkossev.commonLib, line 1243

// Tuya Commands // library marker kkossev.commonLib, line 1245
private static getTUYA_REQUEST()       { 0x00 } // library marker kkossev.commonLib, line 1246
private static getTUYA_REPORTING()     { 0x01 } // library marker kkossev.commonLib, line 1247
private static getTUYA_QUERY()         { 0x02 } // library marker kkossev.commonLib, line 1248
private static getTUYA_STATUS_SEARCH() { 0x06 } // library marker kkossev.commonLib, line 1249
private static getTUYA_TIME_SYNCHRONISATION() { 0x24 } // library marker kkossev.commonLib, line 1250

// tuya DP type // library marker kkossev.commonLib, line 1252
private static getDP_TYPE_RAW()        { '01' }    // [ bytes ] // library marker kkossev.commonLib, line 1253
private static getDP_TYPE_BOOL()       { '01' }    // [ 0/1 ] // library marker kkossev.commonLib, line 1254
private static getDP_TYPE_VALUE()      { '02' }    // [ 4 byte value ] // library marker kkossev.commonLib, line 1255
private static getDP_TYPE_STRING()     { '03' }    // [ N byte string ] // library marker kkossev.commonLib, line 1256
private static getDP_TYPE_ENUM()       { '04' }    // [ 0-255 ] // library marker kkossev.commonLib, line 1257
private static getDP_TYPE_BITMAP()     { '05' }    // [ 1,2,4 bytes ] as bits // library marker kkossev.commonLib, line 1258

void syncTuyaDateTime() { // library marker kkossev.commonLib, line 1260
    // The data format for time synchronization, including standard timestamps and local timestamps. Standard timestamp (4 bytes)    local timestamp (4 bytes) Time synchronization data format: The standard timestamp is the total number of seconds from 00:00:00 on January 01, 1970 GMT to the present. // library marker kkossev.commonLib, line 1261
    // For example, local timestamp = standard timestamp + number of seconds between standard time and local time (including time zone and daylight saving time).  // Y2K = 946684800 // library marker kkossev.commonLib, line 1262
    long offset = 0 // library marker kkossev.commonLib, line 1263
    int offsetHours = 0 // library marker kkossev.commonLib, line 1264
    Calendar cal = Calendar.getInstance();    //it return same time as new Date() // library marker kkossev.commonLib, line 1265
    def hour = cal.get(Calendar.HOUR_OF_DAY) // library marker kkossev.commonLib, line 1266
    try { // library marker kkossev.commonLib, line 1267
        offset = location.getTimeZone().getOffset(new Date().getTime()) // library marker kkossev.commonLib, line 1268
        offsetHours = (offset / 3600000) as int // library marker kkossev.commonLib, line 1269
        logDebug "timezone offset of current location is ${offset} (${offsetHours} hours), current hour is ${hour} h" // library marker kkossev.commonLib, line 1270
    } catch(e) { // library marker kkossev.commonLib, line 1271
        log.error "${device.displayName} cannot resolve current location. please set location in Hubitat location setting. Setting timezone offset to zero" // library marker kkossev.commonLib, line 1272
    ...
    cmds = zigbee.command(CLUSTER_TUYA, SETTIME, '0008' + zigbee.convertToHexString((int)(now() / 1000),8) + zigbee.convertToHexString((int)((now() + offset) / 1000), 8)) // library marker kkossev.commonLib, line 1276
    String dateTimeNow = unix2formattedDate(now()) // library marker kkossev.commonLib, line 1277
    logDebug "sending time data : ${dateTimeNow} (${cmds})" // library marker kkossev.commonLib, line 1278
    sendZigbeeCommands(cmds) // library marker kkossev.commonLib, line 1279
    logInfo "Tuya device time synchronized to ${dateTimeNow}" // library marker kkossev.commonLib, line 1280
} // library marker kkossev.commonLib, line 1281


void parseTuyaCluster(final Map descMap) { // library marker kkossev.commonLib, line 1284
    if (descMap?.clusterInt == CLUSTER_TUYA && descMap?.command == '24') {        //getSETTIME // library marker kkossev.commonLib, line 1285
        syncTuyaDateTime() // library marker kkossev.commonLib, line 1286
    } // library marker kkossev.commonLib, line 1287
    else if (descMap?.clusterInt == CLUSTER_TUYA && descMap?.command == '0B') {    // ZCL Command Default Response // library marker kkossev.commonLib, line 1288
        String clusterCmd = descMap?.data[0] // library marker kkossev.commonLib, line 1289
        String status = descMap?.data[1] // library marker kkossev.commonLib, line 1290
        logDebug "device has received Tuya cluster ZCL command 0x${clusterCmd} response 0x${status} data = ${descMap?.data}" // library marker kkossev.commonLib, line 1291
        if (status != '00') { // library marker kkossev.commonLib, line 1292
            logWarn "ATTENTION! manufacturer = ${device.getDataValue('manufacturer')} unsupported Tuya cluster ZCL command 0x${clusterCmd} response 0x${status} data = ${descMap?.data} !!!" // library marker kkossev.commonLib, line 1293
        } // library marker kkossev.commonLib, line 1294
    } // library marker kkossev.commonLib, line 1295
    else if ((descMap?.clusterInt == CLUSTER_TUYA) && (descMap?.command == '01' || descMap?.command == '02' || descMap?.command == '05' || descMap?.command == '06')) { // library marker kkossev.commonLib, line 1296
        int dataLen = descMap?.data.size() // library marker kkossev.commonLib, line 1297
        //log.warn "dataLen=${dataLen}" // library marker kkossev.commonLib, line 1298
        //def transid = zigbee.convertHexToInt(descMap?.data[1])           // "transid" is just a "counter", a response will have the same transid as the command // library marker kkossev.commonLib, line 1299
        if (dataLen <= 5) { // library marker kkossev.commonLib, line 1300
            logWarn "unprocessed short Tuya command response: dp_id=${descMap?.data[3]} dp=${descMap?.data[2]} fncmd_len=${fncmd_len} data=${descMap?.data})" // library marker kkossev.commonLib, line 1301
            return // library marker kkossev.commonLib, line 1302
        } // library marker kkossev.commonLib, line 1303
        for (int i = 0; i < (dataLen - 4); ) { // library marker kkossev.commonLib, line 1304
            int dp = zigbee.convertHexToInt(descMap?.data[2 + i])          // "dp" field describes the action/message of a command frame // library marker kkossev.commonLib, line 1305
            int dp_id = zigbee.convertHexToInt(descMap?.data[3 + i])       // "dp_identifier" is device dependant // library marker kkossev.commonLib, line 1306
            int fncmd_len = zigbee.convertHexToInt(descMap?.data[5 + i]) // library marker kkossev.commonLib, line 1307
            int fncmd = getTuyaAttributeValue(descMap?.data, i)          // // library marker kkossev.commonLib, line 1308
            if (!isChattyDeviceReport(descMap) && !isSpammyDeviceProfile()) { // library marker kkossev.commonLib, line 1309
                logDebug "parseTuyaCluster: command=${descMap?.command} dp_id=${dp_id} dp=${dp} (0x${descMap?.data[2 + i]}) fncmd=${fncmd} fncmd_len=${fncmd_len} (index=${i})" // library marker kkossev.commonLib, line 1310
            } // library marker kkossev.commonLib, line 1311
            processTuyaDP(descMap, dp, dp_id, fncmd) // library marker kkossev.commonLib, line 1312
            i = i + fncmd_len + 4 // library marker kkossev.commonLib, line 1313
        } // library marker kkossev.commonLib, line 1314
    } // library marker kkossev.commonLib, line 1315
    else { // library marker kkossev.commonLib, line 1316
        if (this.respondsTo('customParseTuyaCluster')) { // library marker kkossev.commonLib, line 1317
            customParseTuyaCluster(descMap) // library marker kkossev.commonLib, line 1318
        } // library marker kkossev.commonLib, line 1319
        else { // library marker kkossev.commonLib, line 1320
            logWarn "unprocessed Tuya cluster command ${descMap?.command} data=${descMap?.data}" // library marker kkossev.commonLib, line 1321
...
void processTuyaDP(final Map descMap, final int dp, final int dp_id, final int fncmd, final int dp_len=0) { // library marker kkossev.commonLib, line 1326
    logTrace "processTuyaDP: <b> checking customProcessTuyaDp</b> dp=${dp} dp_id=${dp_id} fncmd=${fncmd} dp_len=${dp_len}" // library marker kkossev.commonLib, line 1327
    if (this.respondsTo(customProcessTuyaDp)) { // library marker kkossev.commonLib, line 1328
        logTrace 'customProcessTuyaDp exists, calling it...' // library marker kkossev.commonLib, line 1329
        if (customProcessTuyaDp(descMap, dp, dp_id, fncmd, dp_len) == true) { // library marker kkossev.commonLib, line 1330
            return // library marker kkossev.commonLib, line 1331
        } // library marker kkossev.commonLib, line 1332
    } // library marker kkossev.commonLib, line 1333
    // check if the method  method exists // library marker kkossev.commonLib, line 1334
    if (this.respondsTo(processTuyaDPfromDeviceProfile)) { // library marker kkossev.commonLib, line 1335
        if (processTuyaDPfromDeviceProfile(descMap, dp, dp_id, fncmd, dp_len) == true) {    // sucessfuly processed the new way - we are done.  version 3.0 // library marker kkossev.commonLib, line 1336
            return // library marker kkossev.commonLib, line 1337
        } // library marker kkossev.commonLib, line 1338
    } // library marker kkossev.commonLib, line 1339
    logWarn "<b>NOT PROCESSED</b> Tuya cmd: dp=${dp} value=${fncmd} descMap.data = ${descMap?.data}" // library marker kkossev.commonLib, line 1340
} // library marker kkossev.commonLib, line 1341

private int getTuyaAttributeValue(final List<String> _data, final int index) { // library marker kkossev.commonLib, line 1343
    int retValue = 0 // library marker kkossev.commonLib, line 1344
    if (_data.size() >= 6) { // library marker kkossev.commonLib, line 1345
        int dataLength = zigbee.convertHexToInt(_data[5 + index]) // library marker kkossev.commonLib, line 1346
        if (dataLength == 0) { return 0 } // library marker kkossev.commonLib, line 1347
        int power = 1 // library marker kkossev.commonLib, line 1348
        for (i in dataLength..1) { // library marker kkossev.commonLib, line 1349
            retValue = retValue + power * zigbee.convertHexToInt(_data[index + i + 5]) // library marker kkossev.commonLib, line 1350
            power = power * 256 // library marker kkossev.commonLib, line 1351
        } // library marker kkossev.commonLib, line 1352
    } // library marker kkossev.commonLib, line 1353
    return retValue // library marker kkossev.commonLib, line 1354
} // library marker kkossev.commonLib, line 1355

private List<String> getTuyaCommand(String dp, String dp_type, String fncmd) { return sendTuyaCommand(dp, dp_type, fncmd) } // library marker kkossev.commonLib, line 1357

private List<String> sendTuyaCommand(String dp, String dp_type, String fncmd) { // library marker kkossev.commonLib, line 1359
    List<String> cmds = [] // library marker kkossev.commonLib, line 1360
    int ep = safeToInt(state.destinationEP) // library marker kkossev.commonLib, line 1361
    if (ep == null || ep == 0) { ep = 1 } // library marker kkossev.commonLib, line 1362
    int tuyaCmd = isFingerbot() ? 0x04 : SETDATA // library marker kkossev.commonLib, line 1363
    //tuyaCmd = 0x04  // !!!!!!!!!!!!!!!!!!!!!!! // library marker kkossev.commonLib, line 1364
    cmds = zigbee.command(CLUSTER_TUYA, tuyaCmd, [destEndpoint :ep], delay = 201, PACKET_ID + dp + dp_type + zigbee.convertToHexString((int)(fncmd.length() / 2), 4) + fncmd ) // library marker kkossev.commonLib, line 1365
    logDebug "${device.displayName} getTuyaCommand (dp=$dp fncmd=$fncmd dp_type=$dp_type) = ${cmds}" // library marker kkossev.commonLib, line 1366
    return cmds // library marker kkossev.commonLib, line 1367
} // library marker kkossev.commonLib, line 1368

private getPACKET_ID() { // library marker kkossev.commonLib, line 1370
    /* // library marker kkossev.commonLib, line 1371
    int packetId = state.packetId ?: 0 // library marker kkossev.commonLib, line 1372
    state.packetId = packetId + 1 // library marker kkossev.commonLib, line 1373
    return zigbee.convertToHexString(packetId, 4) // library marker kkossev.commonLib, line 1374
    */ // library marker kkossev.commonLib, line 1375
    return zigbee.convertToHexString(new Random().nextInt(65536), 4) // library marker kkossev.commonLib, line 1376
} // library marker kkossev.commonLib, line 1377

/* groovylint-disable-next-line MethodParameterTypeRequired */ // library marker kkossev.commonLib, line 1379
void tuyaTest(String dpCommand, String dpValue, String dpTypeString ) { // library marker kkossev.commonLib, line 1380
    String dpType   = dpTypeString == 'DP_TYPE_VALUE' ? DP_TYPE_VALUE : dpTypeString == 'DP_TYPE_BOOL' ? DP_TYPE_BOOL : dpTypeString == 'DP_TYPE_ENUM' ? DP_TYPE_ENUM : null // library marker kkossev.commonLib, line 1381
    String dpValHex = dpTypeString == 'DP_TYPE_VALUE' ? zigbee.convertToHexString(dpValue as int, 8) : dpValue // library marker kkossev.commonLib, line 1382
    if (settings?.logEnable) { log.warn "${device.displayName}  sending TEST command=${dpCommand} value=${dpValue} ($dpValHex) type=${dpType}" } // library marker kkossev.commonLib, line 1383
    sendZigbeeCommands( sendTuyaCommand(dpCommand, dpType, dpValHex) ) // library marker kkossev.commonLib, line 1384
} // library marker kkossev.commonLib, line 1385

private getANALOG_INPUT_BASIC_CLUSTER() { 0x000C } // library marker kkossev.commonLib, line 1387
private getANALOG_INPUT_BASIC_PRESENT_VALUE_ATTRIBUTE() { 0x0055 } // library marker kkossev.commonLib, line 1388

List<String> tuyaBlackMagic() { // library marker kkossev.commonLib, line 1390
    int ep = safeToInt(state.destinationEP ?: 01) // library marker kkossev.commonLib, line 1391
    if (ep == null || ep == 0) { ep = 1 } // library marker kkossev.commonLib, line 1392
    logInfo 'tuyaBlackMagic()...' // library marker kkossev.commonLib, line 1393
    return zigbee.readAttribute(0x0000, [0x0004, 0x000, 0x0001, 0x0005, 0x0007, 0xfffe], [destEndpoint :ep], delay = 200) // library marker kkossev.commonLib, line 1394
} // library marker kkossev.commonLib, line 1395

void aqaraBlackMagic() { // library marker kkossev.commonLib, line 1397
    List<String> cmds = [] // library marker kkossev.commonLib, line 1398
    if (isAqaraTVOC_OLD() || isAqaraTRV_OLD()) { // library marker kkossev.commonLib, line 1399
        cmds += ["he raw 0x${device.deviceNetworkId} 0 0 0x8002 {40 00 00 00 00 40 8f 5f 11 52 52 00 41 2c 52 00 00} {0x0000}", 'delay 200',] // library marker kkossev.commonLib, line 1400
        cmds += "zdo bind 0x${device.deviceNetworkId} 0x01 0x01 0xFCC0 {${device.zigbeeId}} {}" // library marker kkossev.commonLib, line 1401
        cmds += "zdo bind 0x${device.deviceNetworkId} 0x01 0x01 0x0406 {${device.zigbeeId}} {}" // library marker kkossev.commonLib, line 1402
        cmds += zigbee.readAttribute(0x0001, 0x0020, [:], delay = 200)    // TODO: check - battery voltage // library marker kkossev.commonLib, line 1403
        if (isAqaraTVOC_OLD()) { // library marker kkossev.commonLib, line 1404
            cmds += zigbee.readAttribute(0xFCC0, [0x0102, 0x010C], [mfgCode: 0x115F], delay = 200)    // TVOC only // library marker kkossev.commonLib, line 1405
        } // library marker kkossev.commonLib, line 1406
        sendZigbeeCommands(cmds) // library marker kkossev.commonLib, line 1407
        logDebug 'sent aqaraBlackMagic()' // library marker kkossev.commonLib, line 1408
    } // library marker kkossev.commonLib, line 1409
    else { // library marker kkossev.commonLib, line 1410
        logDebug 'aqaraBlackMagic() was SKIPPED' // library marker kkossev.commonLib, line 1411
 ...
 * initializes the device // library marker kkossev.commonLib, line 1416
 * Invoked from configure() // library marker kkossev.commonLib, line 1417
 * @return zigbee commands // library marker kkossev.commonLib, line 1418
 */ // library marker kkossev.commonLib, line 1419
List<String> initializeDevice() { // library marker kkossev.commonLib, line 1420
    List<String> cmds = [] // library marker kkossev.commonLib, line 1421
    logInfo 'initializeDevice...' // library marker kkossev.commonLib, line 1422
    if (this.respondsTo('customInitializeDevice')) { // library marker kkossev.commonLib, line 1423
        List<String> customCmds = customInitializeDevice() // library marker kkossev.commonLib, line 1424
        if (customCmds != null && !customCmds.isEmpty()) { cmds +=  customCmds } // library marker kkossev.commonLib, line 1425
    } // library marker kkossev.commonLib, line 1426
    logDebug "initializeDevice(): cmds=${cmds}" // library marker kkossev.commonLib, line 1427
    return cmds // library marker kkossev.commonLib, line 1428
} // library marker kkossev.commonLib, line 1429

/** // library marker kkossev.commonLib, line 1431
 * configures the device // library marker kkossev.commonLib, line 1432
 * Invoked from configure() // library marker kkossev.commonLib, line 1433
 * @return zigbee commands // library marker kkossev.commonLib, line 1434
 */ // library marker kkossev.commonLib, line 1435
List<String> configureDevice() { // library marker kkossev.commonLib, line 1436
    List<String> cmds = [] // library marker kkossev.commonLib, line 1437
    logInfo 'configureDevice...' // library marker kkossev.commonLib, line 1438
    if (this.respondsTo('customConfigureDevice')) { // library marker kkossev.commonLib, line 1439
        List<String> customCmds = customConfigureDevice() // library marker kkossev.commonLib, line 1440
        if (customCmds != null && !customCmds.isEmpty()) { cmds +=  customCmds } // library marker kkossev.commonLib, line 1441
    } // library marker kkossev.commonLib, line 1442
    else if (DEVICE_TYPE in  ['Bulb'])       { cmds += configureBulb() } // library marker kkossev.commonLib, line 1443
    // sendZigbeeCommands(cmds) changed 03/04/2024 // library marker kkossev.commonLib, line 1444
    logDebug "configureDevice(): cmds=${cmds}" // library marker kkossev.commonLib, line 1445
    return cmds // library marker kkossev.commonLib, line 1446
 ...
 * Hubitat default handlers methods // library marker kkossev.commonLib, line 1451
 * ----------------------------------------------------------------------------- // library marker kkossev.commonLib, line 1452
*/ // library marker kkossev.commonLib, line 1453

List<String> customHandlers(final List customHandlersList) { // library marker kkossev.commonLib, line 1455
    List<String> cmds = [] // library marker kkossev.commonLib, line 1456
    if (customHandlersList != null && !customHandlersList.isEmpty()) { // library marker kkossev.commonLib, line 1457
        customHandlersList.each { handler -> // library marker kkossev.commonLib, line 1458
            if (this.respondsTo(handler)) { // library marker kkossev.commonLib, line 1459
                List<String> customCmds = this."${handler}"() // library marker kkossev.commonLib, line 1460
                if (customCmds != null && !customCmds.isEmpty()) { cmds +=  customCmds } // library marker kkossev.commonLib, line 1461
    ...
    return cmds // library marker kkossev.commonLib, line 1465
} // library marker kkossev.commonLib, line 1466

void refresh() { // library marker kkossev.commonLib, line 1468
    logDebug "refresh()... DEVICE_TYPE is ${DEVICE_TYPE} model=${device.getDataValue('model')} manufacturer=${device.getDataValue('manufacturer')}" // library marker kkossev.commonLib, line 1469
    checkDriverVersion(state) // library marker kkossev.commonLib, line 1470
    List<String> cmds = [] // library marker kkossev.commonLib, line 1471
    setRefreshRequest()    // 3 seconds // library marker kkossev.commonLib, line 1472

    List<String> customCmds = customHandlers(['batteryRefresh', 'groupsRefresh', 'customRefresh']) // library marker kkossev.commonLib, line 1474
    if (customCmds != null && !customCmds.isEmpty()) { cmds +=  customCmds } // library marker kkossev.commonLib, line 1475

    if (DEVICE_TYPE in  ['Bulb'])       { cmds += refreshBulb() } // library marker kkossev.commonLib, line 1477
    else { // library marker kkossev.commonLib, line 1478
        if (DEVICE_TYPE in  ['Dimmer']) { // library marker kkossev.commonLib, line 1479
            cmds += zigbee.readAttribute(0x0006, 0x0000, [:], delay = 200) // library marker kkossev.commonLib, line 1480
            cmds += zigbee.readAttribute(0x0008, 0x0000, [:], delay = 200) // library marker kkossev.commonLib, line 1481
        } // library marker kkossev.commonLib, line 1482
        if (DEVICE_TYPE in  ['THSensor']) { // library marker kkossev.commonLib, line 1483
            cmds += zigbee.readAttribute(0x0402, 0x0000, [:], delay = 200) // library marker kkossev.commonLib, line 1484
            cmds += zigbee.readAttribute(0x0405, 0x0000, [:], delay = 200) // library marker kkossev.commonLib, line 1485
        } // library marker kkossev.commonLib, line 1486
    } // library marker kkossev.commonLib, line 1487

    if (cmds != null && !cmds.isEmpty()) { // library marker kkossev.commonLib, line 1489
        logDebug "refresh() cmds=${cmds}" // library marker kkossev.commonLib, line 1490
        sendZigbeeCommands(cmds) // library marker kkossev.commonLib, line 1491
    } // library marker kkossev.commonLib, line 1492
    else { // library marker kkossev.commonLib, line 1493
        logDebug "no refresh() commands defined for device type ${DEVICE_TYPE}" // library marker kkossev.commonLib, line 1494
    } // library marker kkossev.commonLib, line 1495
} // library marker kkossev.commonLib, line 1496

public void setRefreshRequest()   { if (state.states == null) { state.states = [:] } ; state.states['isRefresh'] = true; runInMillis(REFRESH_TIMER, clearRefreshRequest, [overwrite: true]) } // library marker kkossev.commonLib, line 1498
public void clearRefreshRequest() { if (state.states == null) { state.states = [:] } ; state.states['isRefresh'] = false } // library marker kkossev.commonLib, line 1499

public void clearInfoEvent() { // library marker kkossev.commonLib, line 1501
    sendInfoEvent('clear') // library marker kkossev.commonLib, line 1502
} // library marker kkossev.commonLib, line 1503

public void sendInfoEvent(String info=null) { // library marker kkossev.commonLib, line 1505
    if (info == null || info == 'clear') { // library marker kkossev.commonLib, line 1506
        logDebug 'clearing the Status event' // library marker kkossev.commonLib, line 1507
        sendEvent(name: 'Status', value: 'clear', isDigital: true) // library marker kkossev.commonLib, line 1508
    } // library marker kkossev.commonLib, line 1509
    else { // library marker kkossev.commonLib, line 1510
        logInfo "${info}" // library marker kkossev.commonLib, line 1511
        sendEvent(name: 'Status', value: info, isDigital: true) // library marker kkossev.commonLib, line 1512
        runIn(INFO_AUTO_CLEAR_PERIOD, 'clearInfoEvent')            // automatically clear the Info attribute after 1 minute // library marker kkossev.commonLib, line 1513
    } // library marker kkossev.commonLib, line 1514
} // library marker kkossev.commonLib, line 1515

public void ping() { // library marker kkossev.commonLib, line 1517
    if (state.lastTx == null ) { state.lastTx = [:] } ; state.lastTx['pingTime'] = new Date().getTime() // library marker kkossev.commonLib, line 1518
    if (state.states == null ) { state.states = [:] } ;     state.states['isPing'] = true // library marker kkossev.commonLib, line 1519
    scheduleCommandTimeoutCheck() // library marker kkossev.commonLib, line 1520
    if (isVirtual()) { runInMillis(10, virtualPong) } // library marker kkossev.commonLib, line 1521
    else { sendZigbeeCommands(zigbee.readAttribute(zigbee.BASIC_CLUSTER, 0x01, [:], 0) ) } // library marker kkossev.commonLib, line 1522
    logDebug 'ping...' // library marker kkossev.commonLib, line 1523
} // library marker kkossev.commonLib, line 1524

def virtualPong() { // library marker kkossev.commonLib, line 1526
    logDebug 'virtualPing: pong!' // library marker kkossev.commonLib, line 1527
    Long now = new Date().getTime() // library marker kkossev.commonLib, line 1528
    int timeRunning = now.toInteger() - (state.lastTx['pingTime'] ?: '0').toInteger() // library marker kkossev.commonLib, line 1529
    if (timeRunning > 0 && timeRunning < MAX_PING_MILISECONDS) { // library marker kkossev.commonLib, line 1530
        state.stats['pingsOK'] = (state.stats['pingsOK'] ?: 0) + 1 // library marker kkossev.commonLib, line 1531
        if (timeRunning < safeToInt((state.stats['pingsMin'] ?: '999'))) { state.stats['pingsMin'] = timeRunning } // library marker kkossev.commonLib, line 1532
        if (timeRunning > safeToInt((state.stats['pingsMax'] ?: '0')))   { state.stats['pingsMax'] = timeRunning } // library marker kkossev.commonLib, line 1533
        state.stats['pingsAvg'] = approxRollingAverage(safeToDouble(state.stats['pingsAvg']), safeToDouble(timeRunning)) as int // library marker kkossev.commonLib, line 1534
        sendRttEvent() // library marker kkossev.commonLib, line 1535
    } // library marker kkossev.commonLib, line 1536
    else { // library marker kkossev.commonLib, line 1537
        logWarn "unexpected ping timeRunning=${timeRunning} " // library marker kkossev.commonLib, line 1538
    } // library marker kkossev.commonLib, line 1539
    state.states['isPing'] = false // library marker kkossev.commonLib, line 1540
    //unschedule('deviceCommandTimeout') // library marker kkossev.commonLib, line 1541
    unscheduleCommandTimeoutCheck(state) // library marker kkossev.commonLib, line 1542
} // library marker kkossev.commonLib, line 1543

/** // library marker kkossev.commonLib, line 1545
 * sends 'rtt'event (after a ping() command) // library marker kkossev.commonLib, line 1546
 * @param null: calculate the RTT in ms // library marker kkossev.commonLib, line 1547
 *        value: send the text instead ('timeout', 'n/a', etc..) // library marker kkossev.commonLib, line 1548
 * @return none // library marker kkossev.commonLib, line 1549
 */ // library marker kkossev.commonLib, line 1550
void sendRttEvent( String value=null) { // library marker kkossev.commonLib, line 1551
    Long now = new Date().getTime() // library marker kkossev.commonLib, line 1552
    if (state.lastTx == null ) { state.lastTx = [:] } // library marker kkossev.commonLib, line 1553
    int timeRunning = now.toInteger() - (state.lastTx['pingTime'] ?: now).toInteger() // library marker kkossev.commonLib, line 1554
    String descriptionText = "Round-trip time is ${timeRunning} ms (min=${state.stats['pingsMin']} max=${state.stats['pingsMax']} average=${state.stats['pingsAvg']})" // library marker kkossev.commonLib, line 1555
    if (value == null) { // library marker kkossev.commonLib, line 1556
        logInfo "${descriptionText}" // library marker kkossev.commonLib, line 1557
        sendEvent(name: 'rtt', value: timeRunning, descriptionText: descriptionText, unit: 'ms', isDigital: true) // library marker kkossev.commonLib, line 1558
    } // library marker kkossev.commonLib, line 1559
    else { // library marker kkossev.commonLib, line 1560
        descriptionText = "Round-trip time : ${value}" // library marker kkossev.commonLib, line 1561
        logInfo "${descriptionText}" // library marker kkossev.commonLib, line 1562
        sendEvent(name: 'rtt', value: value, descriptionText: descriptionText, isDigital: true) // library marker kkossev.commonLib, line 1563
 ...
 * Lookup the cluster name from the cluster ID // library marker kkossev.commonLib, line 1568
 * @param cluster cluster ID // library marker kkossev.commonLib, line 1569
 * @return cluster name if known, otherwise "private cluster" // library marker kkossev.commonLib, line 1570
 */ // library marker kkossev.commonLib, line 1571
private String clusterLookup(final Object cluster) { // library marker kkossev.commonLib, line 1572
    if (cluster != null) { // library marker kkossev.commonLib, line 1573
        return zigbee.clusterLookup(cluster.toInteger()) ?: "private cluster 0x${intToHexStr(cluster.toInteger())}" // library marker kkossev.commonLib, line 1574
    } // library marker kkossev.commonLib, line 1575
    logWarn 'cluster is NULL!' // library marker kkossev.commonLib, line 1576
    return 'NULL' // library marker kkossev.commonLib, line 1577
} // library marker kkossev.commonLib, line 1578

private void scheduleCommandTimeoutCheck(int delay = COMMAND_TIMEOUT) { // library marker kkossev.commonLib, line 1580
    if (state.states == null) { state.states = [:] } // library marker kkossev.commonLib, line 1581
    state.states['isTimeoutCheck'] = true // library marker kkossev.commonLib, line 1582
    runIn(delay, 'deviceCommandTimeout') // library marker kkossev.commonLib, line 1583
} // library marker kkossev.commonLib, line 1584

// unschedule() is a very time consuming operation : ~ 5 milliseconds per call ! // library marker kkossev.commonLib, line 1586
void unscheduleCommandTimeoutCheck(final Map state) {   // can not be static :(  // library marker kkossev.commonLib, line 1587
    if (state.states == null) { state.states = [:] } // library marker kkossev.commonLib, line 1588
    if (state.states['isTimeoutCheck'] == true) { // library marker kkossev.commonLib, line 1589
        state.states['isTimeoutCheck'] = false // library marker kkossev.commonLib, line 1590
        unschedule('deviceCommandTimeout') // library marker kkossev.commonLib, line 1591
    } // library marker kkossev.commonLib, line 1592
} // library marker kkossev.commonLib, line 1593

void deviceCommandTimeout() { // library marker kkossev.commonLib, line 1595
    logWarn 'no response received (sleepy device or offline?)' // library marker kkossev.commonLib, line 1596
    sendRttEvent('timeout') // library marker kkossev.commonLib, line 1597
    state.stats['pingsFail'] = (state.stats['pingsFail'] ?: 0) + 1 // library marker kkossev.commonLib, line 1598
} // library marker kkossev.commonLib, line 1599

/** // library marker kkossev.commonLib, line 1601
 * Schedule a device health check // library marker kkossev.commonLib, line 1602
 * @param intervalMins interval in minutes // library marker kkossev.commonLib, line 1603
 */ // library marker kkossev.commonLib, line 1604
private void scheduleDeviceHealthCheck(final int intervalMins, final int healthMethod) { // library marker kkossev.commonLib, line 1605
    if (healthMethod == 1 || healthMethod == 2)  { // library marker kkossev.commonLib, line 1606
        String cron = getCron( intervalMins * 60 ) // library marker kkossev.commonLib, line 1607
        schedule(cron, 'deviceHealthCheck') // library marker kkossev.commonLib, line 1608
        logDebug "deviceHealthCheck is scheduled every ${intervalMins} minutes" // library marker kkossev.commonLib, line 1609
    } // library marker kkossev.commonLib, line 1610
    else { // library marker kkossev.commonLib, line 1611
        logWarn 'deviceHealthCheck is not scheduled!' // library marker kkossev.commonLib, line 1612
        unschedule('deviceHealthCheck') // library marker kkossev.commonLib, line 1613
    } // library marker kkossev.commonLib, line 1614
} // library marker kkossev.commonLib, line 1615

private void unScheduleDeviceHealthCheck() { // library marker kkossev.commonLib, line 1617
    unschedule('deviceHealthCheck') // library marker kkossev.commonLib, line 1618
    device.deleteCurrentState('healthStatus') // library marker kkossev.commonLib, line 1619
    logWarn 'device health check is disabled!' // library marker kkossev.commonLib, line 1620
} // library marker kkossev.commonLib, line 1621

// called when any event was received from the Zigbee device in the parse() method. // library marker kkossev.commonLib, line 1623

void setHealthStatusOnline(Map state) { // library marker kkossev.commonLib, line 1625
    if (state.health == null) { state.health = [:] } // library marker kkossev.commonLib, line 1626
    state.health['checkCtr3']  = 0 // library marker kkossev.commonLib, line 1627
    if (!((device.currentValue('healthStatus') ?: 'unknown') in ['online'])) { // library marker kkossev.commonLib, line 1628
        sendHealthStatusEvent('online') // library marker kkossev.commonLib, line 1629
        logInfo 'is now online!' // library marker kkossev.commonLib, line 1630
    } // library marker kkossev.commonLib, line 1631
} // library marker kkossev.commonLib, line 1632

void deviceHealthCheck() { // library marker kkossev.commonLib, line 1634
    checkDriverVersion(state) // library marker kkossev.commonLib, line 1635
    if (state.health == null) { state.health = [:] } // library marker kkossev.commonLib, line 1636
    int ctr = state.health['checkCtr3'] ?: 0 // library marker kkossev.commonLib, line 1637
    if (ctr  >= PRESENCE_COUNT_THRESHOLD) { // library marker kkossev.commonLib, line 1638
        if ((device.currentValue('healthStatus') ?: 'unknown') != 'offline' ) { // library marker kkossev.commonLib, line 1639
            logWarn 'not present!' // library marker kkossev.commonLib, line 1640
            sendHealthStatusEvent('offline') // library marker kkossev.commonLib, line 1641
        ...
        logDebug "deviceHealthCheck - online (notPresentCounter=${ctr})" // library marker kkossev.commonLib, line 1645
    } // library marker kkossev.commonLib, line 1646
    state.health['checkCtr3'] = ctr + 1 // library marker kkossev.commonLib, line 1647
} // library marker kkossev.commonLib, line 1648

void sendHealthStatusEvent(final String value) { // library marker kkossev.commonLib, line 1650
    String descriptionText = "healthStatus changed to ${value}" // library marker kkossev.commonLib, line 1651
    sendEvent(name: 'healthStatus', value: value, descriptionText: descriptionText, isStateChange: true, isDigital: true) // library marker kkossev.commonLib, line 1652
    if (value == 'online') { // library marker kkossev.commonLib, line 1653
        logInfo "${descriptionText}" // library marker kkossev.commonLib, line 1654
    } // library marker kkossev.commonLib, line 1655
    else { // library marker kkossev.commonLib, line 1656
        if (settings?.txtEnable) { log.warn "${device.displayName}} <b>${descriptionText}</b>" } // library marker kkossev.commonLib, line 1657
 ...
 * Scheduled job for polling device specific attribute(s) // library marker kkossev.commonLib, line 1662
 */ // library marker kkossev.commonLib, line 1663
void autoPoll() { // library marker kkossev.commonLib, line 1664
    logDebug 'autoPoll()...' // library marker kkossev.commonLib, line 1665
    checkDriverVersion(state) // library marker kkossev.commonLib, line 1666
    List<String> cmds = [] // library marker kkossev.commonLib, line 1667
    if (DEVICE_TYPE in  ['AirQuality']) { // library marker kkossev.commonLib, line 1668
        cmds += zigbee.readAttribute(0xfc7e, 0x0000, [mfgCode: 0x117c], delay = 200)      // tVOC   !! mfcode = "0x117c" !! attributes: (float) 0: Measured Value; 1: Min Measured Value; 2:Max Measured Value; // library marker kkossev.commonLib, line 1669
    } // library marker kkossev.commonLib, line 1670

    if (cmds != null && !cmds.isEmpty()) { // library marker kkossev.commonLib, line 1672
        sendZigbeeCommands(cmds) // library marker kkossev.commonLib, line 1673
 ...
 * Invoked by Hubitat when the driver configuration is updated // library marker kkossev.commonLib, line 1678
 */ // library marker kkossev.commonLib, line 1679
void updated() { // library marker kkossev.commonLib, line 1680
    logInfo 'updated()...' // library marker kkossev.commonLib, line 1681
    checkDriverVersion(state) // library marker kkossev.commonLib, line 1682
    logInfo"driver version ${driverVersionAndTimeStamp()}" // library marker kkossev.commonLib, line 1683
    unschedule() // library marker kkossev.commonLib, line 1684

    if (settings.logEnable) { // library marker kkossev.commonLib, line 1686
        logTrace(settings.toString()) // library marker kkossev.commonLib, line 1687
        runIn(86400, logsOff) // library marker kkossev.commonLib, line 1688
    } // library marker kkossev.commonLib, line 1689
    if (settings.traceEnable) { // library marker kkossev.commonLib, line 1690
        logTrace(settings.toString()) // library marker kkossev.commonLib, line 1691
        runIn(1800, traceOff) // library marker kkossev.commonLib, line 1692
    } // library marker kkossev.commonLib, line 1693

    final int healthMethod = (settings.healthCheckMethod as Integer) ?: 0 // library marker kkossev.commonLib, line 1695
    if (healthMethod == 1 || healthMethod == 2) {                            //    [0: 'Disabled', 1: 'Activity check', 2: 'Periodic polling'] // library marker kkossev.commonLib, line 1696
        // schedule the periodic timer // library marker kkossev.commonLib, line 1697
        final int interval = (settings.healthCheckInterval as Integer) ?: 0 // library marker kkossev.commonLib, line 1698
        if (interval > 0) { // library marker kkossev.commonLib, line 1699
            //log.trace "healthMethod=${healthMethod} interval=${interval}" // library marker kkossev.commonLib, line 1700
            log.info "scheduling health check every ${interval} minutes by ${HealthcheckMethodOpts.options[healthCheckMethod as int]} method" // library marker kkossev.commonLib, line 1701
            scheduleDeviceHealthCheck(interval, healthMethod) // library marker kkossev.commonLib, line 1702
        } // library marker kkossev.commonLib, line 1703
    } // library marker kkossev.commonLib, line 1704
    else { // library marker kkossev.commonLib, line 1705
        unScheduleDeviceHealthCheck()        // unschedule the periodic job, depending on the healthMethod // library marker kkossev.commonLib, line 1706
        log.info 'Health Check is disabled!' // library marker kkossev.commonLib, line 1707
    } // library marker kkossev.commonLib, line 1708
    if (this.respondsTo('customUpdated')) { // library marker kkossev.commonLib, line 1709
        customUpdated() // library marker kkossev.commonLib, line 1710
    } // library marker kkossev.commonLib, line 1711

    sendInfoEvent('updated') // library marker kkossev.commonLib, line 1713
} // library marker kkossev.commonLib, line 1714

/** // library marker kkossev.commonLib, line 1716
 * Disable logging (for debugging) // library marker kkossev.commonLib, line 1717
 */ // library marker kkossev.commonLib, line 1718
void logsOff() { // library marker kkossev.commonLib, line 1719
    logInfo 'debug logging disabled...' // library marker kkossev.commonLib, line 1720
    device.updateSetting('logEnable', [value: 'false', type: 'bool']) // library marker kkossev.commonLib, line 1721
} // library marker kkossev.commonLib, line 1722
void traceOff() { // library marker kkossev.commonLib, line 1723
    logInfo 'trace logging disabled...' // library marker kkossev.commonLib, line 1724
    device.updateSetting('traceEnable', [value: 'false', type: 'bool']) // library marker kkossev.commonLib, line 1725
} // library marker kkossev.commonLib, line 1726

void configure(String command) { // library marker kkossev.commonLib, line 1728
    logInfo "configure(${command})..." // library marker kkossev.commonLib, line 1729
    if (!(command in (ConfigureOpts.keySet() as List))) { // library marker kkossev.commonLib, line 1730
        logWarn "configure: command <b>${command}</b> must be one of these : ${ConfigureOpts.keySet() as List}" // library marker kkossev.commonLib, line 1731
    ...
    String func // library marker kkossev.commonLib, line 1735
    try { // library marker kkossev.commonLib, line 1736
        func = ConfigureOpts[command]?.function // library marker kkossev.commonLib, line 1737
        "$func"() // library marker kkossev.commonLib, line 1738
    } // library marker kkossev.commonLib, line 1739
    catch (e) { // library marker kkossev.commonLib, line 1740
        logWarn "Exception ${e} caught while processing <b>$func</b>(<b>$value</b>)" // library marker kkossev.commonLib, line 1741
        return // library marker kkossev.commonLib, line 1742
    } // library marker kkossev.commonLib, line 1743
    logInfo "executed '${func}'" // library marker kkossev.commonLib, line 1744
} // library marker kkossev.commonLib, line 1745

/* groovylint-disable-next-line UnusedMethodParameter */ // library marker kkossev.commonLib, line 1747
void configureHelp(final String val) { // library marker kkossev.commonLib, line 1748
    if (settings?.txtEnable) { log.warn "${device.displayName} configureHelp: select one of the commands in this list!" } // library marker kkossev.commonLib, line 1749
} // library marker kkossev.commonLib, line 1750

void loadAllDefaults() { // library marker kkossev.commonLib, line 1752
    logWarn 'loadAllDefaults() !!!' // library marker kkossev.commonLib, line 1753
    deleteAllSettings() // library marker kkossev.commonLib, line 1754
    deleteAllCurrentStates() // library marker kkossev.commonLib, line 1755
    deleteAllScheduledJobs() // library marker kkossev.commonLib, line 1756
    deleteAllStates() // library marker kkossev.commonLib, line 1757
    deleteAllChildDevices() // library marker kkossev.commonLib, line 1758
    initialize() // library marker kkossev.commonLib, line 1759
    configureNow()     // calls  also   configureDevice()   // bug fixed 04/03/2024 // library marker kkossev.commonLib, line 1760
    updated() // library marker kkossev.commonLib, line 1761
    sendInfoEvent('All Defaults Loaded! F5 to refresh') // library marker kkossev.commonLib, line 1762
} // library marker kkossev.commonLib, line 1763

void configureNow() { // library marker kkossev.commonLib, line 1765
    configure() // library marker kkossev.commonLib, line 1766
} // library marker kkossev.commonLib, line 1767

/** // library marker kkossev.commonLib, line 1769
 * Send configuration parameters to the device // library marker kkossev.commonLib, line 1770
 * Invoked when device is first installed and when the user updates the configuration  TODO // library marker kkossev.commonLib, line 1771
 * @return sends zigbee commands // library marker kkossev.commonLib, line 1772
 */ // library marker kkossev.commonLib, line 1773
void configure() { // library marker kkossev.commonLib, line 1774
    List<String> cmds = [] // library marker kkossev.commonLib, line 1775
    if (state.stats == null) { state.stats = [:] } ; state.stats.cfgCtr = (state.stats.cfgCtr ?: 0) + 1 // library marker kkossev.commonLib, line 1776
    logInfo "configure()... cfgCtr=${state.stats.cfgCtr}" // library marker kkossev.commonLib, line 1777
    logDebug "configure(): settings: $settings" // library marker kkossev.commonLib, line 1778
    if (isTuya()) { // library marker kkossev.commonLib, line 1779
        cmds += tuyaBlackMagic() // library marker kkossev.commonLib, line 1780
    } // library marker kkossev.commonLib, line 1781
    if (isAqaraTVOC_OLD() || isAqaraTRV_OLD()) { // library marker kkossev.commonLib, line 1782
        aqaraBlackMagic()   // zigbee commands are sent here! // library marker kkossev.commonLib, line 1783
    } // library marker kkossev.commonLib, line 1784
    List<String> initCmds = initializeDevice() // library marker kkossev.commonLib, line 1785
    if (initCmds != null && !initCmds.isEmpty()) { cmds += initCmds } // library marker kkossev.commonLib, line 1786
    List<String> cfgCmds = configureDevice() // library marker kkossev.commonLib, line 1787
    if (cfgCmds != null && !cfgCmds.isEmpty()) { cmds += cfgCmds } // library marker kkossev.commonLib, line 1788
    if (cmds != null && !cmds.isEmpty()) { // library marker kkossev.commonLib, line 1789
        sendZigbeeCommands(cmds) // library marker kkossev.commonLib, line 1790
        logDebug "configure(): sent cmds = ${cmds}" // library marker kkossev.commonLib, line 1791
        sendInfoEvent('sent device configuration') // library marker kkossev.commonLib, line 1792
    } // library marker kkossev.commonLib, line 1793
    else { // library marker kkossev.commonLib, line 1794
        logDebug "configure(): no commands defined for device type ${DEVICE_TYPE}" // library marker kkossev.commonLib, line 1795
 ...
 * Invoked by Hubitat when driver is installed // library marker kkossev.commonLib, line 1800
 */ // library marker kkossev.commonLib, line 1801
void installed() { // library marker kkossev.commonLib, line 1802
    if (state.stats == null) { state.stats = [:] } ; state.stats.instCtr = (state.stats.instCtr ?: 0) + 1 // library marker kkossev.commonLib, line 1803
    logInfo "installed()... instCtr=${state.stats.instCtr}" // library marker kkossev.commonLib, line 1804
    // populate some default values for attributes // library marker kkossev.commonLib, line 1805
    sendEvent(name: 'healthStatus', value: 'unknown') // library marker kkossev.commonLib, line 1806
    sendEvent(name: 'powerSource', value: 'unknown') // library marker kkossev.commonLib, line 1807
    sendInfoEvent('installed') // library marker kkossev.commonLib, line 1808
    runIn(3, 'updated') // library marker kkossev.commonLib, line 1809
} // library marker kkossev.commonLib, line 1810

/** // library marker kkossev.commonLib, line 1812
 * Invoked when the initialize button is clicked // library marker kkossev.commonLib, line 1813
 */ // library marker kkossev.commonLib, line 1814
void initialize() { // library marker kkossev.commonLib, line 1815
    if (state.stats == null) { state.stats = [:] } ; state.stats.initCtr = (state.stats.initCtr ?: 0) + 1 // library marker kkossev.commonLib, line 1816
    logInfo "initialize()... initCtr=${state.stats.initCtr}" // library marker kkossev.commonLib, line 1817
    initializeVars(fullInit = true) // library marker kkossev.commonLib, line 1818
    updateTuyaVersion() // library marker kkossev.commonLib, line 1819
    updateAqaraVersion() // library marker kkossev.commonLib, line 1820
 ...
 * kkossev drivers commonly used functions // library marker kkossev.commonLib, line 1825
...
static Integer safeToInt(val, Integer defaultVal=0) { // library marker kkossev.commonLib, line 1830
    return "${val}"?.isInteger() ? "${val}".toInteger() : defaultVal // library marker kkossev.commonLib, line 1831
} // library marker kkossev.commonLib, line 1832

/* groovylint-disable-next-line MethodParameterTypeRequired, NoDouble */ // library marker kkossev.commonLib, line 1834
static Double safeToDouble(val, Double defaultVal=0.0) { // library marker kkossev.commonLib, line 1835
    return "${val}"?.isDouble() ? "${val}".toDouble() : defaultVal // library marker kkossev.commonLib, line 1836
} // library marker kkossev.commonLib, line 1837

/* groovylint-disable-next-line MethodParameterTypeRequired */ // library marker kkossev.commonLib, line 1839
static BigDecimal safeToBigDecimal(val, BigDecimal defaultVal=0.0) { // library marker kkossev.commonLib, line 1840
    return "${val}"?.isBigDecimal() ? "${val}".toBigDecimal() : defaultVal // library marker kkossev.commonLib, line 1841
} // library marker kkossev.commonLib, line 1842

void sendZigbeeCommands(List<String> cmd) { // library marker kkossev.commonLib, line 1844
    if (cmd == null || cmd.isEmpty()) { // library marker kkossev.commonLib, line 1845
        logWarn "sendZigbeeCommands: list is empty! cmd=${cmd}" // library marker kkossev.commonLib, line 1846
        return // library marker kkossev.commonLib, line 1847
    } // library marker kkossev.commonLib, line 1848
    hubitat.device.HubMultiAction allActions = new hubitat.device.HubMultiAction() // library marker kkossev.commonLib, line 1849
    cmd.each { // library marker kkossev.commonLib, line 1850
        if (it == null || it.isEmpty() || it == 'null') { // library marker kkossev.commonLib, line 1851
            logWarn "sendZigbeeCommands it: no commands to send! it=${it} (cmd=${cmd})" // library marker kkossev.commonLib, line 1852
            return // library marker kkossev.commonLib, line 1853
        } // library marker kkossev.commonLib, line 1854
        allActions.add(new hubitat.device.HubAction(it, hubitat.device.Protocol.ZIGBEE)) // library marker kkossev.commonLib, line 1855
        if (state.stats != null) { state.stats['txCtr'] = (state.stats['txCtr'] ?: 0) + 1 } else { state.stats = [:] } // library marker kkossev.commonLib, line 1856
    } // library marker kkossev.commonLib, line 1857
    if (state.lastTx != null) { state.lastTx['cmdTime'] = now() } else { state.lastTx = [:] } // library marker kkossev.commonLib, line 1858
    sendHubCommand(allActions) // library marker kkossev.commonLib, line 1859
    logDebug "sendZigbeeCommands: sent cmd=${cmd}" // library marker kkossev.commonLib, line 1860
} // library marker kkossev.commonLib, line 1861

String driverVersionAndTimeStamp() { version() + ' ' + timeStamp() + ((_DEBUG) ? ' (debug version!) ' : ' ') + "(${device.getDataValue('model')} ${device.getDataValue('manufacturer')}) (${getModel()} ${location.hub.firmwareVersionString})" } // library marker kkossev.commonLib, line 1863

String getDeviceInfo() { // library marker kkossev.commonLib, line 1865
    return "model=${device.getDataValue('model')} manufacturer=${device.getDataValue('manufacturer')} destinationEP=${state.destinationEP ?: UNKNOWN} <b>deviceProfile=${state.deviceProfile ?: UNKNOWN}</b>" // library marker kkossev.commonLib, line 1866
} // library marker kkossev.commonLib, line 1867

String getDestinationEP() {    // [destEndpoint:safeToInt(getDestinationEP())] // library marker kkossev.commonLib, line 1869
    return state.destinationEP ?: device.endpointId ?: '01' // library marker kkossev.commonLib, line 1870
} // library marker kkossev.commonLib, line 1871

@CompileStatic // library marker kkossev.commonLib, line 1873
void checkDriverVersion(final Map state) { // library marker kkossev.commonLib, line 1874
    if (state.driverVersion == null || driverVersionAndTimeStamp() != state.driverVersion) { // library marker kkossev.commonLib, line 1875
        logDebug "checkDriverVersion: updating the settings from the current driver version ${state.driverVersion} to the new version ${driverVersionAndTimeStamp()}" // library marker kkossev.commonLib, line 1876
        sendInfoEvent("Updated to version ${driverVersionAndTimeStamp()}") // library marker kkossev.commonLib, line 1877
        state.driverVersion = driverVersionAndTimeStamp() // library marker kkossev.commonLib, line 1878
        initializeVars(false) // library marker kkossev.commonLib, line 1879
        updateTuyaVersion() // library marker kkossev.commonLib, line 1880
        updateAqaraVersion() // library marker kkossev.commonLib, line 1881
    } // library marker kkossev.commonLib, line 1882
    if (state.states == null) { state.states = [:] } // library marker kkossev.commonLib, line 1883
    if (state.lastRx == null) { state.lastRx = [:] } // library marker kkossev.commonLib, line 1884
    if (state.lastTx == null) { state.lastTx = [:] } // library marker kkossev.commonLib, line 1885
    if (state.stats  == null) { state.stats =  [:] } // library marker kkossev.commonLib, line 1886
} // library marker kkossev.commonLib, line 1887


// credits @thebearmay // library marker kkossev.commonLib, line 1890
String getModel() { // library marker kkossev.commonLib, line 1891
    try { // library marker kkossev.commonLib, line 1892
        /* groovylint-disable-next-line UnnecessaryGetter, UnusedVariable */ // library marker kkossev.commonLib, line 1893
        String model = getHubVersion() // requires >=2.2.8.141 // library marker kkossev.commonLib, line 1894
    } catch (ignore) { // library marker kkossev.commonLib, line 1895
        try { // library marker kkossev.commonLib, line 1896
            httpGet("http://${location.hub.localIP}:8080/api/hubitat.xml") { res -> // library marker kkossev.commonLib, line 1897
                model = res.data.device.modelName // library marker kkossev.commonLib, line 1898
                return model // library marker kkossev.commonLib, line 1899
            } // library marker kkossev.commonLib, line 1900
        } catch (ignore_again) { // library marker kkossev.commonLib, line 1901
            return '' // library marker kkossev.commonLib, line 1902
...
// credits @thebearmay // library marker kkossev.commonLib, line 1907
boolean isCompatible(Integer minLevel) { //check to see if the hub version meets the minimum requirement ( 7 or 8 ) // library marker kkossev.commonLib, line 1908
    String model = getModel()            // <modelName>Rev C-7</modelName> // library marker kkossev.commonLib, line 1909
    String[] tokens = model.split('-') // library marker kkossev.commonLib, line 1910
    String revision = tokens.last() // library marker kkossev.commonLib, line 1911
    return (Integer.parseInt(revision) >= minLevel) // library marker kkossev.commonLib, line 1912
} // library marker kkossev.commonLib, line 1913

/** // library marker kkossev.commonLib, line 1915
 * called from TODO // library marker kkossev.commonLib, line 1916
 */ // library marker kkossev.commonLib, line 1917

void deleteAllStatesAndJobs() { // library marker kkossev.commonLib, line 1919
    state.clear()    // clear all states // library marker kkossev.commonLib, line 1920
    unschedule() // library marker kkossev.commonLib, line 1921
    device.deleteCurrentState('*') // library marker kkossev.commonLib, line 1922
    device.deleteCurrentState('') // library marker kkossev.commonLib, line 1923

    log.info "${device.displayName} jobs and states cleared. HE hub is ${getHubVersion()}, version is ${location.hub.firmwareVersionString}" // library marker kkossev.commonLib, line 1925
} // library marker kkossev.commonLib, line 1926

void resetStatistics() { // library marker kkossev.commonLib, line 1928
    runIn(1, 'resetStats') // library marker kkossev.commonLib, line 1929
    sendInfoEvent('Statistics are reset. Refresh the web page') // library marker kkossev.commonLib, line 1930
} // library marker kkossev.commonLib, line 1931

// called from initializeVars(true) and resetStatistics() // library marker kkossev.commonLib, line 1933
void resetStats() { // library marker kkossev.commonLib, line 1934
    logDebug 'resetStats...' // library marker kkossev.commonLib, line 1935
    state.stats = [:] ; state.states = [:] ; state.lastRx = [:] ; state.lastTx = [:] ; state.health = [:] // library marker kkossev.commonLib, line 1936
    if (this.respondsTo('groupsLibVersion')) { state.zigbeeGroups = [:] } // library marker kkossev.commonLib, line 1937
    state.stats['rxCtr'] = 0 ; state.stats['txCtr'] = 0 // library marker kkossev.commonLib, line 1938
    state.states['isDigital'] = false ; state.states['isRefresh'] = false ; state.states['isPing'] = false // library marker kkossev.commonLib, line 1939
    state.health['offlineCtr'] = 0 ; state.health['checkCtr3'] = 0 // library marker kkossev.commonLib, line 1940
} // library marker kkossev.commonLib, line 1941

/** // library marker kkossev.commonLib, line 1943
 * called from TODO // library marker kkossev.commonLib, line 1944
 */ // library marker kkossev.commonLib, line 1945
void initializeVars( boolean fullInit = false ) { // library marker kkossev.commonLib, line 1946
    logDebug "InitializeVars()... fullInit = ${fullInit}" // library marker kkossev.commonLib, line 1947
    if (fullInit == true ) { // library marker kkossev.commonLib, line 1948
        state.clear() // library marker kkossev.commonLib, line 1949
        unschedule() // library marker kkossev.commonLib, line 1950
        resetStats() // library marker kkossev.commonLib, line 1951
        //setDeviceNameAndProfile() // library marker kkossev.commonLib, line 1952
        //state.comment = 'Works with Tuya Zigbee Devices' // library marker kkossev.commonLib, line 1953
        logInfo 'all states and scheduled jobs cleared!' // library marker kkossev.commonLib, line 1954
        state.driverVersion = driverVersionAndTimeStamp() // library marker kkossev.commonLib, line 1955
        logInfo "DEVICE_TYPE = ${DEVICE_TYPE}" // library marker kkossev.commonLib, line 1956
        state.deviceType = DEVICE_TYPE // library marker kkossev.commonLib, line 1957
        sendInfoEvent('Initialized') // library marker kkossev.commonLib, line 1958
    } // library marker kkossev.commonLib, line 1959

    if (state.stats == null)  { state.stats  = [:] } // library marker kkossev.commonLib, line 1961
    if (state.states == null) { state.states = [:] } // library marker kkossev.commonLib, line 1962
    if (state.lastRx == null) { state.lastRx = [:] } // library marker kkossev.commonLib, line 1963
    if (state.lastTx == null) { state.lastTx = [:] } // library marker kkossev.commonLib, line 1964
    if (state.health == null) { state.health = [:] } // library marker kkossev.commonLib, line 1965

    if (fullInit || settings?.txtEnable == null) { device.updateSetting('txtEnable', true) } // library marker kkossev.commonLib, line 1967
    if (fullInit || settings?.logEnable == null) { device.updateSetting('logEnable', DEFAULT_DEBUG_LOGGING ?: false) } // library marker kkossev.commonLib, line 1968
    if (fullInit || settings?.traceEnable == null) { device.updateSetting('traceEnable', false) } // library marker kkossev.commonLib, line 1969
    if (fullInit || settings?.alwaysOn == null) { device.updateSetting('alwaysOn', false) } // library marker kkossev.commonLib, line 1970
    if (fullInit || settings?.advancedOptions == null) { device.updateSetting('advancedOptions', [value:false, type:'bool']) } // library marker kkossev.commonLib, line 1971
    if (fullInit || settings?.healthCheckMethod == null) { device.updateSetting('healthCheckMethod', [value: HealthcheckMethodOpts.defaultValue.toString(), type: 'enum']) } // library marker kkossev.commonLib, line 1972
    if (fullInit || settings?.healthCheckInterval == null) { device.updateSetting('healthCheckInterval', [value: HealthcheckIntervalOpts.defaultValue.toString(), type: 'enum']) } // library marker kkossev.commonLib, line 1973
    if (device.currentValue('healthStatus') == null) { sendHealthStatusEvent('unknown') } // library marker kkossev.commonLib, line 1974
    if (fullInit || settings?.voltageToPercent == null) { device.updateSetting('voltageToPercent', false) } // library marker kkossev.commonLib, line 1975
    if ((fullInit || settings?.threeStateEnable == null) && _THREE_STATE == true) { device.updateSetting('threeStateEnable', false) } // library marker kkossev.commonLib, line 1976

    // common libraries initialization - TODO !!!!!!!!!!!!! // library marker kkossev.commonLib, line 1978
    executeCustomHandler('groupsInitializeVars', fullInit) // library marker kkossev.commonLib, line 1979
    executeCustomHandler('deviceProfileInitializeVars', fullInit) // library marker kkossev.commonLib, line 1980
    executeCustomHandler('illuminanceInitializeVars', fullInit) // library marker kkossev.commonLib, line 1981

    // device specific initialization should be at the end // library marker kkossev.commonLib, line 1983
    executeCustomHandler('customInitializeVars', fullInit) // library marker kkossev.commonLib, line 1984
    executeCustomHandler('customCreateChildDevices', fullInit) // library marker kkossev.commonLib, line 1985
    executeCustomHandler('customInitEvents', fullInit) // library marker kkossev.commonLib, line 1986
    if (DEVICE_TYPE in ['Bulb'])       { initVarsBulb(fullInit);     initEventsBulb(fullInit) } // library marker kkossev.commonLib, line 1987

    final String mm = device.getDataValue('model') // library marker kkossev.commonLib, line 1989
    if ( mm != null) { // library marker kkossev.commonLib, line 1990
        logTrace " model = ${mm}" // library marker kkossev.commonLib, line 1991
    } // library marker kkossev.commonLib, line 1992
    else { // library marker kkossev.commonLib, line 1993
        logWarn ' Model not found, please re-pair the device!' // library marker kkossev.commonLib, line 1994
    } // library marker kkossev.commonLib, line 1995
    final String ep = device.getEndpointId() // library marker kkossev.commonLib, line 1996
    if ( ep  != null) { // library marker kkossev.commonLib, line 1997
        //state.destinationEP = ep // library marker kkossev.commonLib, line 1998
        logTrace " destinationEP = ${ep}" // library marker kkossev.commonLib, line 1999
    } // library marker kkossev.commonLib, line 2000
    else { // library marker kkossev.commonLib, line 2001
        logWarn ' Destination End Point not found, please re-pair the device!' // library marker kkossev.commonLib, line 2002
    //state.destinationEP = "01"    // fallback // library marker kkossev.commonLib, line 2003
 ...
 * called from TODO // library marker kkossev.commonLib, line 2008
 */ // library marker kkossev.commonLib, line 2009
void setDestinationEP() { // library marker kkossev.commonLib, line 2010
    String ep = device.getEndpointId() // library marker kkossev.commonLib, line 2011
    if (ep != null && ep != 'F2') { // library marker kkossev.commonLib, line 2012
        state.destinationEP = ep // library marker kkossev.commonLib, line 2013
        logDebug "setDestinationEP() destinationEP = ${state.destinationEP}" // library marker kkossev.commonLib, line 2014
    } // library marker kkossev.commonLib, line 2015
    else { // library marker kkossev.commonLib, line 2016
        logWarn "setDestinationEP() Destination End Point not found or invalid(${ep}), activating the F2 bug patch!" // library marker kkossev.commonLib, line 2017
        state.destinationEP = '01'    // fallback EP // library marker kkossev.commonLib, line 2018
    } // library marker kkossev.commonLib, line 2019
} // library marker kkossev.commonLib, line 2020

void logDebug(final String msg) { // library marker kkossev.commonLib, line 2022
    if (settings?.logEnable) { // library marker kkossev.commonLib, line 2023
        log.debug "${device.displayName} " + msg // library marker kkossev.commonLib, line 2024
    } // library marker kkossev.commonLib, line 2025
} // library marker kkossev.commonLib, line 2026

void logInfo(final String msg) { // library marker kkossev.commonLib, line 2028
    if (settings?.txtEnable) { // library marker kkossev.commonLib, line 2029
        log.info "${device.displayName} " + msg // library marker kkossev.commonLib, line 2030
    } // library marker kkossev.commonLib, line 2031
} // library marker kkossev.commonLib, line 2032

void logWarn(final String msg) { // library marker kkossev.commonLib, line 2034
    if (settings?.logEnable) { // library marker kkossev.commonLib, line 2035
        log.warn "${device.displayName} " + msg // library marker kkossev.commonLib, line 2036
    } // library marker kkossev.commonLib, line 2037
} // library marker kkossev.commonLib, line 2038

void logTrace(final String msg) { // library marker kkossev.commonLib, line 2040
    if (settings?.traceEnable) { // library marker kkossev.commonLib, line 2041
        log.trace "${device.displayName} " + msg // library marker kkossev.commonLib, line 2042
    } // library marker kkossev.commonLib, line 2043
} // library marker kkossev.commonLib, line 2044

// _DEBUG mode only // library marker kkossev.commonLib, line 2046
void getAllProperties() { // library marker kkossev.commonLib, line 2047
    log.trace 'Properties:' // library marker kkossev.commonLib, line 2048
    device.properties.each { it -> // library marker kkossev.commonLib, line 2049
        log.debug it // library marker kkossev.commonLib, line 2050
    } // library marker kkossev.commonLib, line 2051
    log.trace 'Settings:' // library marker kkossev.commonLib, line 2052
    settings.each { it -> // library marker kkossev.commonLib, line 2053
        log.debug "${it.key} =  ${it.value}"    // https://community.hubitat.com/t/how-do-i-get-the-datatype-for-an-app-setting/104228/6?u=kkossev // library marker kkossev.commonLib, line 2054
    } // library marker kkossev.commonLib, line 2055
    log.trace 'Done' // library marker kkossev.commonLib, line 2056
} // library marker kkossev.commonLib, line 2057

// delete all Preferences // library marker kkossev.commonLib, line 2059
void deleteAllSettings() { // library marker kkossev.commonLib, line 2060
    String preferencesDeleted = '' // library marker kkossev.commonLib, line 2061
    settings.each { it -> // library marker kkossev.commonLib, line 2062
        preferencesDeleted += "${it.key} (${it.value}), " // library marker kkossev.commonLib, line 2063
        device.removeSetting("${it.key}") // library marker kkossev.commonLib, line 2064
    } // library marker kkossev.commonLib, line 2065
    logDebug "Deleted settings: ${preferencesDeleted}" // library marker kkossev.commonLib, line 2066
    logInfo  'All settings (preferences) DELETED' // library marker kkossev.commonLib, line 2067
} // library marker kkossev.commonLib, line 2068

// delete all attributes // library marker kkossev.commonLib, line 2070
void deleteAllCurrentStates() { // library marker kkossev.commonLib, line 2071
    String attributesDeleted = '' // library marker kkossev.commonLib, line 2072
    device.properties.supportedAttributes.each { it -> attributesDeleted += "${it}, " ; device.deleteCurrentState("$it") } // library marker kkossev.commonLib, line 2073
    logDebug "Deleted attributes: ${attributesDeleted}" ; logInfo 'All current states (attributes) DELETED' // library marker kkossev.commonLib, line 2074
} // library marker kkossev.commonLib, line 2075

// delete all State Variables // library marker kkossev.commonLib, line 2077
void deleteAllStates() { // library marker kkossev.commonLib, line 2078
    String stateDeleted = '' // library marker kkossev.commonLib, line 2079
    state.each { it -> stateDeleted += "${it.key}, " } // library marker kkossev.commonLib, line 2080
    state.clear() // library marker kkossev.commonLib, line 2081
    logDebug "Deleted states: ${stateDeleted}" ; logInfo 'All States DELETED' // library marker kkossev.commonLib, line 2082
} // library marker kkossev.commonLib, line 2083

void deleteAllScheduledJobs() { // library marker kkossev.commonLib, line 2085
    unschedule() ; logInfo 'All scheduled jobs DELETED' // library marker kkossev.commonLib, line 2086
} // library marker kkossev.commonLib, line 2087

void deleteAllChildDevices() { // library marker kkossev.commonLib, line 2089
    getChildDevices().each { child -> // library marker kkossev.commonLib, line 2090
        log.info "${device.displayName} Deleting ${child.deviceNetworkId}" // library marker kkossev.commonLib, line 2091
        deleteChildDevice(child.deviceNetworkId) // library marker kkossev.commonLib, line 2092
    } // library marker kkossev.commonLib, line 2093
    sendInfoEvent 'All child devices DELETED' // library marker kkossev.commonLib, line 2094
} // library marker kkossev.commonLib, line 2095

void parseTest(String par) { // library marker kkossev.commonLib, line 2097
    //read attr - raw: DF8D0104020A000029280A, dni: DF8D, endpoint: 01, cluster: 0402, size: 0A, attrId: 0000, encoding: 29, command: 0A, value: 280A // library marker kkossev.commonLib, line 2098
    log.warn "parseTest - <b>START</b> (${par})" // library marker kkossev.commonLib, line 2099
    parse(par) // library marker kkossev.commonLib, line 2100
    log.warn "parseTest -   <b>END</b> (${par})" // library marker kkossev.commonLib, line 2101
} // library marker kkossev.commonLib, line 2102

def testJob() { // library marker kkossev.commonLib, line 2104
    log.warn 'test job executed' // library marker kkossev.commonLib, line 2105
} // library marker kkossev.commonLib, line 2106

/** // library marker kkossev.commonLib, line 2108
 * Calculates and returns the cron expression // library marker kkossev.commonLib, line 2109
 * @param timeInSeconds interval in seconds // library marker kkossev.commonLib, line 2110
 */ // library marker kkossev.commonLib, line 2111
String getCron(int timeInSeconds) { // library marker kkossev.commonLib, line 2112
    //schedule("${rnd.nextInt(59)} ${rnd.nextInt(9)}/${intervalMins} * ? * * *", 'ping') // library marker kkossev.commonLib, line 2113
    // TODO: runEvery1Minute runEvery5Minutes runEvery10Minutes runEvery15Minutes runEvery30Minutes runEvery1Hour runEvery3Hours // library marker kkossev.commonLib, line 2114
    final Random rnd = new Random() // library marker kkossev.commonLib, line 2115
    int minutes = (timeInSeconds / 60 ) as int // library marker kkossev.commonLib, line 2116
    int  hours = (minutes / 60 ) as int // library marker kkossev.commonLib, line 2117
    if (hours > 23) { hours = 23 } // library marker kkossev.commonLib, line 2118
    String cron // library marker kkossev.commonLib, line 2119
    if (timeInSeconds < 60) { // library marker kkossev.commonLib, line 2120
        cron = "*/$timeInSeconds * * * * ? *" // library marker kkossev.commonLib, line 2121
    } // library marker kkossev.commonLib, line 2122
    else { // library marker kkossev.commonLib, line 2123
        if (minutes < 60) { // library marker kkossev.commonLib, line 2124
            cron = "${rnd.nextInt(59)} ${rnd.nextInt(9)}/$minutes * ? * *" // library marker kkossev.commonLib, line 2125
        } // library marker kkossev.commonLib, line 2126
        else { // library marker kkossev.commonLib, line 2127
            cron = "${rnd.nextInt(59)} ${rnd.nextInt(59)} */$hours ? * *" // library marker kkossev.commonLib, line 2128
        } // library marker kkossev.commonLib, line 2129
    } // library marker kkossev.commonLib, line 2130
    return cron // library marker kkossev.commonLib, line 2131
} // library marker kkossev.commonLib, line 2132

// credits @thebearmay // library marker kkossev.commonLib, line 2134
String formatUptime() { // library marker kkossev.commonLib, line 2135
    return formatTime(location.hub.uptime) // library marker kkossev.commonLib, line 2136
} // library marker kkossev.commonLib, line 2137

String formatTime(int timeInSeconds) { // library marker kkossev.commonLib, line 2139
    if (timeInSeconds == null) { return UNKNOWN } // library marker kkossev.commonLib, line 2140
    int days = (timeInSeconds / 86400).toInteger() // library marker kkossev.commonLib, line 2141
    int hours = ((timeInSeconds % 86400) / 3600).toInteger() // library marker kkossev.commonLib, line 2142
    int minutes = ((timeInSeconds % 3600) / 60).toInteger() // library marker kkossev.commonLib, line 2143
    int seconds = (timeInSeconds % 60).toInteger() // library marker kkossev.commonLib, line 2144
    return "${days}d ${hours}h ${minutes}m ${seconds}s" // library marker kkossev.commonLib, line 2145
} // library marker kkossev.commonLib, line 2146

boolean isTuya() { // library marker kkossev.commonLib, line 2148
    if (!device) { return true }    // fallback - added 04/03/2024 // library marker kkossev.commonLib, line 2149
    String model = device.getDataValue('model') // library marker kkossev.commonLib, line 2150
    String manufacturer = device.getDataValue('manufacturer') // library marker kkossev.commonLib, line 2151
    /* groovylint-disable-next-line UnnecessaryTernaryExpression */ // library marker kkossev.commonLib, line 2152
    return (model?.startsWith('TS') && manufacturer?.startsWith('_TZ')) ? true : false // library marker kkossev.commonLib, line 2153
} // library marker kkossev.commonLib, line 2154

void updateTuyaVersion() { // library marker kkossev.commonLib, line 2156
    if (!isTuya()) { logTrace 'not Tuya' ; return } // library marker kkossev.commonLib, line 2157
    final String application = device.getDataValue('application') // library marker kkossev.commonLib, line 2158
    if (application != null) { // library marker kkossev.commonLib, line 2159
        Integer ver // library marker kkossev.commonLib, line 2160
        try { // library marker kkossev.commonLib, line 2161
            ver = zigbee.convertHexToInt(application) // library marker kkossev.commonLib, line 2162
        } // library marker kkossev.commonLib, line 2163
        catch (e) { // library marker kkossev.commonLib, line 2164
            logWarn "exception caught while converting application version ${application} to tuyaVersion" // library marker kkossev.commonLib, line 2165
            return // library marker kkossev.commonLib, line 2166
        } // library marker kkossev.commonLib, line 2167
        final String str = ((ver & 0xC0) >> 6).toString() + '.' + ((ver & 0x30) >> 4).toString() + '.' + (ver & 0x0F).toString() // library marker kkossev.commonLib, line 2168
        if (device.getDataValue('tuyaVersion') != str) { // library marker kkossev.commonLib, line 2169
            device.updateDataValue('tuyaVersion', str) // library marker kkossev.commonLib, line 2170
            logInfo "tuyaVersion set to $str" // library marker kkossev.commonLib, line 2171
...
boolean isAqara() { // library marker kkossev.commonLib, line 2176
    return device.getDataValue('model')?.startsWith('lumi') ?: false // library marker kkossev.commonLib, line 2177
} // library marker kkossev.commonLib, line 2178

void updateAqaraVersion() { // library marker kkossev.commonLib, line 2180
    if (!isAqara()) { logTrace 'not Aqara' ; return } // library marker kkossev.commonLib, line 2181
    String application = device.getDataValue('application') // library marker kkossev.commonLib, line 2182
    if (application != null) { // library marker kkossev.commonLib, line 2183
        String str = '0.0.0_' + String.format('%04d', zigbee.convertHexToInt(application.take(2))) // library marker kkossev.commonLib, line 2184
        if (device.getDataValue('aqaraVersion') != str) { // library marker kkossev.commonLib, line 2185
            device.updateDataValue('aqaraVersion', str) // library marker kkossev.commonLib, line 2186
            logInfo "aqaraVersion set to $str" // library marker kkossev.commonLib, line 2187
...
String unix2formattedDate(Long unixTime) { // library marker kkossev.commonLib, line 2192
    try { // library marker kkossev.commonLib, line 2193
        if (unixTime == null) { return null } // library marker kkossev.commonLib, line 2194
        /* groovylint-disable-next-line NoJavaUtilDate */ // library marker kkossev.commonLib, line 2195
        Date date = new Date(unixTime.toLong()) // library marker kkossev.commonLib, line 2196
        return date.format('yyyy-MM-dd HH:mm:ss.SSS', location.timeZone) // library marker kkossev.commonLib, line 2197
    } catch (e) { // library marker kkossev.commonLib, line 2198
        logDebug "Error formatting date: ${e.message}. Returning current time instead." // library marker kkossev.commonLib, line 2199
        return new Date().format('yyyy-MM-dd HH:mm:ss.SSS', location.timeZone) // library marker kkossev.commonLib, line 2200
    } // library marker kkossev.commonLib, line 2201
} // library marker kkossev.commonLib, line 2202

long formattedDate2unix(String formattedDate) { // library marker kkossev.commonLib, line 2204
    try { // library marker kkossev.commonLib, line 2205
        if (formattedDate == null) { return null } // library marker kkossev.commonLib, line 2206
        Date date = Date.parse('yyyy-MM-dd HH:mm:ss.SSS', formattedDate) // library marker kkossev.commonLib, line 2207
        return date.getTime() // library marker kkossev.commonLib, line 2208
    } catch (e) { // library marker kkossev.commonLib, line 2209
        logDebug "Error parsing formatted date: ${formattedDate}. Returning current time instead." // library marker kkossev.commonLib, line 2210
        return now() // library marker kkossev.commonLib, line 2211
