/* groovylint-disable CompileStatic, ConstantIfExpression, DuplicateMapLiteral, DuplicateNumberLiteral, DuplicateStringLiteral, EmptyElseBlock, EmptyIfStatement, LineLength, MethodReturnTypeRequired, NoDef, NoDouble, NoFloat, PublicMethodsBeforeNonPublicMethods, UnnecessaryGetter, UnusedMethodParameter */
library(
    base: 'driver',
 ...
 * ver. 1.0.2  2024-04-01 kkossev  - (dev.branch) groovy linting (disabled)
 *
 *                                   TODO:
 *
*/
...
private void sendAirQualityLevelEvent(String level) {
    ...
    String descriptionText = "Air Quality Level is ${level}"
