 ...
 * ver. 1.0.1  2023-09-02 kkossev  - removed airQualityLevel for VINDSTYRKA; airQualityIndex is deleted if polling is disabled; added pm25Threshold; added airQualityIndexThreshold; airQualityIndex replaced by sensirionVOCindex
 *
 *                                   TODO: !!! Aqara TVOC reporting in ppb - convert to airQualityIndex or add a new attribute ppb !! **** ( goes above 900 ) 
 *                                   TODO: !!! Aqara mgm3 setting doesn't work ?  ( C/F switching is OK)
 *                                   TODO: !!! add instructions to press the top button when changing the C/F and ppb/mgm3 settings !!!
 *
*/
