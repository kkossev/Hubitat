...
def getNeed(desired, bedSensorContactClosed, inside){
    ...
    def swing = outsideTemperature < 50 || outsideTemperature > 75 ? 0.5 : 1 // lower swing when hot or cold outside
...
"""
    ...
    boolean norHeatNorCool = !needCool && !needHeat && inside > desired + swing && bedSensorContactClosed && outsideTemperature >= 55 ? true : false
...
""" 
    ...
    def maxAH = maxAutoHeat != null ? maxAutoHeat : 75
    def minAC = minAutoCool != null ? minAutoCool : 70
    def minAH = minAutoHeat != null ? minAutoHeat : 70
    def maxAC = maxAutoCool != null ? maxAutoCool : 77
...
If this message still shows within an hour, check your thermostat configuration..."""
    ...
    y = m*(x-xa)+ya // solving y-ya = m*(x-xa)
    //log.warn "y = $y"
    def result = y > 68 ? 68 : (y < 60 ? 60 : y) // max and min
